...
class test_filter(gr_unittest.TestCase):
    ...
    def xtest_fir_filter_ccc_001(self):
        src_data = 40*[1+1j, 2+2j, 3+3j, 4+4j]
    ...
    def xtest_fir_filter_ccc_002(self):
        ...
        from  fir_filter_taps import taps
        src = gr.vector_source_c(src_data)
    ...
    def xtest_fir_filter_ccc_003(self):
        src_data = 40*[1+1j, 2+2j, 3+3j, 4+4j]
    ...
    def xtest_fir_filter_scc_001(self):
        src_data = 40*[1, 2, 3, 4]
    ...
    def xtest_fir_filter_scc_002(self):
        src_data = 40*[1, 2, 3, 4]
