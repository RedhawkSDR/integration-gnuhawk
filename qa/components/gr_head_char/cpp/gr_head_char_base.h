...
#ifndef GR_HEAD_CHAR_IMPL_BASE_H
#define GR_HEAD_CHAR_IMPL_BASE_H
...
class gr_head_char_base : public Resource_impl
{
    friend class BULKIO_dataChar_In_i;
    friend class BULKIO_dataChar_Out_i;

    public: 
        gr_head_char_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<gr_head_char_base> *serviceThread; 
        ...
        // Ports
        BULKIO_dataChar_In_i *char_in;
        BULKIO_dataChar_Out_i *char_out;
