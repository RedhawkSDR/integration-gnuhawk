...
{
    public:
        BULKIO_dataChar_Out_i(std::string port_name, gr_head_char_base *_parent);
...
{
    public:
        BULKIO_dataChar_In_i(std::string port_name, gr_head_char_base *_parent);
