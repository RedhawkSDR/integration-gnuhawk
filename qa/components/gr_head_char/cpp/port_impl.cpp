...
// ----------------------------------------------------------------------------------------
BULKIO_dataChar_Out_i::BULKIO_dataChar_Out_i(std::string port_name, gr_head_char_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<gr_head_char_i *> (_parent);
...
// ----------------------------------------------------------------------------------------
BULKIO_dataChar_In_i::BULKIO_dataChar_In_i(std::string port_name, gr_head_char_base *_parent) : 
