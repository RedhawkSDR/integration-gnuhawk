...
{
    public:
        BULKIO_dataOctet_Out_i(std::string port_name, gr_head_octet_base *_parent);
...
{
    public:
        BULKIO_dataOctet_In_i(std::string port_name, gr_head_octet_base *_parent);
