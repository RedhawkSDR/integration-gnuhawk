...
#ifndef GR_HEAD_OCTET_IMPL_BASE_H
#define GR_HEAD_OCTET_IMPL_BASE_H
...
class gr_head_octet_base : public Resource_impl
{
    friend class BULKIO_dataOctet_In_i;
    friend class BULKIO_dataOctet_Out_i;

    public: 
        gr_head_octet_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<gr_head_octet_base> *serviceThread; 
