...
firdes_i::firdes_i(const char *uuid, const char *label) :
firdes_base(uuid, label)
{
    this->setHilbert("init");
    this->setPropertyChangeListener("hilbert_ntaps", this, &firdes_i::setHilbert);
    this->setPropertyChangeListener("hilbert_windowtype", this, &firdes_i::setHilbert);
    this->setPropertyChangeListener("hilbert_beta", this, &firdes_i::setHilbert);
...
void firdes_i::setHilbert(const std::string &id)
{
    if (this->hilbert_windowtype == 0){
        hilbert = gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_HAMMING, this->hilbert_beta);
    } else if (this->hilbert_windowtype == 1){
        hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_HANN, this->hilbert_beta);
    } else if (this->hilbert_windowtype == 2){
        hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_BLACKMAN, this->hilbert_beta);
    } else if (this->hilbert_windowtype == 3){
        hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_RECTANGULAR, this->hilbert_beta);
    } else if (this->hilbert_windowtype == 4){
        hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_KAISER, this->hilbert_beta);
    } else if (this->hilbert_windowtype == 5){
        hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_BLACKMAN_HARRIS, this->hilbert_beta);
    }
    hilbert =  gr_firdes::hilbert(this->hilbert_ntaps, gr_firdes::WIN_RECTANGULAR, this->hilbert_beta);
}
