...
{
    public:
        BULKIO_dataShort_Out_i(std::string port_name, gr_head_short_base *_parent);
...
{
    public:
        BULKIO_dataShort_In_i(std::string port_name, gr_head_short_base *_parent);
