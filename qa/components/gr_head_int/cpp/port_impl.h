...
{
    public:
        BULKIO_dataLong_Out_i(std::string port_name, gr_head_int_base *_parent);
...
{
    public:
        BULKIO_dataLong_In_i(std::string port_name, gr_head_int_base *_parent);
