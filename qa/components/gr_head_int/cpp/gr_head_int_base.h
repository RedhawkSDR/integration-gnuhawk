...
#ifndef GR_HEAD_INT_IMPL_BASE_H
#define GR_HEAD_INT_IMPL_BASE_H
...
class gr_head_int_base : public Resource_impl
{
    friend class BULKIO_dataLong_In_i;
    friend class BULKIO_dataLong_Out_i;

    public: 
        gr_head_int_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<gr_head_int_base> *serviceThread; 
