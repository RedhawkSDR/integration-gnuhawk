...
// ----------------------------------------------------------------------------------------
BULKIO_dataLong_Out_i::BULKIO_dataLong_Out_i(std::string port_name, gr_head_int_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<gr_head_int_i *> (_parent);
...
// ----------------------------------------------------------------------------------------
BULKIO_dataLong_In_i::BULKIO_dataLong_In_i(std::string port_name, gr_head_int_base *_parent) : 
