...
{
    public:
        BULKIO_dataFloat_Out_i(std::string port_name, gr_head_complex_base *_parent);
...
{
    public:
        BULKIO_dataFloat_In_i(std::string port_name, gr_head_complex_base *_parent);
