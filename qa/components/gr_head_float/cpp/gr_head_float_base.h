...
#ifndef GR_HEAD_FLOAT_IMPL_BASE_H
#define GR_HEAD_FLOAT_IMPL_BASE_H
...
class gr_head_float_base : public Resource_impl
{
    friend class BULKIO_dataFloat_In_i;
    friend class BULKIO_dataFloat_Out_i;

    public: 
        gr_head_float_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<gr_head_float_base> *serviceThread; 
