...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/packed_to_unpacked_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_bb.spd.xml
