...
#ifndef PACKED_TO_UNPACKED_BB_IMPL_H
#define PACKED_TO_UNPACKED_BB_IMPL_H

#include "packed_to_unpacked_bb_base.h"

class packed_to_unpacked_bb_i : public packed_to_unpacked_bb_base
{
    public:
        packed_to_unpacked_bb_i(const char *uuid, const char *label);
        ~packed_to_unpacked_bb_i();
