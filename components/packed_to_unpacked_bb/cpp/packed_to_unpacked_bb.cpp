...
#include "packed_to_unpacked_bb.h"
...
packed_to_unpacked_bb_i::packed_to_unpacked_bb_i(const char *uuid, const char *label) :
packed_to_unpacked_bb_base(uuid, label)
{
}

packed_to_unpacked_bb_i::~packed_to_unpacked_bb_i()
{
}
...
void packed_to_unpacked_bb_i::createBlock()
{
    //
    ...
    gr_sptr = gr_make_packed_to_unpacked_bb(this->bits_per_chunk, end);
...
//      
BULKIO::StreamSRI packed_to_unpacked_bb_i::createOutputSRI( int32_t idx)
{
    //
