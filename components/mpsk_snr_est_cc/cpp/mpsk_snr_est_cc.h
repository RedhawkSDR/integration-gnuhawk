...
#ifndef MPSK_SNR_EST_CC_IMPL_H
#define MPSK_SNR_EST_CC_IMPL_H

#include "mpsk_snr_est_cc_base.h"

class mpsk_snr_est_cc_i : public mpsk_snr_est_cc_base
{
    public:
        mpsk_snr_est_cc_i(const char *uuid, const char *label);
        ~mpsk_snr_est_cc_i();
