...
mpsk_snr_est_cc_i::mpsk_snr_est_cc_i(const char *uuid, const char *label) :
mpsk_snr_est_cc_base(uuid, label)
{
}

mpsk_snr_est_cc_i::~mpsk_snr_est_cc_i()
{
}

double mpsk_snr_est_cc_i::get_snr()
{
    return this->gr_sptr->snr();
}

void mpsk_snr_est_cc_i::set_type(const std::string &id)
{
...
//      
BULKIO::StreamSRI mpsk_snr_est_cc_i::createOutputSRI( int32_t idx)
{
    //
