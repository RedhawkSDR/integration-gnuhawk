...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/mute_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_cc.spd.xml
