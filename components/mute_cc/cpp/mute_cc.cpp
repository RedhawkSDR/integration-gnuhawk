...
mute_cc_i::mute_cc_i(const char *uuid, const char *label) :
mute_cc_base(uuid, label)
{
}
...
void mute_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_mute_cc( this->mute );
...
//      
BULKIO::StreamSRI mute_cc_i::createOutputSRI( int32_t idx)
{
    //
