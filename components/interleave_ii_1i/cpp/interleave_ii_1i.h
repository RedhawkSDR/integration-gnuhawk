...
#ifndef INTERLEAVE_II_1I_IMPL_H
#define INTERLEAVE_II_1I_IMPL_H

#include "interleave_ii_1i_base.h"

class interleave_ii_1i_i : public interleave_ii_1i_base
{
    public:
        interleave_ii_1i_i(const char *uuid, const char *label);
        ~interleave_ii_1i_i();
