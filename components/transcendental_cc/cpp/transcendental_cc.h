...
#ifndef TRANSCENDENTAL_CC_IMPL_H
#define TRANSCENDENTAL_CC_IMPL_H

#include "transcendental_cc_base.h"

class transcendental_cc_i : public transcendental_cc_base
{
    public:
        transcendental_cc_i(const char *uuid, const char *label);
        ~transcendental_cc_i();
