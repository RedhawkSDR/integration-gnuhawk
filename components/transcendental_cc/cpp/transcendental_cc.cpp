...
transcendental_cc_i::transcendental_cc_i(const char *uuid, const char *label) :
transcendental_cc_base(uuid, label)
{
}

transcendental_cc_i::~transcendental_cc_i()
{
}
...
void transcendental_cc_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_transcendental( this->name, this->type );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI transcendental_cc_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
