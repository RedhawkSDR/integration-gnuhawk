...
xor_bb_2i_i::xor_bb_2i_i(const char *uuid, const char *label) :
xor_bb_2i_base(uuid, label)
{
}

xor_bb_2i_i::~xor_bb_2i_i()
{
}
...
//      
BULKIO::StreamSRI xor_bb_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
