...
#ifndef PFB_DECIMATOR_CCF_5I_IMPL_H
#define PFB_DECIMATOR_CCF_5I_IMPL_H

#include "pfb_decimator_ccf_5i_base.h"

class pfb_decimator_ccf_5i_i : public pfb_decimator_ccf_5i_base
{
    public:
        pfb_decimator_ccf_5i_i(const char *uuid, const char *label);
        ~pfb_decimator_ccf_5i_i();
