...
#ifndef OFDM_BPSK_DEMAPPER_IMPL_H
#define OFDM_BPSK_DEMAPPER_IMPL_H

#include "ofdm_bpsk_demapper_base.h"

class ofdm_bpsk_demapper_i : public ofdm_bpsk_demapper_base
{
    public:
        ofdm_bpsk_demapper_i(const char *uuid, const char *label);
        ~ofdm_bpsk_demapper_i();
