...
ofdm_bpsk_demapper_i::ofdm_bpsk_demapper_i(const char *uuid, const char *label) :
ofdm_bpsk_demapper_base(uuid, label)
{
}

ofdm_bpsk_demapper_i::~ofdm_bpsk_demapper_i()
{
}
...
void ofdm_bpsk_demapper_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_ofdm_bpsk_demapper( this->occupied_carriers );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI ofdm_bpsk_demapper_i::createOutputSRI( int32_t idx)
{
    //
