...
%define _namespace gnuhawk/gr/ofdm

Name: ofdm_bpsk_demapper
...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/ofdm_bpsk_demapper/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_bpsk_demapper.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_bpsk_demapper.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_bpsk_demapper.spd.xml
