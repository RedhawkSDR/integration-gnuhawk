...
#ifndef CVSD_DECODE_BS_IMPL_H
#define CVSD_DECODE_BS_IMPL_H

#include "cvsd_decode_bs_base.h"

class cvsd_decode_bs_i : public cvsd_decode_bs_base
{
    public:
        cvsd_decode_bs_i(const char *uuid, const char *label);
        ~cvsd_decode_bs_i();
