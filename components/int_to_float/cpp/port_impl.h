...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataFloat_Out_i(std::string port_name, int_to_float_base *_parent);
    ...
    public:
     ...
     class SRIListener {
       ...
       public:
          ...
          virtual void operator() ( BULKIO_dataLong_In_i *, BULKIO::StreamSRI &  ) = 0;
     };
      
     //BULKIO_dataLong_In_i(std::string port_name, int_to_float_base *_parent);
     BULKIO_dataLong_In_i(std::string port_name, SRIListener *listener=NULL, SRICompare cmp=CompareSRI);
     ~BULKIO_dataLong_In_i();  
        ...
        void pushPacket(const PortTypes::LongSequence& data, const BULKIO::PrecisionUTCTime& T, CORBA::Boolean EOS, const char* streamID);
     	...
     	typedef CORBA::Long         RH_TransportType;
        typedef Int32        RH_NativeType;
