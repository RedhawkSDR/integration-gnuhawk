...
int_to_float_i::int_to_float_i(const char *uuid, const char *label) :
int_to_float_base(uuid, label)
{
}

int_to_float_i::~int_to_float_i()
{
}
...
//
void int_to_float_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_int_to_float( this->vlen, this->scale);
...
//      
BULKIO::StreamSRI int_to_float_i::createOutputSRI( int32_t idx)
{
  //
