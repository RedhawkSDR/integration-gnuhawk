...
#ifndef EQUALIZER_FF_2I2O_IMPL_H
#define EQUALIZER_FF_2I2O_IMPL_H

#include "equalizer_ff_2i2o_base.h"

class equalizer_ff_2i2o_i : public equalizer_ff_2i2o_base
{
    public:
        equalizer_ff_2i2o_i(const char *uuid, const char *label);
        ~equalizer_ff_2i2o_i();
