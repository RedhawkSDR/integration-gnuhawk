...
#ifndef FILE_DESCRIPTOR_SOURCE_I_IMPL_H
#define FILE_DESCRIPTOR_SOURCE_I_IMPL_H

#include "file_descriptor_source_i_base.h"

class file_descriptor_source_i_i : public file_descriptor_source_i_base
{
    public:
        file_descriptor_source_i_i(const char *uuid, const char *label);
        ~file_descriptor_source_i_i();
