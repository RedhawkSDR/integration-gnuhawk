...
./reconf
%define _bindir %{_prefix}/dom/components/agc_ff/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_ff.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_ff.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_ff.spd.xml
