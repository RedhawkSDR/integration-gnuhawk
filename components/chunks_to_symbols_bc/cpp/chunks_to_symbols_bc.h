...
#ifndef CHUNKS_TO_SYMBOLS_BC_IMPL_H
#define CHUNKS_TO_SYMBOLS_BC_IMPL_H

#include "chunks_to_symbols_bc_base.h"

class chunks_to_symbols_bc_i : public chunks_to_symbols_bc_base
{
    public:
        chunks_to_symbols_bc_i(const char *uuid, const char *label);
        ~chunks_to_symbols_bc_i();
