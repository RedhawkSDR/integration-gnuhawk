...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/chunks_to_symbols_bc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_bc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_bc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_bc.spd.xml
