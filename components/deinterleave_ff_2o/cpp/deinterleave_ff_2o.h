...
#ifndef DEINTERLEAVE_FF_2O_IMPL_H
#define DEINTERLEAVE_FF_2O_IMPL_H

#include "deinterleave_ff_2o_base.h"

class deinterleave_ff_2o_i : public deinterleave_ff_2o_base
{
    public:
        deinterleave_ff_2o_i(const char *uuid, const char *label);
        ~deinterleave_ff_2o_i();
