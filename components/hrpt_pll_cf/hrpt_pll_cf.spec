...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/hrpt_pll_cf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_pll_cf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_pll_cf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_pll_cf.spd.xml
