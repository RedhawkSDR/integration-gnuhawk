...
#ifndef PFB_CLOCK_SYNC_FFF_4O_IMPL_H
#define PFB_CLOCK_SYNC_FFF_4O_IMPL_H

#include "pfb_clock_sync_fff_4o_base.h"

class pfb_clock_sync_fff_4o_i : public pfb_clock_sync_fff_4o_base
{
    public:
        pfb_clock_sync_fff_4o_i(const char *uuid, const char *label);
        ~pfb_clock_sync_fff_4o_i();
