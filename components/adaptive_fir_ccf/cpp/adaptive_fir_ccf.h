...
#ifndef ADAPTIVE_FIR_CCF_IMPL_H
#define ADAPTIVE_FIR_CCF_IMPL_H

#include "adaptive_fir_ccf_base.h"

class adaptive_fir_ccf_i : public adaptive_fir_ccf_base
{
    public:
        adaptive_fir_ccf_i(const char *uuid, const char *label);
        ~adaptive_fir_ccf_i();
