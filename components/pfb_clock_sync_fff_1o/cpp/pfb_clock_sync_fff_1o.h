...
#ifndef PFB_CLOCK_SYNC_FFF_1O_IMPL_H
#define PFB_CLOCK_SYNC_FFF_1O_IMPL_H

#include "pfb_clock_sync_fff_1o_base.h"

class pfb_clock_sync_fff_1o_i : public pfb_clock_sync_fff_1o_base
{
    public:
        pfb_clock_sync_fff_1o_i(const char *uuid, const char *label);
        ~pfb_clock_sync_fff_1o_i();
