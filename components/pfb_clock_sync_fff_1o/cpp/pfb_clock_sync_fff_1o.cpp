...
pfb_clock_sync_fff_1o_i::pfb_clock_sync_fff_1o_i(const char *uuid, const char *label) :
pfb_clock_sync_fff_1o_base(uuid, label)
{
}

pfb_clock_sync_fff_1o_i::~pfb_clock_sync_fff_1o_i()
{
}
...
void pfb_clock_sync_fff_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI pfb_clock_sync_fff_1o_i::createOutputSRI( int32_t idx)
{
    //
