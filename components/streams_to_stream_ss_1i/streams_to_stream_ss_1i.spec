...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/streams_to_stream_ss_1i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_1i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_1i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_1i.spd.xml
