...
depad_i::depad_i(const char *uuid, const char *label) :
depad_base(uuid, label)
{
}
...
//      
BULKIO::StreamSRI depad_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
