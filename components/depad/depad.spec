...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/depad/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/depad.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/depad.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/depad.spd.xml
