...
probe_avg_mag_sqrd_c_i::probe_avg_mag_sqrd_c_i(const char *uuid, const char *label) :
probe_avg_mag_sqrd_c_base(uuid, label)
{
}

probe_avg_mag_sqrd_c_i::~probe_avg_mag_sqrd_c_i()
{
}
...
void probe_avg_mag_sqrd_c_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_probe_avg_mag_sqrd_c( this->threshold_db, this->alpha );
    } catch (...) {
        return;
    }

    this->registerSetter("alpha", &gr_probe_avg_mag_sqrd_c::set_alpha);
    this->registerGetterSetter("threshold_db", &gr_probe_avg_mag_sqrd_c::threshold, &gr_probe_avg_mag_sqrd_c::set_threshold);

    this->registerGetter("unmuted", &gr_probe_avg_mag_sqrd_c::unmuted);
    this->registerGetter("level", &gr_probe_avg_mag_sqrd_c::level);
