...
#include "streams_to_stream_ii_1i.h"
...
streams_to_stream_ii_1i_i::streams_to_stream_ii_1i_i(const char *uuid, const char *label) :
streams_to_stream_ii_1i_base(uuid, label)
{
}

streams_to_stream_ii_1i_i::~streams_to_stream_ii_1i_i()
{
}
...
void streams_to_stream_ii_1i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI streams_to_stream_ii_1i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
