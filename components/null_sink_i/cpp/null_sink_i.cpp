...
null_sink_i_i::null_sink_i_i(const char *uuid, const char *label) :
null_sink_i_base(uuid, label)
{
}

null_sink_i_i::~null_sink_i_i()
{
}
...
void null_sink_i_i::createBlock()
{
    //
