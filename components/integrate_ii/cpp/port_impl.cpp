...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Tue Mar 05 13:03:30 EST 2013
 	Redhawk IDE
 	Version:M.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataLong_Out_i,integrate_ii_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataLong_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataLong_Out_i::BULKIO_dataLong_Out_i(std::string port_name, integrate_ii_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<integrate_ii_i *> (_parent);
