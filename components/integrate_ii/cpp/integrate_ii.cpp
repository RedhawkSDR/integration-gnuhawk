...
integrate_ii_i::integrate_ii_i(const char *uuid, const char *label) :
integrate_ii_base(uuid, label)
{
}

integrate_ii_i::~integrate_ii_i()
{
}
...
//
void integrate_ii_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_integrate_ii(decim);
...
//      
BULKIO::StreamSRI integrate_ii_i::createOutputSRI( int32_t idx)
{
  //
