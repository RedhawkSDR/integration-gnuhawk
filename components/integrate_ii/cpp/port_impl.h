...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataLong_Out_i(std::string port_name, integrate_ii_base *_parent);
...
class BULKIO_dataLong_In_i : public POA_BULKIO::dataLong, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataLong_In_i(std::string port_name, integrate_ii_base *_parent);
