...
./reconf
%define _bindir %{_prefix}/dom/components/integrate_ii/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ii.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ii.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ii.spd.xml
