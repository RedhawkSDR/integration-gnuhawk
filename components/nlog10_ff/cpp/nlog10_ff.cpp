...
nlog10_ff_i::nlog10_ff_i(const char *uuid, const char *label) :
nlog10_ff_base(uuid, label)
{
}

nlog10_ff_i::~nlog10_ff_i()
{
}
...
void nlog10_ff_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_nlog10_ff( this->n, this->vlen, this->k );
...
//      
BULKIO::StreamSRI nlog10_ff_i::createOutputSRI( int32_t idx)
{
    //
