...
#ifndef CONSTELLATION_DECODER_CB_IMPL_H
#define CONSTELLATION_DECODER_CB_IMPL_H

#include "constellation_decoder_cb_base.h"

class constellation_decoder_cb_i : public constellation_decoder_cb_base
{
    ENABLE_LOGGING;

    public:
        constellation_decoder_cb_i(const char *uuid, const char *label);
        ~constellation_decoder_cb_i();
