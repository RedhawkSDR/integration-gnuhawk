...
tagged_file_sink_f_i::tagged_file_sink_f_i(const char *uuid, const char *label) :
tagged_file_sink_f_base(uuid, label)
{
}

tagged_file_sink_f_i::~tagged_file_sink_f_i()
{
}
...
void tagged_file_sink_f_i::createBlock()
{
    //
