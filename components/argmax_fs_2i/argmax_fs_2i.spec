...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/argmax_fs_2i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_2i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_2i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_2i.spd.xml
