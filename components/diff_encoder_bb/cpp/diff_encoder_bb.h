...
#ifndef DIFF_ENCODER_BB_IMPL_H
#define DIFF_ENCODER_BB_IMPL_H

#include "diff_encoder_bb_base.h"

class diff_encoder_bb_i : public diff_encoder_bb_base
{
    public:
        diff_encoder_bb_i(const char *uuid, const char *label);
        ~diff_encoder_bb_i();
