...
#include "file_descriptor_sink_i.h"
...
file_descriptor_sink_i_i::file_descriptor_sink_i_i(const char *uuid, const char *label) :
file_descriptor_sink_i_base(uuid, label)
{
}

file_descriptor_sink_i_i::~file_descriptor_sink_i_i()
{
}
...
void file_descriptor_sink_i_i::createBlock()
{
    //
