...
#ifndef ULAW_DECODE_BS_IMPL_H
#define ULAW_DECODE_BS_IMPL_H

#include "ulaw_decode_bs_base.h"

class ulaw_decode_bs_i : public ulaw_decode_bs_base
{
    public:
        ulaw_decode_bs_i(const char *uuid, const char *label);
        ~ulaw_decode_bs_i();
