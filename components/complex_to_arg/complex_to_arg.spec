...
./reconf
%define _bindir %{_prefix}/dom/components/complex_to_arg/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_arg.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_arg.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_arg.spd.xml
