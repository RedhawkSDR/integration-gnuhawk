...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_arg/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_arg.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_arg.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_arg.spd.xml
