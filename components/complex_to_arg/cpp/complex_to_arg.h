...
#ifndef COMPLEX_TO_ARG_IMPL_H
#define COMPLEX_TO_ARG_IMPL_H

#include "complex_to_arg_base.h"

class complex_to_arg_i : public complex_to_arg_base
{
   public:
      complex_to_arg_i(const char *uuid, const char *label);
      ~complex_to_arg_i();
