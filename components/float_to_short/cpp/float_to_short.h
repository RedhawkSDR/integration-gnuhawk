...
#ifndef FLOAT_TO_SHORT_IMPL_H
#define FLOAT_TO_SHORT_IMPL_H

#include "float_to_short_base.h"

class float_to_short_i : public float_to_short_base
{
    public:
        float_to_short_i(const char *uuid, const char *label);
        ~float_to_short_i();
