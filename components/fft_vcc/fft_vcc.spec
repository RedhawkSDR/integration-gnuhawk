...
./reconf
%define _bindir %{_prefix}/dom/components/fft_vcc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vcc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vcc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vcc.spd.xml
