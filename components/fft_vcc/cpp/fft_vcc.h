...
#ifndef FFT_VCC_IMPL_H
#define FFT_VCC_IMPL_H

#include "fft_vcc_base.h"

class fft_vcc_i : public fft_vcc_base
{
   public:
      fft_vcc_i(const char *uuid, const char *label);
      ~fft_vcc_i();
    ...
    void changedWindow(const std::string &id);
};
