...
fft_vcc_i::fft_vcc_i(const char *uuid, const char *label) :
fft_vcc_base(uuid, label)
{
}
...
void fft_vcc_i::changedWindow(const std::string &id)
{
...
//      
BULKIO::StreamSRI fft_vcc_i::createOutputSRI( int32_t idx)
{
  //
