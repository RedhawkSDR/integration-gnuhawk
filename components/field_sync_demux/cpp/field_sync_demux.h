...
#ifndef FIELD_SYNC_DEMUX_IMPL_H
#define FIELD_SYNC_DEMUX_IMPL_H

#include "field_sync_demux_base.h"

class field_sync_demux_i : public field_sync_demux_base
{
    public:
        field_sync_demux_i(const char *uuid, const char *label);
        ~field_sync_demux_i();
