...
#ifndef SAMPLE_AND_HOLD_BB_IMPL_H
#define SAMPLE_AND_HOLD_BB_IMPL_H

#include "sample_and_hold_bb_base.h"

class sample_and_hold_bb_i : public sample_and_hold_bb_base
{
    public:
        sample_and_hold_bb_i(const char *uuid, const char *label);
        ~sample_and_hold_bb_i();
