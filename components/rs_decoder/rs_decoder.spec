...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/rs_decoder/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_decoder.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_decoder.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_decoder.spd.xml
