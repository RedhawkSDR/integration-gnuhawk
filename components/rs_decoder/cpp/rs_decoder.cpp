...
rs_decoder_i::rs_decoder_i(const char *uuid, const char *label) :
rs_decoder_base(uuid, label)
{
}

rs_decoder_i::~rs_decoder_i()
{
}
...
//      
BULKIO::StreamSRI rs_decoder_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
