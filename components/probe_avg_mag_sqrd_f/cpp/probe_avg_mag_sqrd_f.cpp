...
#include "probe_avg_mag_sqrd_f.h"
...
probe_avg_mag_sqrd_f_i::probe_avg_mag_sqrd_f_i(const char *uuid, const char *label) :
probe_avg_mag_sqrd_f_base(uuid, label)
{
}

probe_avg_mag_sqrd_f_i::~probe_avg_mag_sqrd_f_i()
{
}
