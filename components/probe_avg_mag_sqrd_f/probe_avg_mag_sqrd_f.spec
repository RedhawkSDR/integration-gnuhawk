...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_avg_mag_sqrd_f/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_avg_mag_sqrd_f.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_avg_mag_sqrd_f.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_avg_mag_sqrd_f.spd.xml
