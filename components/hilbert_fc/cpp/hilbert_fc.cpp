...
hilbert_fc_i::hilbert_fc_i(const char *uuid, const char *label) :
hilbert_fc_base(uuid, label)
{
}

hilbert_fc_i::~hilbert_fc_i()
{
}
...
//      
BULKIO::StreamSRI hilbert_fc_i::createOutputSRI( int32_t idx)
{
  //
