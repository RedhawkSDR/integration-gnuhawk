...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Tue Mar 05 10:35:11 EST 2013
 	Redhawk IDE
 	Version:M.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,hilbert_fc_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, hilbert_fc_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<hilbert_fc_i *> (_parent);
