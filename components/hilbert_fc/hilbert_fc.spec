...
./reconf
%define _bindir %{_prefix}/dom/components/hilbert_fc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/hilbert_fc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/hilbert_fc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/hilbert_fc.spd.xml
