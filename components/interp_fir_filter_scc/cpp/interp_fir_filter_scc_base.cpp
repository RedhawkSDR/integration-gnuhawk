...
interp_fir_filter_scc_base::~interp_fir_filter_scc_base()
{
// Destructor
    // Free input streams
...
BULKIO::StreamSRI interp_fir_filter_scc_base::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
...
int interp_fir_filter_scc_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int interp_fir_filter_scc_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( interp_fir_filter_scc_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( interp_fir_filter_scc_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( interp_fir_filter_scc_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( interp_fir_filter_scc_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( interp_fir_filter_scc_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
