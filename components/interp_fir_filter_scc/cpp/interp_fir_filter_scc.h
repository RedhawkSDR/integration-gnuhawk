...
#ifndef INTERP_FIR_FILTER_SCC_IMPL_H
#define INTERP_FIR_FILTER_SCC_IMPL_H

#include "interp_fir_filter_scc_base.h"

class interp_fir_filter_scc_i : public interp_fir_filter_scc_base
{
    public:
        interp_fir_filter_scc_i(const char *uuid, const char *label);
        ~interp_fir_filter_scc_i();
