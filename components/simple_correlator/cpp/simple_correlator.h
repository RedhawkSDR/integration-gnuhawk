...
#ifndef SIMPLE_CORRELATOR_IMPL_H
#define SIMPLE_CORRELATOR_IMPL_H

#include "simple_correlator_base.h"

class simple_correlator_i : public simple_correlator_base
{
    public:
        simple_correlator_i(const char *uuid, const char *label);
        ~simple_correlator_i();
