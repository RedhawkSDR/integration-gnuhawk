...
#ifndef TAGGED_FILE_SINK_B_IMPL_H
#define TAGGED_FILE_SINK_B_IMPL_H

#include "tagged_file_sink_b_base.h"

class tagged_file_sink_b_i : public tagged_file_sink_b_base
{
    public:
        tagged_file_sink_b_i(const char *uuid, const char *label);
        ~tagged_file_sink_b_i();
