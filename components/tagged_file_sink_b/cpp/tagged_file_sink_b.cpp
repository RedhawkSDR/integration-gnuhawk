...
tagged_file_sink_b_i::tagged_file_sink_b_i(const char *uuid, const char *label) :
tagged_file_sink_b_base(uuid, label)
{
}

tagged_file_sink_b_i::~tagged_file_sink_b_i()
{
}
...
void tagged_file_sink_b_i::createBlock()
{
    //
