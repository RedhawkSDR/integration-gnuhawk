...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_stream_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ss.spd.xml
