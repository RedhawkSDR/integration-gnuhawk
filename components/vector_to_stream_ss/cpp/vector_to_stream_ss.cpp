...
vector_to_stream_ss_i::vector_to_stream_ss_i(const char *uuid, const char *label) :
vector_to_stream_ss_base(uuid, label)
{
}

vector_to_stream_ss_i::~vector_to_stream_ss_i()
{
}
...
void vector_to_stream_ss_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI vector_to_stream_ss_i::createOutputSRI( int32_t idx)
{
    //
