...
#ifndef VECTOR_TO_STREAM_SS_IMPL_H
#define VECTOR_TO_STREAM_SS_IMPL_H

#include "vector_to_stream_ss_base.h"

class vector_to_stream_ss_i : public vector_to_stream_ss_base
{
    public:
        vector_to_stream_ss_i(const char *uuid, const char *label);
        ~vector_to_stream_ss_i();
