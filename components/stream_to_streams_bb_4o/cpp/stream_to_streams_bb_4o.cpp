...
#include "stream_to_streams_bb_4o.h"
...
stream_to_streams_bb_4o_i::~stream_to_streams_bb_4o_i()
{
}

void stream_to_streams_bb_4o_i::streamIdChanged(const std::string& id)
{ 
...
void stream_to_streams_bb_4o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI stream_to_streams_bb_4o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
