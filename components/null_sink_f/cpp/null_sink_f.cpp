...
null_sink_f_i::null_sink_f_i(const char *uuid, const char *label) :
null_sink_f_base(uuid, label)
{
}

null_sink_f_i::~null_sink_f_i()
{
}
...
void null_sink_f_i::createBlock()
{
    //
