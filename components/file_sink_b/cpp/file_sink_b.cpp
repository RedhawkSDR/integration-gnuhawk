...
file_sink_b_i::file_sink_b_i(const char *uuid, const char *label) :
file_sink_b_base(uuid, label)
{
}

file_sink_b_i::~file_sink_b_i()
{
}
...
void file_sink_b_i::createBlock()
{
    //
