...
sub_ii_1i_i::sub_ii_1i_i(const char *uuid, const char *label) :
sub_ii_1i_base(uuid, label)
{
}

sub_ii_1i_i::~sub_ii_1i_i()
{
}
...
//      
BULKIO::StreamSRI sub_ii_1i_i::createOutputSRI( int32_t idx)
{
    //
