...
// Destructor
argmax_ss_1i_base::~argmax_ss_1i_base()
{
    // Free input streams
...
BULKIO::StreamSRI argmax_ss_1i_base::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
...
int argmax_ss_1i_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int argmax_ss_1i_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( argmax_ss_1i_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( argmax_ss_1i_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( argmax_ss_1i_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( argmax_ss_1i_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( argmax_ss_1i_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
