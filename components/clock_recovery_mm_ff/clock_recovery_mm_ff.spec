...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/clock_recovery_mm_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/clock_recovery_mm_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/clock_recovery_mm_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/clock_recovery_mm_ff.spd.xml
