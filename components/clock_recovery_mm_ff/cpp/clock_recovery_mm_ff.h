...
#ifndef CLOCK_RECOVERY_MM_FF_IMPL_H
#define CLOCK_RECOVERY_MM_FF_IMPL_H

#include "clock_recovery_mm_ff_base.h"

class clock_recovery_mm_ff_i : public clock_recovery_mm_ff_base
{
    public:
        clock_recovery_mm_ff_i(const char *uuid, const char *label);
        ~clock_recovery_mm_ff_i();
