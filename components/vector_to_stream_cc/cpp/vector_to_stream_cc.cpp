...
vector_to_stream_cc_i::vector_to_stream_cc_i(const char *uuid, const char *label) :
vector_to_stream_cc_base(uuid, label)
{
}

vector_to_stream_cc_i::~vector_to_stream_cc_i()
{
}
...
void vector_to_stream_cc_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI vector_to_stream_cc_i::createOutputSRI( int32_t idx)
{
    //
