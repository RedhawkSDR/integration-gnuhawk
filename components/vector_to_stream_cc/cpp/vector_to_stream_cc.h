...
#ifndef VECTOR_TO_STREAM_CC_IMPL_H
#define VECTOR_TO_STREAM_CC_IMPL_H

#include "vector_to_stream_cc_base.h"

class vector_to_stream_cc_i : public vector_to_stream_cc_base
{
    public:
        vector_to_stream_cc_i(const char *uuid, const char *label);
        ~vector_to_stream_cc_i();
