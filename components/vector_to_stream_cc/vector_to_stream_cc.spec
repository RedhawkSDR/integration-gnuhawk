...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_stream_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_cc.spd.xml
