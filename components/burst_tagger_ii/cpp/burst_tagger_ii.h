...
#ifndef BURST_TAGGER_II_IMPL_H
#define BURST_TAGGER_II_IMPL_H

#include "burst_tagger_ii_base.h"

class burst_tagger_ii_i : public burst_tagger_ii_base
{
    public:
        burst_tagger_ii_i(const char *uuid, const char *label);
        ~burst_tagger_ii_i();
        ...
        void true_tag_changed(const std::string &id);
        void false_tag_changed(const std::string &id);
};
