...
#ifndef FIELD_SYNC_MUX_IMPL_H
#define FIELD_SYNC_MUX_IMPL_H

#include "field_sync_mux_base.h"

class field_sync_mux_i : public field_sync_mux_base
{
    public:
        field_sync_mux_i(const char *uuid, const char *label);
        ~field_sync_mux_i();
