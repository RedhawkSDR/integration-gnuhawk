...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/field_sync_mux/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/field_sync_mux.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/field_sync_mux.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/field_sync_mux.spd.xml
