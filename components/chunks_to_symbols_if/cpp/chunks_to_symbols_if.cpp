...
chunks_to_symbols_if_i::chunks_to_symbols_if_i(const char *uuid, const char *label) :
chunks_to_symbols_if_base(uuid, label)
{
}

chunks_to_symbols_if_i::~chunks_to_symbols_if_i()
{
}
...
void chunks_to_symbols_if_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_chunks_to_symbols_if( this->symbol_table, this->D );

    this->registerGetter("symbol_table", &gr_chunks_to_symbols_if::symbol_table);
    this->registerGetter("D", &gr_chunks_to_symbols_if::D);
...
//      
BULKIO::StreamSRI chunks_to_symbols_if_i::createOutputSRI( int32_t idx)
{
    //
