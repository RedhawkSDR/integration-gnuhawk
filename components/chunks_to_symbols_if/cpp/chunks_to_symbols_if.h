...
#ifndef CHUNKS_TO_SYMBOLS_IF_IMPL_H
#define CHUNKS_TO_SYMBOLS_IF_IMPL_H

#include "chunks_to_symbols_if_base.h"

class chunks_to_symbols_if_i : public chunks_to_symbols_if_base
{
    public:
        chunks_to_symbols_if_i(const char *uuid, const char *label);
        ~chunks_to_symbols_if_i();
