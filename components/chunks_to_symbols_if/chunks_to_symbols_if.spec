...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/chunks_to_symbols_if/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_if.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_if.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_if.spd.xml
