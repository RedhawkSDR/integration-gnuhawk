...
#ifndef LMS_DD_EQUALIZER_CC_IMPL_H
#define LMS_DD_EQUALIZER_CC_IMPL_H

#include "lms_dd_equalizer_cc_base.h"

class lms_dd_equalizer_cc_i : public lms_dd_equalizer_cc_base
{
    public:
        lms_dd_equalizer_cc_i(const char *uuid, const char *label);
        ~lms_dd_equalizer_cc_i();
        ...
        void set_gain(const std::string &id);
        float get_gain();
};
