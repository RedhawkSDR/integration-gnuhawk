...
or_bb_3i_i::or_bb_3i_i(const char *uuid, const char *label) :
or_bb_3i_base(uuid, label)
{
}

or_bb_3i_i::~or_bb_3i_i()
{
}
...
//      
BULKIO::StreamSRI or_bb_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
