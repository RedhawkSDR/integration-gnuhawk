...
#ifndef G721_DECODE_BS_IMPL_H
#define G721_DECODE_BS_IMPL_H

#include "g721_decode_bs_base.h"

class g721_decode_bs_i : public g721_decode_bs_base
{
    public:
        g721_decode_bs_i(const char *uuid, const char *label);
        ~g721_decode_bs_i();
