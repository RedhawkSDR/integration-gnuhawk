...
g721_decode_bs_i::g721_decode_bs_i(const char *uuid, const char *label) :
g721_decode_bs_base(uuid, label)
{
}

g721_decode_bs_i::~g721_decode_bs_i()
{
}
...
void g721_decode_bs_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = vocoder_make_g721_decode_bs();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI g721_decode_bs_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
