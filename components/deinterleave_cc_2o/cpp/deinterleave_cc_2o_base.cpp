...
// Destructor
deinterleave_cc_2o_base::~deinterleave_cc_2o_base()
{
    // Free input streams
...
BULKIO::StreamSRI deinterleave_cc_2o_base::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
...
int deinterleave_cc_2o_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int deinterleave_cc_2o_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( deinterleave_cc_2o_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( deinterleave_cc_2o_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( deinterleave_cc_2o_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( deinterleave_cc_2o_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( deinterleave_cc_2o_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
