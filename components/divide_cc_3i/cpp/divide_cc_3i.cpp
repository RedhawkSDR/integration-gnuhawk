...
divide_cc_3i_i::divide_cc_3i_i(const char *uuid, const char *label) :
divide_cc_3i_base(uuid, label)
{
}

divide_cc_3i_i::~divide_cc_3i_i()
{
}
...
void divide_cc_3i_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_divide_cc( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI divide_cc_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
