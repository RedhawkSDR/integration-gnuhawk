...
#ifndef MULTIPLY_CONST_VCC_IMPL_H
#define MULTIPLY_CONST_VCC_IMPL_H

#include "multiply_const_vcc_base.h"

class multiply_const_vcc_i : public multiply_const_vcc_base
{
    public:
        multiply_const_vcc_i(const char *uuid, const char *label);
        ~multiply_const_vcc_i();
