...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/multiply_const_vcc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vcc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vcc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vcc.spd.xml
