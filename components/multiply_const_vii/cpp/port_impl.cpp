...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Mon Feb 25 13:43:20 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
 	Build id: v201302221050

*******************************************************************************************/

#include "multiply_const_vii.h"
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataLong_Out_i,multiply_const_vii_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataLong_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataLong_Out_i::BULKIO_dataLong_Out_i(std::string port_name, multiply_const_vii_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<multiply_const_vii_i *> (_parent);
    ...
    if (active) {
        ...
        for (i = outConnections.begin(); i != outConnections.end(); ++i) {
            try {
                ...
                //RESOLVE LOG_ERROR(BULKIO_dataLong_Out_i, "Call to pushSRI by BULKIO_dataLong_Out_i failed");
            }
        }
    }
...
// ----------------------------------------------------------------------------------------
BULKIO_dataLong_In_i::BULKIO_dataLong_In_i(std::string port_name,  SRIListener *listener , SRICompare cmpFunc) : 
...
bool BULKIO_dataLong_In_i::blocked()
{
    return breakBlock;
}
 ...
 */
BULKIO_dataLong_In_i::dataTransfer *BULKIO_dataLong_In_i::getPacket(float timeout, std::string streamID )
{
    if (breakBlock) {
        return NULL;
    }
    ...
    BULKIO_dataLong_In_i::dataTransfer *tmp = NULL;
    if ( streamID == "" ){
        tmp = workQueue.front();
        workQueue.pop_front();
    } else {
