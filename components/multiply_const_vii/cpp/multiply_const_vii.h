...
#ifndef MULTIPLY_CONST_VII_IMPL_H
#define MULTIPLY_CONST_VII_IMPL_H

#include "multiply_const_vii_base.h"

class multiply_const_vii_i : public multiply_const_vii_base
{
   public:
      multiply_const_vii_i(const char *uuid, const char *label);
      ~multiply_const_vii_i();
