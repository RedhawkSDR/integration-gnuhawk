...
multiply_const_vii_i::multiply_const_vii_i(const char *uuid, const char *label) :
multiply_const_vii_base(uuid, label)
{
}

multiply_const_vii_i::~multiply_const_vii_i()
{
}
...
std::vector< CORBA::Long > multiply_const_vii_i::getK() {
...
void multiply_const_vii_i::setK( const std::string &id ) {
    if ( validGRBlock() ) {
...
//      
BULKIO::StreamSRI multiply_const_vii_i::createOutputSRI( int32_t idx)
{
  //
