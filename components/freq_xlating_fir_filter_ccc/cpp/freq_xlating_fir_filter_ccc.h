...
#ifndef FREQ_XLATING_FIR_FILTER_CCC_IMPL_H
#define FREQ_XLATING_FIR_FILTER_CCC_IMPL_H

#include "freq_xlating_fir_filter_ccc_base.h"

class freq_xlating_fir_filter_ccc_i : public freq_xlating_fir_filter_ccc_base
{
    public:
        freq_xlating_fir_filter_ccc_i(const char *uuid, const char *label);
        ~freq_xlating_fir_filter_ccc_i();
