...
freq_xlating_fir_filter_ccc_i::freq_xlating_fir_filter_ccc_i(const char *uuid, const char *label) :
freq_xlating_fir_filter_ccc_base(uuid, label)
{
}

freq_xlating_fir_filter_ccc_i::~freq_xlating_fir_filter_ccc_i()
{
}

void freq_xlating_fir_filter_ccc_i::set_taps(const std::string &id)
{
    this->gr_sptr->set_taps(this->taps);
}

std::vector<std::complex<float> > freq_xlating_fir_filter_ccc_i::get_taps()
{
...
void freq_xlating_fir_filter_ccc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr::filter::freq_xlating_fir_filter_ccc::make( this->decimation, this->taps, this->center_freq, this->sampling_freq );

    this->registerGetterSetter("center_freq",
                               &gr::filter::freq_xlating_fir_filter_ccc::center_freq,
                               &gr::filter::freq_xlating_fir_filter_ccc::set_center_freq);

    this->setPropertyChangeListener("taps",
                                    this,
                                    &freq_xlating_fir_filter_ccc_i::set_taps);
    this->registerGetValue("taps",
                           this,
                           &freq_xlating_fir_filter_ccc_i::get_taps);
...
//      
BULKIO::StreamSRI freq_xlating_fir_filter_ccc_i::createOutputSRI( int32_t idx)
{
    //
