...
#ifndef INTERLEAVE_BB_1I_IMPL_H
#define INTERLEAVE_BB_1I_IMPL_H

#include "interleave_bb_1i_base.h"

class interleave_bb_1i_i : public interleave_bb_1i_base
{
    public:
        interleave_bb_1i_i(const char *uuid, const char *label);
        ~interleave_bb_1i_i();
