...
sub_ii_4i_i::sub_ii_4i_i(const char *uuid, const char *label) :
sub_ii_4i_base(uuid, label)
{
}

sub_ii_4i_i::~sub_ii_4i_i()
{
}
...
void sub_ii_4i_i::createBlock()
{
    ...
    try {
        gr_sptr = gr_make_sub_ii( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sub_ii_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
