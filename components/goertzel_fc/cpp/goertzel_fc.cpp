...
goertzel_fc_i::goertzel_fc_i(const char *uuid, const char *label) :
goertzel_fc_base(uuid, label)
{
}

goertzel_fc_i::~goertzel_fc_i()
{
}
...
//
void goertzel_fc_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI goertzel_fc_i::createOutputSRI( int32_t idx)
{
  //
