...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/goertzel_fc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/goertzel_fc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/goertzel_fc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/goertzel_fc.spd.xml
