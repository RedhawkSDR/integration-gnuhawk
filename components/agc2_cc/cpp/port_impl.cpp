...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Thu Feb 28 13:49:13 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,agc2_cc_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, agc2_cc_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<agc2_cc_i *> (_parent);
