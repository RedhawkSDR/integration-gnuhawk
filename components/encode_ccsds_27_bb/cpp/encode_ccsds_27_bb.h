...
#ifndef ENCODE_CCSDS_27_BB_IMPL_H
#define ENCODE_CCSDS_27_BB_IMPL_H

#include "encode_ccsds_27_bb_base.h"

class encode_ccsds_27_bb_i : public encode_ccsds_27_bb_base
{
    public:
        encode_ccsds_27_bb_i(const char *uuid, const char *label);
        ~encode_ccsds_27_bb_i();
