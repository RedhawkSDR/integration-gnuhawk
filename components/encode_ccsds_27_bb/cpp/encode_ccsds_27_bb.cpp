...
encode_ccsds_27_bb_i::encode_ccsds_27_bb_i(const char *uuid, const char *label) :
encode_ccsds_27_bb_base(uuid, label)
{
}

encode_ccsds_27_bb_i::~encode_ccsds_27_bb_i()
{
}
...
void encode_ccsds_27_bb_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_encode_ccsds_27_bb();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI encode_ccsds_27_bb_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
