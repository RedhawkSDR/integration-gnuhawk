...
#ifndef CORRELATE_ACCESS_CODE_TAG_BB_IMPL_H
#define CORRELATE_ACCESS_CODE_TAG_BB_IMPL_H

#include "correlate_access_code_tag_bb_base.h"

class correlate_access_code_tag_bb_i : public correlate_access_code_tag_bb_base
{
    ENABLE_LOGGING
    public:
        correlate_access_code_tag_bb_i(const char *uuid, const char *label);
        ~correlate_access_code_tag_bb_i();
        ...
        void set_access_code(const std::string &id);
};
