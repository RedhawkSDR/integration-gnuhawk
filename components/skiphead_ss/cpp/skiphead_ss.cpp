...
skiphead_ss_i::skiphead_ss_i(const char *uuid, const char *label) :
skiphead_ss_base(uuid, label)
{
}

skiphead_ss_i::~skiphead_ss_i()
{
}
...
void skiphead_ss_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI skiphead_ss_i::createOutputSRI( int32_t idx)
{
    //
