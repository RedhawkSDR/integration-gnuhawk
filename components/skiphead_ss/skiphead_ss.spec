...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/skiphead_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/skiphead_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/skiphead_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/skiphead_ss.spd.xml
