...
#ifndef THROTTLE_BB_IMPL_H
#define THROTTLE_BB_IMPL_H

#include "throttle_bb_base.h"

class throttle_bb_i : public throttle_bb_base
{
    public:
        throttle_bb_i(const char *uuid, const char *label);
        ~throttle_bb_i();
        ...
        void changeFrequency(const std::string &id);
};
