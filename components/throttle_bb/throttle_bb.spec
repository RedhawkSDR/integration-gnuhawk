...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/throttle_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_bb.spd.xml
