...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/rms_cf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rms_cf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rms_cf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rms_cf.spd.xml
