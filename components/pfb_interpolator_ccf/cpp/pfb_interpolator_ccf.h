...
#ifndef PFB_INTERPOLATOR_CCF_IMPL_H
#define PFB_INTERPOLATOR_CCF_IMPL_H

#include "pfb_interpolator_ccf_base.h"

class pfb_interpolator_ccf_i : public pfb_interpolator_ccf_base
{
    public:
        pfb_interpolator_ccf_i(const char *uuid, const char *label);
        ~pfb_interpolator_ccf_i();
