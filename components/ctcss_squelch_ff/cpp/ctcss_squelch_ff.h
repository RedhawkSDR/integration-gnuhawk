...
#ifndef CTCSS_SQUELCH_FF_IMPL_H
#define CTCSS_SQUELCH_FF_IMPL_H

#include "ctcss_squelch_ff_base.h"

class ctcss_squelch_ff_i : public ctcss_squelch_ff_base
{
    public:
        ctcss_squelch_ff_i(const char *uuid, const char *label);
        ~ctcss_squelch_ff_i();
        ...
        int get_ramp();
        bool get_gate();
        void set_ramp(const std::string &id);
        void set_gate(const std::string &id);
};
