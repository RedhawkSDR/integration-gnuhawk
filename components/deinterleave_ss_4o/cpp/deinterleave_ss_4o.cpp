...
deinterleave_ss_4o_i::deinterleave_ss_4o_i(const char *uuid, const char *label) :
deinterleave_ss_4o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_ss_4o_i::streamIdChanged );
}

deinterleave_ss_4o_i::~deinterleave_ss_4o_i()
{
}

void deinterleave_ss_4o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_ss_4o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI deinterleave_ss_4o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
