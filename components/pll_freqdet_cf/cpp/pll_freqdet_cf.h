...
#ifndef PLL_FREQDET_CF_IMPL_H
#define PLL_FREQDET_CF_IMPL_H

#include "pll_freqdet_cf_base.h"

class pll_freqdet_cf_i : public pll_freqdet_cf_base
{
    public:
        pll_freqdet_cf_i(const char *uuid, const char *label);
        ~pll_freqdet_cf_i();
