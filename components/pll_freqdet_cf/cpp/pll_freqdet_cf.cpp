...
pll_freqdet_cf_i::pll_freqdet_cf_i(const char *uuid, const char *label) :
pll_freqdet_cf_base(uuid, label)
{
}

pll_freqdet_cf_i::~pll_freqdet_cf_i()
{
}
...
void pll_freqdet_cf_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_pll_freqdet_cf( this->loop_bw, this->max_freq, this->min_freq );
...
//      
BULKIO::StreamSRI pll_freqdet_cf_i::createOutputSRI( int32_t idx)
{
    //
