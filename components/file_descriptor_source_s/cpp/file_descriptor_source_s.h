...
#ifndef FILE_DESCRIPTOR_SOURCE_S_IMPL_H
#define FILE_DESCRIPTOR_SOURCE_S_IMPL_H

#include "file_descriptor_source_s_base.h"

class file_descriptor_source_s_i : public file_descriptor_source_s_base
{
    public:
        file_descriptor_source_s_i(const char *uuid, const char *label);
        ~file_descriptor_source_s_i();
