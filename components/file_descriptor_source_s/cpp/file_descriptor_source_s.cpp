...
#include "file_descriptor_source_s.h"
...
file_descriptor_source_s_i::file_descriptor_source_s_i(const char *uuid, const char *label) :
file_descriptor_source_s_base(uuid, label)
{
}

file_descriptor_source_s_i::~file_descriptor_source_s_i()
{
}
...
void file_descriptor_source_s_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI file_descriptor_source_s_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
