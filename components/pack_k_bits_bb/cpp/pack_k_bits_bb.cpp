...
pack_k_bits_bb_i::pack_k_bits_bb_i(const char *uuid, const char *label) :
pack_k_bits_bb_base(uuid, label)
{
}

pack_k_bits_bb_i::~pack_k_bits_bb_i()
{
}
...
void pack_k_bits_bb_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_pack_k_bits_bb( this->k );
...
//      
BULKIO::StreamSRI pack_k_bits_bb_i::createOutputSRI( int32_t idx)
{
    //
