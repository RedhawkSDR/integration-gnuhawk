...
#ifndef PACK_K_BITS_BB_IMPL_H
#define PACK_K_BITS_BB_IMPL_H

#include "pack_k_bits_bb_base.h"

class pack_k_bits_bb_i : public pack_k_bits_bb_base
{
    public:
        pack_k_bits_bb_i(const char *uuid, const char *label);
        ~pack_k_bits_bb_i();
