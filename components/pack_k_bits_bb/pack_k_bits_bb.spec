...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/pack_k_bits_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pack_k_bits_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pack_k_bits_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pack_k_bits_bb.spd.xml
