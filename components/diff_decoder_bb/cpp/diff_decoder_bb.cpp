...
diff_decoder_bb_i::diff_decoder_bb_i(const char *uuid, const char *label) :
diff_decoder_bb_base(uuid, label)
{
}

diff_decoder_bb_i::~diff_decoder_bb_i()
{
}
...
void diff_decoder_bb_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = digital_make_diff_decoder_bb( this->modulus );
...
//      
BULKIO::StreamSRI diff_decoder_bb_i::createOutputSRI( int32_t idx)
{
    //
