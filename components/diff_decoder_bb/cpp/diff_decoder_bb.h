...
#ifndef DIFF_DECODER_BB_IMPL_H
#define DIFF_DECODER_BB_IMPL_H

#include "diff_decoder_bb_base.h"

class diff_decoder_bb_i : public diff_decoder_bb_base
{
    public:
        diff_decoder_bb_i(const char *uuid, const char *label);
        ~diff_decoder_bb_i();
