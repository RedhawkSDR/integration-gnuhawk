...
ofdm_frame_acquisition_i::ofdm_frame_acquisition_i(const char *uuid, const char *label) :
ofdm_frame_acquisition_base(uuid, label)
{
}

ofdm_frame_acquisition_i::~ofdm_frame_acquisition_i()
{
}


float ofdm_frame_acquisition_i::get_snr()
{
    return gr_sptr->snr();
}
...
PREPARE_LOGGING(ofdm_frame_acquisition_i);
...
//      
BULKIO::StreamSRI ofdm_frame_acquisition_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
