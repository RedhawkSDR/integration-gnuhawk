...
#ifndef OFDM_FRAME_ACQUISITION_IMPL_H
#define OFDM_FRAME_ACQUISITION_IMPL_H

#include "ofdm_frame_acquisition_base.h"

class ofdm_frame_acquisition_i : public ofdm_frame_acquisition_base
{
    ENABLE_LOGGING;
    public:
        ofdm_frame_acquisition_i(const char *uuid, const char *label);
        ~ofdm_frame_acquisition_i();
