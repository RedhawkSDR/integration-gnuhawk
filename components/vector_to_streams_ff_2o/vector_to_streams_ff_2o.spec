...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_streams_ff_2o/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_streams_ff_2o.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_streams_ff_2o.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_streams_ff_2o.spd.xml
