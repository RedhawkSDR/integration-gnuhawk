...
#ifndef INTERLEAVE_FF_4I_IMPL_H
#define INTERLEAVE_FF_4I_IMPL_H

#include "interleave_ff_4i_base.h"

class interleave_ff_4i_i : public interleave_ff_4i_base
{
    public:
        interleave_ff_4i_i(const char *uuid, const char *label);
        ~interleave_ff_4i_i();
