...
interleave_ff_4i_i::interleave_ff_4i_i(const char *uuid, const char *label) :
interleave_ff_4i_base(uuid, label)
{
}

interleave_ff_4i_i::~interleave_ff_4i_i()
{
}
...
void interleave_ff_4i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI interleave_ff_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
