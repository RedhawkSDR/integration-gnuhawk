...
#include "stream_to_streams_ff_2o.h"
...
stream_to_streams_ff_2o_i::stream_to_streams_ff_2o_i(const char *uuid, const char *label) :
stream_to_streams_ff_2o_base(uuid, label)
{
    setPropertyChangeListener("stream_id_map", this, &stream_to_streams_ff_2o_i::streamIdChanged);
}

stream_to_streams_ff_2o_i::~stream_to_streams_ff_2o_i()
{
}

void stream_to_streams_ff_2o_i::streamIdChanged(const std::string& id) {
...
void stream_to_streams_ff_2o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_streams_ff_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
