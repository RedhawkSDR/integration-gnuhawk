...
throttle_cc_i::throttle_cc_i(const char *uuid, const char *label) :
throttle_cc_base(uuid, label)
{
}

throttle_cc_i::~throttle_cc_i()
{
}

void throttle_cc_i::changeFrequency(const std::string &id)
{
...
void throttle_cc_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("samples_per_sec", this, &throttle_cc_i::changeFrequency);
...
//      
BULKIO::StreamSRI throttle_cc_i::createOutputSRI( int32_t idx)
{
    //
