...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/throttle_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_cc.spd.xml
