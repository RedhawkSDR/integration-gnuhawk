...
#ifndef DEINTERLEAVE_SS_2O_IMPL_H
#define DEINTERLEAVE_SS_2O_IMPL_H

#include "deinterleave_ss_2o_base.h"

class deinterleave_ss_2o_i : public deinterleave_ss_2o_base
{
    public:
        deinterleave_ss_2o_i(const char *uuid, const char *label);
        ~deinterleave_ss_2o_i();
