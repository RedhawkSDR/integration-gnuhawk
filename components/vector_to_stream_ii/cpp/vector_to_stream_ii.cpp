...
vector_to_stream_ii_i::vector_to_stream_ii_i(const char *uuid, const char *label) :
vector_to_stream_ii_base(uuid, label)
{
}

vector_to_stream_ii_i::~vector_to_stream_ii_i()
{
}
...
void vector_to_stream_ii_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI vector_to_stream_ii_i::createOutputSRI( int32_t idx)
{
    //
