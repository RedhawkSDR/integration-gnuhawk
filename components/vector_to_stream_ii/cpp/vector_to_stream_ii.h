...
#ifndef VECTOR_TO_STREAM_II_IMPL_H
#define VECTOR_TO_STREAM_II_IMPL_H

#include "vector_to_stream_ii_base.h"

class vector_to_stream_ii_i : public vector_to_stream_ii_base
{
    public:
        vector_to_stream_ii_i(const char *uuid, const char *label);
        ~vector_to_stream_ii_i();
