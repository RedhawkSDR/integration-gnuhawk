...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_stream_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ii.spd.xml
