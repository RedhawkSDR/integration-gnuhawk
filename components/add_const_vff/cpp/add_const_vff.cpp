...
add_const_vff_i::add_const_vff_i(const char *uuid, const char *label) :
add_const_vff_base(uuid, label)
{
}

add_const_vff_i::~add_const_vff_i()
{
}
...
//      
BULKIO::StreamSRI add_const_vff_i::createOutputSRI( int32_t idx)
{
  //
