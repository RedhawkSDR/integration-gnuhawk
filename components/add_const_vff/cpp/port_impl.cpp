...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Fri Mar 01 15:59:52 EST 2013
 	Redhawk IDE
 	Version:M.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,add_const_vff_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, add_const_vff_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<add_const_vff_i *> (_parent);
