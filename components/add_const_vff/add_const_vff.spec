...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/add_const_vff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vff.spd.xml
