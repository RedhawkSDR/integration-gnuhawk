...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_mag/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag.spd.xml
