...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Tue Mar 05 09:37:37 EST 2013
 	Redhawk IDE
 	Version:M.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,complex_to_mag_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, complex_to_mag_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<complex_to_mag_i *> (_parent);
