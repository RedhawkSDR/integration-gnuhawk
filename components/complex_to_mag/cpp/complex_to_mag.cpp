...
complex_to_mag_i::complex_to_mag_i(const char *uuid, const char *label) :
complex_to_mag_base(uuid, label)
{
}

complex_to_mag_i::~complex_to_mag_i()
{
}
...
//
void complex_to_mag_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_complex_to_mag(this->vlen);
...
//      
BULKIO::StreamSRI complex_to_mag_i::createOutputSRI( int32_t idx)
{
  //
