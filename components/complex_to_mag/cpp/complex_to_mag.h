...
#ifndef COMPLEX_TO_MAG_IMPL_H
#define COMPLEX_TO_MAG_IMPL_H

#include "complex_to_mag_base.h"

class complex_to_mag_i : public complex_to_mag_base
{
   public:
      complex_to_mag_i(const char *uuid, const char *label);
      ~complex_to_mag_i();
