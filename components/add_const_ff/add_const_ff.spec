...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/add_const_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_ff.spd.xml
