...
#ifndef ADDITIVE_SCRAMBLER_BB_IMPL_H
#define ADDITIVE_SCRAMBLER_BB_IMPL_H

#include "additive_scrambler_bb_base.h"

class additive_scrambler_bb_i : public additive_scrambler_bb_base
{
    public:
        additive_scrambler_bb_i(const char *uuid, const char *label);
        ~additive_scrambler_bb_i();
