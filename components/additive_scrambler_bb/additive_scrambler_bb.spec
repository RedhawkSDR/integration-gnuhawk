...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/additive_scrambler_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/additive_scrambler_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/additive_scrambler_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/additive_scrambler_bb.spd.xml
