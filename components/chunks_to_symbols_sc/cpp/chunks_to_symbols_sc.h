...
#ifndef CHUNKS_TO_SYMBOLS_SC_IMPL_H
#define CHUNKS_TO_SYMBOLS_SC_IMPL_H

#include "chunks_to_symbols_sc_base.h"

class chunks_to_symbols_sc_i : public chunks_to_symbols_sc_base
{
    public:
        chunks_to_symbols_sc_i(const char *uuid, const char *label);
        ~chunks_to_symbols_sc_i();
