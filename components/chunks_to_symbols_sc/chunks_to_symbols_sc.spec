...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/chunks_to_symbols_sc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sc.spd.xml
