...
#include "stream_to_streams_bb_3o.h"
...
stream_to_streams_bb_3o_i::stream_to_streams_bb_3o_i(const char *uuid, const char *label) :
stream_to_streams_bb_3o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &stream_to_streams_bb_3o_i::streamIdChanged );
}

stream_to_streams_bb_3o_i::~stream_to_streams_bb_3o_i()
{
}

void stream_to_streams_bb_3o_i::streamIdChanged(const std::string& id)
{ 
...
void stream_to_streams_bb_3o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI stream_to_streams_bb_3o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
