...
probe_signal_b_i::probe_signal_b_i(const char *uuid, const char *label) :
probe_signal_b_base(uuid, label)
{
}

probe_signal_b_i::~probe_signal_b_i()
{
}
...
void probe_signal_b_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_probe_signal_b();

    this->registerGetter("level",
                         &gr_probe_signal_b::level);
