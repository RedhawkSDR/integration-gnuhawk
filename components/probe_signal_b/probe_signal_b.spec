...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_b/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_b.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_b.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_b.spd.xml
