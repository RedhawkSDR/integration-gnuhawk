...
#ifndef KEEP_M_IN_N_SS_IMPL_H
#define KEEP_M_IN_N_SS_IMPL_H

#include "keep_m_in_n_ss_base.h"

class keep_m_in_n_ss_i : public keep_m_in_n_ss_base
{
    public:
        keep_m_in_n_ss_i(const char *uuid, const char *label);
        ~keep_m_in_n_ss_i();
