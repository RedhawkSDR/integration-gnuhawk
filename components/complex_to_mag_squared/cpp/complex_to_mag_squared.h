...
#ifndef COMPLEX_TO_MAG_SQUARED_IMPL_H
#define COMPLEX_TO_MAG_SQUARED_IMPL_H

#include "complex_to_mag_squared_base.h"

class complex_to_mag_squared_i : public complex_to_mag_squared_base
{
   public:
      complex_to_mag_squared_i(const char *uuid, const char *label);
      ~complex_to_mag_squared_i();
