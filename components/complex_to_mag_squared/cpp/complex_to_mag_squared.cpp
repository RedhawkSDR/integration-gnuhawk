...
complex_to_mag_squared_i::complex_to_mag_squared_i(const char *uuid, const char *label) :
complex_to_mag_squared_base(uuid, label)
{
}

complex_to_mag_squared_i::~complex_to_mag_squared_i()
{
}
...
//
void complex_to_mag_squared_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_complex_to_mag_squared(this->vlen);
...
//      
BULKIO::StreamSRI complex_to_mag_squared_i::createOutputSRI( int32_t idx)
{
  //
