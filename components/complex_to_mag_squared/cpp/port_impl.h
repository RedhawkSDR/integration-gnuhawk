...
class complex_to_mag_squared_i;
...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataFloat_Out_i(std::string port_name, complex_to_mag_squared_base *_parent);
    ...
    protected:
        complex_to_mag_squared_i *parent;
...
class BULKIO_dataFloat_In_i : public POA_BULKIO::dataFloat, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataFloat_In_i(std::string port_name, complex_to_mag_squared_base *_parent);
