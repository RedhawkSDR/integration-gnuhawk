...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_mag_squared/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag_squared.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag_squared.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_mag_squared.spd.xml
