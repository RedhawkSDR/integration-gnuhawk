...
#ifndef PEAK_DETECTOR_SB_IMPL_H
#define PEAK_DETECTOR_SB_IMPL_H

#include "peak_detector_sb_base.h"

class peak_detector_sb_i : public peak_detector_sb_base
{
    public:
        peak_detector_sb_i(const char *uuid, const char *label);
        ~peak_detector_sb_i();
