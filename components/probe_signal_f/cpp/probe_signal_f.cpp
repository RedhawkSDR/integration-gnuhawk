...
probe_signal_f_i::probe_signal_f_i(const char *uuid, const char *label) :
probe_signal_f_base(uuid, label)
{
}

probe_signal_f_i::~probe_signal_f_i()
{
}
...
void probe_signal_f_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_probe_signal_f();

    this->registerGetter("level",
                         &gr_probe_signal_f::level);
