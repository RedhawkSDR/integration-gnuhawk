...
Name: complex_to_interleaved_short
...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_interleaved_short/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_interleaved_short.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_interleaved_short.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_interleaved_short.spd.xml
