...
#ifndef COMPLEX_TO_INTERLEAVED_SHORT_IMPL_H
#define COMPLEX_TO_INTERLEAVED_SHORT_IMPL_H

#include "complex_to_interleaved_short_base.h"

class complex_to_interleaved_short_i : public complex_to_interleaved_short_base
{
    public:
        complex_to_interleaved_short_i(const char *uuid, const char *label);
        ~complex_to_interleaved_short_i();
