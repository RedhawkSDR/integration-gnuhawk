...
complex_to_interleaved_short_i::complex_to_interleaved_short_i(const char *uuid, const char *label) :
complex_to_interleaved_short_base(uuid, label)
{
}

complex_to_interleaved_short_i::~complex_to_interleaved_short_i()
{
}
...
void complex_to_interleaved_short_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_complex_to_interleaved_short();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI complex_to_interleaved_short_i::createOutputSRI( int32_t idx)
{
    //
