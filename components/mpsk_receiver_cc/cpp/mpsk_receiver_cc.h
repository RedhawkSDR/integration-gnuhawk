...
#ifndef MPSK_RECEIVER_CC_IMPL_H
#define MPSK_RECEIVER_CC_IMPL_H

#include "mpsk_receiver_cc_base.h"

class mpsk_receiver_cc_i : public mpsk_receiver_cc_base
{
    public:
        mpsk_receiver_cc_i(const char *uuid, const char *label);
        ~mpsk_receiver_cc_i();
