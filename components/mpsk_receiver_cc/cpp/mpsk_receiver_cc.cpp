...
mpsk_receiver_cc_i::mpsk_receiver_cc_i(const char *uuid, const char *label) :
mpsk_receiver_cc_base(uuid, label)
{
}

mpsk_receiver_cc_i::~mpsk_receiver_cc_i()
{
}


float mpsk_receiver_cc_i::modulation_order()
{
    return gr_sptr->modulation_order();
}
...
//      
BULKIO::StreamSRI mpsk_receiver_cc_i::createOutputSRI( int32_t idx)
{
    //
