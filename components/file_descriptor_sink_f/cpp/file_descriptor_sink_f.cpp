...
#include "file_descriptor_sink_f.h"
...
file_descriptor_sink_f_i::file_descriptor_sink_f_i(const char *uuid, const char *label) :
file_descriptor_sink_f_base(uuid, label)
{
}

file_descriptor_sink_f_i::~file_descriptor_sink_f_i()
{
}
...
void file_descriptor_sink_f_i::createBlock()
{
    //
