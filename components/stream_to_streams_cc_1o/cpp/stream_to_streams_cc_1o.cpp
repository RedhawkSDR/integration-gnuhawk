...
#include "stream_to_streams_cc_1o.h"
...
stream_to_streams_cc_1o_i::stream_to_streams_cc_1o_i(const char *uuid, const char *label) :
stream_to_streams_cc_1o_base(uuid, label)
{
}

stream_to_streams_cc_1o_i::~stream_to_streams_cc_1o_i()
{
}
...
void stream_to_streams_cc_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_streams_cc_1o_i::createOutputSRI( int32_t idx)
{
    //
