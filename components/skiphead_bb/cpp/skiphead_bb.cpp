...
skiphead_bb_i::skiphead_bb_i(const char *uuid, const char *label) :
skiphead_bb_base(uuid, label)
{
}

skiphead_bb_i::~skiphead_bb_i()
{
}
...
void skiphead_bb_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI skiphead_bb_i::createOutputSRI( int32_t idx)
{
    //
