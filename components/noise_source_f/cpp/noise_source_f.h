...
#ifndef NOISE_SOURCE_F_IMPL_H
#define NOISE_SOURCE_F_IMPL_H

#include "noise_source_f_base.h"

class noise_source_f_i : public noise_source_f_base
{
   public:
      noise_source_f_i(const char *uuid, const char *label);
      ~noise_source_f_i();
