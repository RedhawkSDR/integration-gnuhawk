...
// Destructor
vector_to_streams_ss_3o_base::~vector_to_streams_ss_3o_base()
{
    // Free input streams
...
BULKIO::StreamSRI vector_to_streams_ss_3o_base::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
...
int vector_to_streams_ss_3o_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int vector_to_streams_ss_3o_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( vector_to_streams_ss_3o_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( vector_to_streams_ss_3o_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( vector_to_streams_ss_3o_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( vector_to_streams_ss_3o_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( vector_to_streams_ss_3o_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
