...
#ifndef PEAK_DETECTOR_IB_IMPL_H
#define PEAK_DETECTOR_IB_IMPL_H

#include "peak_detector_ib_base.h"

class peak_detector_ib_i : public peak_detector_ib_base
{
    public:
        peak_detector_ib_i(const char *uuid, const char *label);
        ~peak_detector_ib_i();
        ...
        float get_threshold_factor_fall();
        int get_look_ahead();
        float get_alpha();
};
