...
#ifndef COMPLEX_TO_FLOAT_1O_IMPL_H
#define COMPLEX_TO_FLOAT_1O_IMPL_H

#include "complex_to_float_1o_base.h"

class complex_to_float_1o_i : public complex_to_float_1o_base
{
   public:
      complex_to_float_1o_i(const char *uuid, const char *label);
      ~complex_to_float_1o_i();
