...
complex_to_float_1o_i::complex_to_float_1o_i(const char *uuid, const char *label) :
complex_to_float_1o_base(uuid, label)
{
}

complex_to_float_1o_i::~complex_to_float_1o_i()
{
}
...
//
void complex_to_float_1o_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI complex_to_float_1o_i::createOutputSRI( int32_t idx)
{
  //
