...
./reconf
%define _bindir %{_prefix}/dom/components/vector_source_b/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_source_b.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_source_b.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_source_b.spd.xml
