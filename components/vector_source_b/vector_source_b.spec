...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_source_b/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_b.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_b.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_b.spd.xml
