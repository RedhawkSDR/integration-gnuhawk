...
#ifndef VECTOR_SOURCE_B_IMPL_H
#define VECTOR_SOURCE_B_IMPL_H

#include "vector_source_b_base.h"

class vector_source_b_i : public vector_source_b_base
{
   public:
      vector_source_b_i(const char *uuid, const char *label);
      ~vector_source_b_i();
