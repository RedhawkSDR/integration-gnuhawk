...
deinterleave_cc_3o_i::deinterleave_cc_3o_i(const char *uuid, const char *label) :
deinterleave_cc_3o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_cc_3o_i::streamIdChanged );
}

deinterleave_cc_3o_i::~deinterleave_cc_3o_i()
{
}

void deinterleave_cc_3o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_cc_3o_i::createBlock()
{
    //
    //
	gr_sptr = gr_make_deinterleave (this->itemsize);
	gr_sptr->check_topology(this->ninputs, this->noutputs);
...
//      
BULKIO::StreamSRI deinterleave_cc_3o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
