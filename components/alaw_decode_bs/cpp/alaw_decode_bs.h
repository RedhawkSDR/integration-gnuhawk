...
#ifndef ALAW_DECODE_BS_IMPL_H
#define ALAW_DECODE_BS_IMPL_H

#include "alaw_decode_bs_base.h"

class alaw_decode_bs_i : public alaw_decode_bs_base
{
    public:
        alaw_decode_bs_i(const char *uuid, const char *label);
        ~alaw_decode_bs_i();
