...
pll_refout_cc_i::pll_refout_cc_i(const char *uuid, const char *label) :
pll_refout_cc_base(uuid, label)
{
}

pll_refout_cc_i::~pll_refout_cc_i()
{
}
...
void pll_refout_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_pll_refout_cc( this->loop_bw, this->max_freq, this->min_freq );
...
//      
BULKIO::StreamSRI pll_refout_cc_i::createOutputSRI( int32_t idx)
{
    //
