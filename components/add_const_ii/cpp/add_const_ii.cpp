...
add_const_ii_i::add_const_ii_i(const char *uuid, const char *label) :
add_const_ii_base(uuid, label)
{
}

add_const_ii_i::~add_const_ii_i()
{
}
...
//
void add_const_ii_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_add_const_ii(k);
  ...
  setupIOMappings();
  registerGetterSetter("k", &gr_add_const_ii::k, &gr_add_const_ii::set_k);
} 
...
//      
BULKIO::StreamSRI add_const_ii_i::createOutputSRI( int32_t idx)
{
  //
