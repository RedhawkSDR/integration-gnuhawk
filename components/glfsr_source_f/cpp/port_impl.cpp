...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Tue Mar 05 08:07:33 EST 2013
 	Redhawk IDE
 	Version:M.1.8.3
...
#include "glfsr_source_f.h"


//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,glfsr_source_f_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, glfsr_source_f_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<glfsr_source_f_i *> (_parent);
