...
glfsr_source_f_i::glfsr_source_f_i(const char *uuid, const char *label) :
glfsr_source_f_base(uuid, label)
{
}

glfsr_source_f_i::~glfsr_source_f_i()
{
}

void glfsr_source_f_i::changedSamplingFreq(const std::string &id)
{
...
//
void glfsr_source_f_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI glfsr_source_f_i::createOutputSRI( int32_t idx)
{
  //
