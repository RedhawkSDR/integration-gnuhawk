...
#ifndef GLFSR_SOURCE_F_IMPL_H
#define GLFSR_SOURCE_F_IMPL_H

#include "glfsr_source_f_base.h"

class glfsr_source_f_i : public glfsr_source_f_base
{
   public:
      glfsr_source_f_i(const char *uuid, const char *label);
      ~glfsr_source_f_i();
