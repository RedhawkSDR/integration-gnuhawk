...
copy_ii_i::copy_ii_i(const char *uuid, const char *label) :
copy_ii_base(uuid, label)
{
}
...
//      
BULKIO::StreamSRI copy_ii_i::createOutputSRI( int32_t idx)
{
    //
