...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/packed_to_unpacked_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ii.spd.xml
