...
#ifndef PACKED_TO_UNPACKED_II_IMPL_H
#define PACKED_TO_UNPACKED_II_IMPL_H

#include "packed_to_unpacked_ii_base.h"

class packed_to_unpacked_ii_i : public packed_to_unpacked_ii_base
{
    public:
        packed_to_unpacked_ii_i(const char *uuid, const char *label);
        ~packed_to_unpacked_ii_i();
