...
packed_to_unpacked_ii_i::packed_to_unpacked_ii_i(const char *uuid, const char *label) :
packed_to_unpacked_ii_base(uuid, label)
{
}

packed_to_unpacked_ii_i::~packed_to_unpacked_ii_i()
{
}
...
void packed_to_unpacked_ii_i::createBlock()
{
    //
    ...
    gr_sptr = gr_make_packed_to_unpacked_ii(this->bits_per_chunk, end);
...
//      
BULKIO::StreamSRI packed_to_unpacked_ii_i::createOutputSRI( int32_t idx)
{
    //
