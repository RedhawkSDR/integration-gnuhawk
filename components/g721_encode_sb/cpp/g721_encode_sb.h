...
#ifndef G721_ENCODE_SB_IMPL_H
#define G721_ENCODE_SB_IMPL_H

#include "g721_encode_sb_base.h"

class g721_encode_sb_i : public g721_encode_sb_base
{
    public:
        g721_encode_sb_i(const char *uuid, const char *label);
        ~g721_encode_sb_i();
