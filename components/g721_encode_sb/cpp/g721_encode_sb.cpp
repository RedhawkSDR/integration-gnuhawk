...
g721_encode_sb_i::g721_encode_sb_i(const char *uuid, const char *label) :
g721_encode_sb_base(uuid, label)
{
}

g721_encode_sb_i::~g721_encode_sb_i()
{
}
...
void g721_encode_sb_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = vocoder_make_g721_encode_sb();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI g721_encode_sb_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
