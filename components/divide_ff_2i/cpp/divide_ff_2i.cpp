...
divide_ff_2i_i::divide_ff_2i_i(const char *uuid, const char *label) :
divide_ff_2i_base(uuid, label)
{
}

divide_ff_2i_i::~divide_ff_2i_i()
{
}
...
void divide_ff_2i_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_divide_ff( this->vlen);
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI divide_ff_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
