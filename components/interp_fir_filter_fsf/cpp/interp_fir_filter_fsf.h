...
#ifndef INTERP_FIR_FILTER_FSF_IMPL_H
#define INTERP_FIR_FILTER_FSF_IMPL_H

#include "interp_fir_filter_fsf_base.h"

class interp_fir_filter_fsf_i : public interp_fir_filter_fsf_base
{
    public:
        interp_fir_filter_fsf_i(const char *uuid, const char *label);
        ~interp_fir_filter_fsf_i();
