...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fir_filter_fcc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fcc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fcc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fcc.spd.xml
