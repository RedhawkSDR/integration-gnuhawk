...
#ifndef FIR_FILTER_FCC_IMPL_H
#define FIR_FILTER_FCC_IMPL_H

#include "fir_filter_fcc_base.h"

class fir_filter_fcc_i : public fir_filter_fcc_base
{
    public:
        fir_filter_fcc_i(const char *uuid, const char *label);
        ~fir_filter_fcc_i();
