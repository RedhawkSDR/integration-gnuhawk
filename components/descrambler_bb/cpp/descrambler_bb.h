...
#ifndef DESCRAMBLER_BB_IMPL_H
#define DESCRAMBLER_BB_IMPL_H

#include "descrambler_bb_base.h"

class descrambler_bb_i : public descrambler_bb_base
{
    public:
        descrambler_bb_i(const char *uuid, const char *label);
        ~descrambler_bb_i();
