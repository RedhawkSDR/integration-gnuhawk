...
#include "file_descriptor_sink_b.h"
...
file_descriptor_sink_b_i::file_descriptor_sink_b_i(const char *uuid, const char *label) :
file_descriptor_sink_b_base(uuid, label)
{
}

file_descriptor_sink_b_i::~file_descriptor_sink_b_i()
{
}
...
void file_descriptor_sink_b_i::createBlock()
{
    //
