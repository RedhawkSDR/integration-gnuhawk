...
xor_ss_4i_i::xor_ss_4i_i(const char *uuid, const char *label) :
xor_ss_4i_base(uuid, label)
{
}

xor_ss_4i_i::~xor_ss_4i_i()
{
}
...
//      
BULKIO::StreamSRI xor_ss_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
