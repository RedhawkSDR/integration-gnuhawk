...
int xor_ss_4i_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int xor_ss_4i_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( xor_ss_4i_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( xor_ss_4i_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( xor_ss_4i_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( xor_ss_4i_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( xor_ss_4i_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
