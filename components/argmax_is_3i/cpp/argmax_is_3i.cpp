...
argmax_is_3i_i::argmax_is_3i_i(const char *uuid, const char *label) :
argmax_is_3i_base(uuid, label)
{
}

argmax_is_3i_i::~argmax_is_3i_i()
{
}
...
void argmax_is_3i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI argmax_is_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
