...
#ifndef STREAMS_TO_STREAM_II_3I_IMPL_H
#define STREAMS_TO_STREAM_II_3I_IMPL_H

#include "streams_to_stream_ii_3i_base.h"

class streams_to_stream_ii_3i_i : public streams_to_stream_ii_3i_base
{
    public:
        streams_to_stream_ii_3i_i(const char *uuid, const char *label);
        ~streams_to_stream_ii_3i_i();
