...
%define _namespace gnuhawk/gr/modulator
...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vco_f/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vco_f.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vco_f.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vco_f.spd.xml
