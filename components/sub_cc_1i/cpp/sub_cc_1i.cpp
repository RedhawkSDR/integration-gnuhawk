...
sub_cc_1i_i::sub_cc_1i_i(const char *uuid, const char *label) :
sub_cc_1i_base(uuid, label)
{
}

sub_cc_1i_i::~sub_cc_1i_i()
{
}
...
//      
BULKIO::StreamSRI sub_cc_1i_i::createOutputSRI( int32_t idx)
{
    //
