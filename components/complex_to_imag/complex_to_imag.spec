...
./reconf
%define _bindir %{_prefix}/dom/components/complex_to_imag/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_imag.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_imag.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_imag.spd.xml
