...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_imag/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_imag.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_imag.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_imag.spd.xml
