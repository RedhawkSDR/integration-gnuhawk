...
#ifndef COMPLEX_TO_IMAG_IMPL_H
#define COMPLEX_TO_IMAG_IMPL_H

#include "complex_to_imag_base.h"

class complex_to_imag_i : public complex_to_imag_base
{
   public:
      complex_to_imag_i(const char *uuid, const char *label);
      ~complex_to_imag_i();
