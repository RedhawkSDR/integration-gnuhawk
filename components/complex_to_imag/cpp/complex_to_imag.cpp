...
complex_to_imag_i::complex_to_imag_i(const char *uuid, const char *label) :
complex_to_imag_base(uuid, label)
{
}

complex_to_imag_i::~complex_to_imag_i()
{
}
...
//
void complex_to_imag_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_complex_to_imag(this->vlen);
...
//      
BULKIO::StreamSRI complex_to_imag_i::createOutputSRI( int32_t idx)
{
  //
