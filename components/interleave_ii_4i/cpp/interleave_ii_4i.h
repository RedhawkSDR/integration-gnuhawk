...
#ifndef INTERLEAVE_II_4I_IMPL_H
#define INTERLEAVE_II_4I_IMPL_H

#include "interleave_ii_4i_base.h"

class interleave_ii_4i_i : public interleave_ii_4i_base
{
    public:
        interleave_ii_4i_i(const char *uuid, const char *label);
        ~interleave_ii_4i_i();
