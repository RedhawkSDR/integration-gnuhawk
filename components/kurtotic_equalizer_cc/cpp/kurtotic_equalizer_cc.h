...
#ifndef KURTOTIC_EQUALIZER_CC_IMPL_H
#define KURTOTIC_EQUALIZER_CC_IMPL_H

#include "kurtotic_equalizer_cc_base.h"

class kurtotic_equalizer_cc_i : public kurtotic_equalizer_cc_base
{
    public:
        kurtotic_equalizer_cc_i(const char *uuid, const char *label);
        ~kurtotic_equalizer_cc_i();
