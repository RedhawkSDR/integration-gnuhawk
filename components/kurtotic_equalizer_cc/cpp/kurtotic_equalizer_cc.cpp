...
kurtotic_equalizer_cc_i::kurtotic_equalizer_cc_i(const char *uuid, const char *label) :
kurtotic_equalizer_cc_base(uuid, label)
{
}

kurtotic_equalizer_cc_i::~kurtotic_equalizer_cc_i()
{
}

void kurtotic_equalizer_cc_i::set_taps(const std::string &id)
{
...
void kurtotic_equalizer_cc_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = digital_make_kurtotic_equalizer_cc( this->num_taps, this->mu );
    } catch (...) {
        return;
    }

    this->registerSetter("mu", &digital_kurtotic_equalizer_cc::set_gain);
    this->setPropertyChangeListener("taps", this, &kurtotic_equalizer_cc_i::set_taps);
...
//      
BULKIO::StreamSRI kurtotic_equalizer_cc_i::createOutputSRI( int32_t idx)
{
    //
