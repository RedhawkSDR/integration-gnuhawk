...
//       }This section describes general information about this component.
//       return 0.0;
//    }
//    void component_class_i::createBlock()
//    {
...
null_sink_c_i::null_sink_c_i(const char *uuid, const char *label) :
null_sink_c_base(uuid, label)
{
}

null_sink_c_i::~null_sink_c_i()
{
}
...
void null_sink_c_i::createBlock()
{
    //
	...
	try {
        gr_sptr = gr_make_null_sink (this->sizeof_stream_item);
	}
	catch (...) {
		return;
	}
