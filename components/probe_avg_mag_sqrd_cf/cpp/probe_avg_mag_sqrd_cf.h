...
#ifndef PROBE_AVG_MAG_SQRD_CF_IMPL_H
#define PROBE_AVG_MAG_SQRD_CF_IMPL_H

#include "probe_avg_mag_sqrd_cf_base.h"

class probe_avg_mag_sqrd_cf_i : public probe_avg_mag_sqrd_cf_base
{
    public:
        probe_avg_mag_sqrd_cf_i(const char *uuid, const char *label);
        ~probe_avg_mag_sqrd_cf_i();
