...
#ifndef COSTAS_LOOP_CC_2O_IMPL_H
#define COSTAS_LOOP_CC_2O_IMPL_H

#include "costas_loop_cc_2o_base.h"

class costas_loop_cc_2o_i : public costas_loop_cc_2o_base
{
    public:
        costas_loop_cc_2o_i(const char *uuid, const char *label);
        ~costas_loop_cc_2o_i();
