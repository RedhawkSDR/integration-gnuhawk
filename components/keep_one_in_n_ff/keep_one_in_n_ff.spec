...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/keep_one_in_n_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ff.spd.xml
