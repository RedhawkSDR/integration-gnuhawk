...
keep_one_in_n_ff_i::keep_one_in_n_ff_i(const char *uuid, const char *label) :
keep_one_in_n_ff_base(uuid, label)
{
}

keep_one_in_n_ff_i::~keep_one_in_n_ff_i()
{
}
...
void keep_one_in_n_ff_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI keep_one_in_n_ff_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
