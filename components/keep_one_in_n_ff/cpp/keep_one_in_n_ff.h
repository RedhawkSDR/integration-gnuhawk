...
#ifndef KEEP_ONE_IN_N_FF_IMPL_H
#define KEEP_ONE_IN_N_FF_IMPL_H

#include "keep_one_in_n_ff_base.h"

class keep_one_in_n_ff_i : public keep_one_in_n_ff_base
{
    public:
        keep_one_in_n_ff_i(const char *uuid, const char *label);
        ~keep_one_in_n_ff_i();
