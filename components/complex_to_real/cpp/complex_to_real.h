...
#ifndef COMPLEX_TO_REAL_IMPL_H
#define COMPLEX_TO_REAL_IMPL_H

#include "complex_to_real_base.h"

class complex_to_real_i : public complex_to_real_base
{
   public:
      complex_to_real_i(const char *uuid, const char *label);
      ~complex_to_real_i();
