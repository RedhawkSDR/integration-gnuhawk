...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_real/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_real.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_real.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_real.spd.xml
