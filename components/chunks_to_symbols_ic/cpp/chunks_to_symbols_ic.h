...
#ifndef CHUNKS_TO_SYMBOLS_IC_IMPL_H
#define CHUNKS_TO_SYMBOLS_IC_IMPL_H

#include "chunks_to_symbols_ic_base.h"

class chunks_to_symbols_ic_i : public chunks_to_symbols_ic_base
{
    public:
        chunks_to_symbols_ic_i(const char *uuid, const char *label);
        ~chunks_to_symbols_ic_i();
