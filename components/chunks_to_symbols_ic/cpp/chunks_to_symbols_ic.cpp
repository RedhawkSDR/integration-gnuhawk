...
#include "chunks_to_symbols_ic.h"
...
chunks_to_symbols_ic_i::chunks_to_symbols_ic_i(const char *uuid, const char *label) :
chunks_to_symbols_ic_base(uuid, label)
{
}

chunks_to_symbols_ic_i::~chunks_to_symbols_ic_i()
{
}
...
void chunks_to_symbols_ic_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_chunks_to_symbols_ic( this->symbol_table, this->D );

    this->registerGetter("symbol_table", &gr_chunks_to_symbols_ic::symbol_table);
    this->registerGetter("D", &gr_chunks_to_symbols_ic::D);
...
//      
BULKIO::StreamSRI chunks_to_symbols_ic_i::createOutputSRI( int32_t idx)
{
    //
