...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/chunks_to_symbols_ic/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_ic.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_ic.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_ic.spd.xml
