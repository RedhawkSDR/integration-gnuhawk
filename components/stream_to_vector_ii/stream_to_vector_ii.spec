...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/stream_to_vector_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ii.spd.xml
