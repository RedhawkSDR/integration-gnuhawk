...
#ifndef STREAM_TO_VECTOR_II_IMPL_H
#define STREAM_TO_VECTOR_II_IMPL_H

#include "stream_to_vector_ii_base.h"

class stream_to_vector_ii_i : public stream_to_vector_ii_base
{
    public:
        stream_to_vector_ii_i(const char *uuid, const char *label);
        ~stream_to_vector_ii_i();
