...
stream_to_vector_ii_i::stream_to_vector_ii_i(const char *uuid, const char *label) :
stream_to_vector_ii_base(uuid, label)
{
}

stream_to_vector_ii_i::~stream_to_vector_ii_i()
{
}
...
void stream_to_vector_ii_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_vector_ii_i::createOutputSRI( int32_t idx)
{
    //
