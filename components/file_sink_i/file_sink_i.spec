...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/file_sink_i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_i.spd.xml
