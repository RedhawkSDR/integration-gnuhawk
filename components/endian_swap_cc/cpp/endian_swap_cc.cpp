...
endian_swap_cc_i::endian_swap_cc_i(const char *uuid, const char *label) :
endian_swap_cc_base(uuid, label)
{
}

endian_swap_cc_i::~endian_swap_cc_i()
{
}
...
void endian_swap_cc_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI endian_swap_cc_i::createOutputSRI( int32_t idx)
{
    //
