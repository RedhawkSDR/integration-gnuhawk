...
#ifndef ENDIAN_SWAP_CC_IMPL_H
#define ENDIAN_SWAP_CC_IMPL_H

#include "endian_swap_cc_base.h"

class endian_swap_cc_i : public endian_swap_cc_base
{
    public:
        endian_swap_cc_i(const char *uuid, const char *label);
        ~endian_swap_cc_i();
