...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Thu Feb 28 15:17:57 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,quadrature_demod_cf_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, quadrature_demod_cf_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<quadrature_demod_cf_i *> (_parent);
...
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_In_i::BULKIO_dataFloat_In_i(std::string port_name,  SRIListener *listener , SRICompare cmpFunc) : 
...
bool BULKIO_dataFloat_In_i::blocked()
{
    return breakBlock;
}
