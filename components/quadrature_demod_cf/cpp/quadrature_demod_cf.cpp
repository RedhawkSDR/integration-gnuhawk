...
quadrature_demod_cf_i::quadrature_demod_cf_i(const char *uuid, const char *label) :
quadrature_demod_cf_base(uuid, label)
{
}

quadrature_demod_cf_i::~quadrature_demod_cf_i()
{
}
...
//
void quadrature_demod_cf_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_quadrature_demod_cf(this->gain);
  ...
  // maintainTimestamp( bool onoff );
   ...
   setupIOMappings();
   this->registerGetterSetter("gain", &gr_quadrature_demod_cf::gain, &gr_quadrature_demod_cf::set_gain);
...
//      
BULKIO::StreamSRI quadrature_demod_cf_i::createOutputSRI( int32_t idx)
{
  //
