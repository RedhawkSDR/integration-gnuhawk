...
#ifndef QUADRATURE_DEMOD_CF_IMPL_H
#define QUADRATURE_DEMOD_CF_IMPL_H

#include "quadrature_demod_cf_base.h"

class quadrature_demod_cf_i : public quadrature_demod_cf_base
{
   public:
      quadrature_demod_cf_i(const char *uuid, const char *label);
      ~quadrature_demod_cf_i();
