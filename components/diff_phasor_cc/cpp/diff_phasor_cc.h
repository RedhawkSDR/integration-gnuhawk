...
#ifndef DIFF_PHASOR_CC_IMPL_H
#define DIFF_PHASOR_CC_IMPL_H

#include "diff_phasor_cc_base.h"

class diff_phasor_cc_i : public diff_phasor_cc_base
{
    public:
        diff_phasor_cc_i(const char *uuid, const char *label);
        ~diff_phasor_cc_i();
