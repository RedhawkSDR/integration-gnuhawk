...
interp_fir_filter_fff_i::interp_fir_filter_fff_i(const char *uuid, const char *label) :
interp_fir_filter_fff_base(uuid, label)
{
}

interp_fir_filter_fff_i::~interp_fir_filter_fff_i()
{
}

void interp_fir_filter_fff_i::setTaps(const std::string &id){
...
//
void interp_fir_filter_fff_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI interp_fir_filter_fff_i::createOutputSRI( int32_t idx)
{
  //
