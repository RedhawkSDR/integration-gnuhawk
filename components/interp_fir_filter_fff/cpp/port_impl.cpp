...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,interp_fir_filter_fff_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, interp_fir_filter_fff_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<interp_fir_filter_fff_i *> (_parent);
