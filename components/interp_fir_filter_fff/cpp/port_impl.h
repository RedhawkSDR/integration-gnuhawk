...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataFloat_Out_i(std::string port_name, interp_fir_filter_fff_base *_parent);
    ...
    protected:
        interp_fir_filter_fff_i *parent;
...
class BULKIO_dataFloat_In_i : public POA_BULKIO::dataFloat, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataFloat_In_i(std::string port_name, interp_fir_filter_fff_base *_parent);
