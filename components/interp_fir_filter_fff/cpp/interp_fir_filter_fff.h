...
#ifndef INTERP_FIR_FILTER_FFF_IMPL_H
#define INTERP_FIR_FILTER_FFF_IMPL_H

#include "interp_fir_filter_fff_base.h"

class interp_fir_filter_fff_i : public interp_fir_filter_fff_base
{
   public:
      interp_fir_filter_fff_i(const char *uuid, const char *label);
      ~interp_fir_filter_fff_i();
