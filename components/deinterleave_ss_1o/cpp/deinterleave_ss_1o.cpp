...
deinterleave_ss_1o_i::deinterleave_ss_1o_i(const char *uuid, const char *label) :
deinterleave_ss_1o_base(uuid, label)
{
}

deinterleave_ss_1o_i::~deinterleave_ss_1o_i()
{
}
...
void deinterleave_ss_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI deinterleave_ss_1o_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
