...
divide_ii_2i_i::divide_ii_2i_i(const char *uuid, const char *label) :
divide_ii_2i_base(uuid, label)
{
}

divide_ii_2i_i::~divide_ii_2i_i()
{
}
...
void divide_ii_2i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI divide_ii_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
