...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/iqcomp_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iqcomp_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iqcomp_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iqcomp_cc.spd.xml
