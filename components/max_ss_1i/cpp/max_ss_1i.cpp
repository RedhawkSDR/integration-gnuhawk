...
max_ss_1i_i::max_ss_1i_i(const char *uuid, const char *label) :
max_ss_1i_base(uuid, label)
{
}

max_ss_1i_i::~max_ss_1i_i()
{
}
...
//      
BULKIO::StreamSRI max_ss_1i_i::createOutputSRI( int32_t idx)
{
    //
