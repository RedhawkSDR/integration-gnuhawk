...
pfb_channelizer_ccf_5i5o_i::pfb_channelizer_ccf_5i5o_i(const char *uuid, const char *label) :
pfb_channelizer_ccf_5i5o_base(uuid, label)
{
}

pfb_channelizer_ccf_5i5o_i::~pfb_channelizer_ccf_5i5o_i()
{
}
...
void pfb_channelizer_ccf_5i5o_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr::filter::pfb_channelizer_ccf::make(numchans, taps, oversample_rate);
    } catch (...) {
        return;
    }

    this->registerSetter("channel_map", &gr::filter::pfb_channelizer_ccf::set_channel_map);
    this->registerGetter("channel_map", &gr::filter::pfb_channelizer_ccf::channel_map);
    this->registerSetter("taps", &gr::filter::pfb_channelizer_ccf::set_taps);
...
//      
BULKIO::StreamSRI pfb_channelizer_ccf_5i5o_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
