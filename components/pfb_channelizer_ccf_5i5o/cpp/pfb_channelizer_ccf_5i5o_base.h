...
#ifndef PFB_CHANNELIZER_CCF_5I5O_IMPL_BASE_H
#define PFB_CHANNELIZER_CCF_5I5O_IMPL_BASE_H
...
#include "pfb_channelizer_ccf_5i5o_GnuHawkBlock.h"

#define NOOP 0
#define FINISH -1
#define NORMAL 1

class pfb_channelizer_ccf_5i5o_base;
...
class pfb_channelizer_ccf_5i5o_base : public GnuHawkBlock
{
    public:
        pfb_channelizer_ccf_5i5o_base(const char *uuid, const char *label);
        ...
        ~pfb_channelizer_ccf_5i5o_base();

        void loadProperties();

    protected:
        ProcessThread<pfb_channelizer_ccf_5i5o_base> *serviceThread; 
        ...
        std::vector<CORBA::Long> channel_map;
        ...
        bulkio::OutFloatPort *complex_out_0;
        bulkio::OutFloatPort *complex_out_1;
        bulkio::OutFloatPort *complex_out_2;
        bulkio::OutFloatPort *complex_out_3;
        bulkio::OutFloatPort *complex_out_4;
    ...
    struct gr_istream_base {
        ...
        void _check( int inMode , bool force=false) {
            ...
            try {
                ...
                LOG_TRACE( pfb_channelizer_ccf_5i5o_base, "UNABLE TO SET VLEN, BAD INDEX:" << _idx );
            }
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( pfb_channelizer_ccf_5i5o_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( pfb_channelizer_ccf_5i5o_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( pfb_channelizer_ccf_5i5o_base, " serviceFunction: retval:" << retval);
