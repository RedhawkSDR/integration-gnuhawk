...
#ifndef PFB_CHANNELIZER_CCF_5I5O_IMPL_H
#define PFB_CHANNELIZER_CCF_5I5O_IMPL_H

#include "pfb_channelizer_ccf_5i5o_base.h"

class pfb_channelizer_ccf_5i5o_i : public pfb_channelizer_ccf_5i5o_base
{
    public:
        pfb_channelizer_ccf_5i5o_i(const char *uuid, const char *label);
        ~pfb_channelizer_ccf_5i5o_i();
