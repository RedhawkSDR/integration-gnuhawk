...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Mon Feb 25 13:09:40 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,add_const_sf_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, add_const_sf_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<add_const_sf_i *> (_parent);
    ...
    if (active) {
        ...
        for (i = outConnections.begin(); i != outConnections.end(); ++i) {
            try {
                ...
                //RESOLVE LOG_ERROR(BULKIO_dataFloat_Out_i, "Call to pushSRI by BULKIO_dataFloat_Out_i failed");
            }
        }
    }
...
// ----------------------------------------------------------------------------------------
BULKIO_dataShort_In_i::BULKIO_dataShort_In_i(std::string port_name,  SRIListener *listener , SRICompare cmpFunc) : 
...
bool BULKIO_dataShort_In_i::blocked()
{
    return breakBlock;
}
 ...
 */
BULKIO_dataShort_In_i::dataTransfer *BULKIO_dataShort_In_i::getPacket(float timeout, std::string streamID )
{
    if (breakBlock) {
        return NULL;
    }
    ...
    BULKIO_dataShort_In_i::dataTransfer *tmp = NULL;
    if ( streamID == "" ){
        tmp = workQueue.front();
        workQueue.pop_front();
    } else {
