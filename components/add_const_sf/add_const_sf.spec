...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/add_const_sf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_sf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_sf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_sf.spd.xml
