...
./reconf
%define _bindir %{_prefix}/dom/components/sig_source_f/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/sig_source_f.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/sig_source_f.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/sig_source_f.spd.xml
