...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/sig_source_f/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sig_source_f.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sig_source_f.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sig_source_f.spd.xml
