...
sig_source_f_i::sig_source_f_i(const char *uuid, const char *label) :
sig_source_f_base(uuid, label)
{
}

sig_source_f_i::~sig_source_f_i()
{
}
...
//      
BULKIO::StreamSRI sig_source_f_i::createOutputSRI( int32_t idx)
{
  //
