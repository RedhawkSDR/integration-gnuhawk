...
#ifndef CMA_EQUALIZER_CC_IMPL_H
#define CMA_EQUALIZER_CC_IMPL_H

#include "cma_equalizer_cc_base.h"

class cma_equalizer_cc_i : public cma_equalizer_cc_base
{
    public:
        cma_equalizer_cc_i(const char *uuid, const char *label);
        ~cma_equalizer_cc_i();
        ...
        void set_modulus(const std::string &id);
        float get_gain();
        float get_modulus();
};
