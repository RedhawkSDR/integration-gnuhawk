...
tagged_file_sink_s_i::tagged_file_sink_s_i(const char *uuid, const char *label) :
tagged_file_sink_s_base(uuid, label)
{
}

tagged_file_sink_s_i::~tagged_file_sink_s_i()
{
}
...
void tagged_file_sink_s_i::createBlock()
{
    //
