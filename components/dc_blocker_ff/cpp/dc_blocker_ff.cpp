...
dc_blocker_ff_i::dc_blocker_ff_i(const char *uuid, const char *label) :
dc_blocker_ff_base(uuid, label)
{
}

dc_blocker_ff_i::~dc_blocker_ff_i()
{
}
...
//
void dc_blocker_ff_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI dc_blocker_ff_i::createOutputSRI( int32_t idx)
{
  //
