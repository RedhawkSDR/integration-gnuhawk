...
#ifndef STREAM_TO_STREAMS_CC_4O_IMPL_H
#define STREAM_TO_STREAMS_CC_4O_IMPL_H

#include "stream_to_streams_cc_4o_base.h"

class stream_to_streams_cc_4o_i : public stream_to_streams_cc_4o_base
{
    public:
        stream_to_streams_cc_4o_i(const char *uuid, const char *label);
        ~stream_to_streams_cc_4o_i();
        ...
        //      
        BULKIO::StreamSRI  createOutputSRI( int32_t i, int32_t &idx, std::string &ext );
};
