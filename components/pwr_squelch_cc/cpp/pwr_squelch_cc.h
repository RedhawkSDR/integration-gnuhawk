...
#ifndef PWR_SQUELCH_CC_IMPL_H
#define PWR_SQUELCH_CC_IMPL_H

#include "pwr_squelch_cc_base.h"

class pwr_squelch_cc_i : public pwr_squelch_cc_base
{
    public:
        pwr_squelch_cc_i(const char *uuid, const char *label);
        ~pwr_squelch_cc_i();
