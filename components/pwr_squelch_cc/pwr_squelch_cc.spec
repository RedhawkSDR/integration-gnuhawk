...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/pwr_squelch_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_cc.spd.xml
