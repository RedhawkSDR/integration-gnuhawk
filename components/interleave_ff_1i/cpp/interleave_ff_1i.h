...
#ifndef INTERLEAVE_FF_1I_IMPL_H
#define INTERLEAVE_FF_1I_IMPL_H

#include "interleave_ff_1i_base.h"

class interleave_ff_1i_i : public interleave_ff_1i_base
{
    public:
        interleave_ff_1i_i(const char *uuid, const char *label);
        ~interleave_ff_1i_i();
