...
#ifndef VECTOR_SOURCE_S_IMPL_H
#define VECTOR_SOURCE_S_IMPL_H

#include "vector_source_s_base.h"

class vector_source_s_i : public vector_source_s_base
{
   public:
      vector_source_s_i(const char *uuid, const char *label);
      ~vector_source_s_i();
