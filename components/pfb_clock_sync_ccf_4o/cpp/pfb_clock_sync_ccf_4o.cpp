...
pfb_clock_sync_ccf_4o_i::~pfb_clock_sync_ccf_4o_i()
{
}
void pfb_clock_sync_ccf_4o_i::streamIdChanged(const std::string& id)
{ 
...
//      
BULKIO::StreamSRI pfb_clock_sync_ccf_4o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
  //
