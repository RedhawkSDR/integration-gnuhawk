...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_sink_f/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_f.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_f.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_f.spd.xml
