...
./reconf
%define _bindir %{_prefix}/dom/components/vector_sink_f/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_f.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_f.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_f.spd.xml
