...
repeat_ss_i::repeat_ss_i(const char *uuid, const char *label) :
repeat_ss_base(uuid, label)
{
}

repeat_ss_i::~repeat_ss_i()
{
}
...
//      
BULKIO::StreamSRI repeat_ss_i::createOutputSRI( int32_t idx)
{
    //
