...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/float_to_char/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_char.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_char.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_char.spd.xml
