...
#ifndef KEEP_ONE_IN_N_CC_IMPL_H
#define KEEP_ONE_IN_N_CC_IMPL_H

#include "keep_one_in_n_cc_base.h"

class keep_one_in_n_cc_i : public keep_one_in_n_cc_base
{
    public:
        keep_one_in_n_cc_i(const char *uuid, const char *label);
        ~keep_one_in_n_cc_i();
