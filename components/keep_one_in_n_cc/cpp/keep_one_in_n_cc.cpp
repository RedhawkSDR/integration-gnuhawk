...
keep_one_in_n_cc_i::keep_one_in_n_cc_i(const char *uuid, const char *label) :
keep_one_in_n_cc_base(uuid, label)
{
}

keep_one_in_n_cc_i::~keep_one_in_n_cc_i()
{
}
...
void keep_one_in_n_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
    try{
    	this->gr_sptr = gr_make_keep_one_in_n (this->item_size, this->n);
    }
    catch(...){
    	return;
    }
...
//      
BULKIO::StreamSRI keep_one_in_n_cc_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
