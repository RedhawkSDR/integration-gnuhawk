...
#ifndef MOVING_AVERAGE_FF_IMPL_H
#define MOVING_AVERAGE_FF_IMPL_H

#include "moving_average_ff_base.h"

class moving_average_ff_i : public moving_average_ff_base
{
    public:
        moving_average_ff_i(const char *uuid, const char *label);
        ~moving_average_ff_i();
        ...
        void set_length_and_scale(const std::string &id);
};
