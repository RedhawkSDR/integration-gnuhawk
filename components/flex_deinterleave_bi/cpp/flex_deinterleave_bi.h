...
#ifndef FLEX_DEINTERLEAVE_BI_IMPL_H
#define FLEX_DEINTERLEAVE_BI_IMPL_H

#include "flex_deinterleave_bi_base.h"

class flex_deinterleave_bi_i : public flex_deinterleave_bi_base
{
    public:
        flex_deinterleave_bi_i(const char *uuid, const char *label);
        ~flex_deinterleave_bi_i();
