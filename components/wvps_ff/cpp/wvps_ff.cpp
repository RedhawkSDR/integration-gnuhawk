...
wvps_ff_i::wvps_ff_i(const char *uuid, const char *label) :
wvps_ff_base(uuid, label)
{
}
...
void wvps_ff_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = wavelet_make_wvps_ff( this->ilen );
...
//      
BULKIO::StreamSRI wvps_ff_i::createOutputSRI( int32_t idx)
{
    //
