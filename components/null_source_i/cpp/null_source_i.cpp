...
null_source_i_i::null_source_i_i(const char *uuid, const char *label) :
null_source_i_base(uuid, label)
{
}

null_source_i_i::~null_source_i_i()
{
}

void null_source_i_i::changedSamplingFreq(const std::string &id)
{
...
void null_source_i_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("sampling_freq", this, &null_source_i_i::changedSamplingFreq);
...
//      
BULKIO::StreamSRI null_source_i_i::createOutputSRI( int32_t idx)
{
    //
