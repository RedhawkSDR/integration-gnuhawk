...
#ifndef UNPACKED_TO_PACKED_II_IMPL_H
#define UNPACKED_TO_PACKED_II_IMPL_H

#include "unpacked_to_packed_ii_base.h"

class unpacked_to_packed_ii_i : public unpacked_to_packed_ii_base
{
    public:
        unpacked_to_packed_ii_i(const char *uuid, const char *label);
        ~unpacked_to_packed_ii_i();
