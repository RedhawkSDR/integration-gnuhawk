...
unpacked_to_packed_ii_i::unpacked_to_packed_ii_i(const char *uuid, const char *label) :
unpacked_to_packed_ii_base(uuid, label)
{
}

unpacked_to_packed_ii_i::~unpacked_to_packed_ii_i()
{
}
...
void unpacked_to_packed_ii_i::createBlock()
{
    //
    ...
    gr_sptr = gr_make_unpacked_to_packed_ii(this->bits_per_chunk, end);
...
//      
BULKIO::StreamSRI unpacked_to_packed_ii_i::createOutputSRI( int32_t idx)
{
    //
