...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/unpacked_to_packed_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ii.spd.xml
