...
#ifndef INTERLEAVE_SS_1I_IMPL_H
#define INTERLEAVE_SS_1I_IMPL_H

#include "interleave_ss_1i_base.h"

class interleave_ss_1i_i : public interleave_ss_1i_base
{
    public:
        interleave_ss_1i_i(const char *uuid, const char *label);
        ~interleave_ss_1i_i();
