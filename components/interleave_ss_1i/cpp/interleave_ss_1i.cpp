...
interleave_ss_1i_i::interleave_ss_1i_i(const char *uuid, const char *label) :
interleave_ss_1i_base(uuid, label)
{
}

interleave_ss_1i_i::~interleave_ss_1i_i()
{
}
...
void interleave_ss_1i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI interleave_ss_1i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
