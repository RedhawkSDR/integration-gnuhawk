...
check_counting_s_i::check_counting_s_i(const char *uuid, const char *label) :
check_counting_s_base(uuid, label)
{
}

check_counting_s_i::~check_counting_s_i()
{
}
...
void check_counting_s_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_check_counting_s( this->do_32bit );
    } catch (...) {
        return;
    }
