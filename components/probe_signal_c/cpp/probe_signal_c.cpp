...
probe_signal_c_i::probe_signal_c_i(const char *uuid, const char *label) :
probe_signal_c_base(uuid, label)
{
}

probe_signal_c_i::~probe_signal_c_i()
{
}
...
void probe_signal_c_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_probe_signal_c();

    this->registerGetter("level",
                         &gr_probe_signal_c::level);
