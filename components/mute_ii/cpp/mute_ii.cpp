...
mute_ii_i::mute_ii_i(const char *uuid, const char *label) :
mute_ii_base(uuid, label)
{
}
...
void mute_ii_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_mute_ii( this->mute );
...
//      
BULKIO::StreamSRI mute_ii_i::createOutputSRI( int32_t idx)
{
    //
