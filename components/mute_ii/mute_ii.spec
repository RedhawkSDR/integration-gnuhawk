...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/mute_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ii.spd.xml
