...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/argmax_is_1i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_1i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_1i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_1i.spd.xml
