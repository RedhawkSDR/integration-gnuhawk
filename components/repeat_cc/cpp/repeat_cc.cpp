...
repeat_cc_i::repeat_cc_i(const char *uuid, const char *label) :
repeat_cc_base(uuid, label)
{
}

repeat_cc_i::~repeat_cc_i()
{
}
...
//      
BULKIO::StreamSRI repeat_cc_i::createOutputSRI( int32_t idx)
{
    //
