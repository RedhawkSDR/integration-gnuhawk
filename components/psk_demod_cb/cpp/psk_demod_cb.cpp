...
psk_demod_cb_i::psk_demod_cb_i(const char *uuid, const char *label) :
psk_demod_cb_base(uuid, label)
{
}

psk_demod_cb_i::~psk_demod_cb_i()
{
}
...
//
void psk_demod_cb_i::createBlock()
{
  //
  ...
  gr_sptr = digital_make_constellation_receiver_cb(cons, loop_bw, fmin, fmax);
...
//      
BULKIO::StreamSRI psk_demod_cb_i::createOutputSRI( int32_t idx)
{
  //
