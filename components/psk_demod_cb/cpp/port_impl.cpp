...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataOctet_Out_i,psk_demod_cb_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataOctet_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataOctet_Out_i::BULKIO_dataOctet_Out_i(std::string port_name, psk_demod_cb_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<psk_demod_cb_i *> (_parent);
