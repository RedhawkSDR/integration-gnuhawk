...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/psk_demod_cb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/psk_demod_cb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/psk_demod_cb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/psk_demod_cb.spd.xml
