...
#ifndef BURST_TAGGER_SS_IMPL_H
#define BURST_TAGGER_SS_IMPL_H

#include "burst_tagger_ss_base.h"

class burst_tagger_ss_i : public burst_tagger_ss_base
{
    public:
        burst_tagger_ss_i(const char *uuid, const char *label);
        ~burst_tagger_ss_i();
