...
burst_tagger_ss_i::burst_tagger_ss_i(const char *uuid, const char *label) :
burst_tagger_ss_base(uuid, label)
{
}

burst_tagger_ss_i::~burst_tagger_ss_i()
{
}

void burst_tagger_ss_i::true_tag_changed(const std::string &id)
{
    gr_sptr->set_true_tag(true_tag.true_tag_key, true_tag.true_tag_value);
}

void burst_tagger_ss_i::false_tag_changed(const std::string &id)
{
...
void burst_tagger_ss_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("true_tag", this, &burst_tagger_ss_i::true_tag_changed);
    this->setPropertyChangeListener("false_tag", this, &burst_tagger_ss_i::false_tag_changed);
...
//      
BULKIO::StreamSRI burst_tagger_ss_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
