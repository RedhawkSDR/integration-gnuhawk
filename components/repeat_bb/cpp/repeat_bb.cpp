...
repeat_bb_i::repeat_bb_i(const char *uuid, const char *label) :
repeat_bb_base(uuid, label)
{
}

repeat_bb_i::~repeat_bb_i()
{
}
...
//      
BULKIO::StreamSRI repeat_bb_i::createOutputSRI( int32_t idx)
{
    //
