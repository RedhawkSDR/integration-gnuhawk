...
#ifndef FREQ_XLATING_FIR_FILTER_SCF_IMPL_H
#define FREQ_XLATING_FIR_FILTER_SCF_IMPL_H

#include "freq_xlating_fir_filter_scf_base.h"

class freq_xlating_fir_filter_scf_i : public freq_xlating_fir_filter_scf_base
{
    public:
        freq_xlating_fir_filter_scf_i(const char *uuid, const char *label);
        ~freq_xlating_fir_filter_scf_i();
