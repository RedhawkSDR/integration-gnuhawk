...
deinterleave_bb_4o_i::deinterleave_bb_4o_i(const char *uuid, const char *label) :
deinterleave_bb_4o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_bb_4o_i::streamIdChanged );
}

deinterleave_bb_4o_i::~deinterleave_bb_4o_i()
{
}

void deinterleave_bb_4o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_bb_4o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI deinterleave_bb_4o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
