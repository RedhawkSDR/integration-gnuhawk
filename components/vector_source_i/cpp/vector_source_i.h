...
#ifndef VECTOR_SOURCE_I_IMPL_H
#define VECTOR_SOURCE_I_IMPL_H

#include "vector_source_i_base.h"

class vector_source_i_i : public vector_source_i_base
{
   public:
      vector_source_i_i(const char *uuid, const char *label);
      ~vector_source_i_i();
    ...
    void onRewind (const std::string&);

    void setData( const std::string &id );
