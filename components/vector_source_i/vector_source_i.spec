...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_source_i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_source_i.spd.xml
