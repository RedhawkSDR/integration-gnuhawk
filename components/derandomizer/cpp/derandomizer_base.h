...
#ifndef DERANDOMIZER_IMPL_BASE_H
#define DERANDOMIZER_IMPL_BASE_H
...
#include "derandomizer_GnuHawkBlock.h"

#define NOOP 0
#define FINISH -1
#define NORMAL 1

class derandomizer_base;
...
class derandomizer_base : public GnuHawkBlock
{
    public:
        derandomizer_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<derandomizer_base> *serviceThread; 
        ...
        // Ports
        bulkio::InOctetPort *atsc_mpeg_packet_no_sync_in;
        bulkio::OutOctetPort *atsc_mpeg_packet_out;
    ...
    protected:
        ...
        void  atsc_mpeg_packet_no_sync_in_newStreamCallback( BULKIO::StreamSRI &sri );
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( derandomizer_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( derandomizer_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( derandomizer_base, " serviceFunction: retval:" << retval);
