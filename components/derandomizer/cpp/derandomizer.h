...
#ifndef DERANDOMIZER_IMPL_H
#define DERANDOMIZER_IMPL_H

#include "derandomizer_base.h"

class derandomizer_i : public derandomizer_base
{
    public:
        derandomizer_i(const char *uuid, const char *label);
        ~derandomizer_i();
        ...
        void reset_state(const std::string &id);
};
