...
./reconf
%define _bindir %{_prefix}/dom/components/multiply_const_vff/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vff.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vff.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vff.spd.xml
