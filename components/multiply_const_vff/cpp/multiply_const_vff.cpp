...
multiply_const_vff_i::multiply_const_vff_i(const char *uuid, const char *label) :
multiply_const_vff_base(uuid, label)
{
}

multiply_const_vff_i::~multiply_const_vff_i()
{
}
...
//
void multiply_const_vff_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI multiply_const_vff_i::createOutputSRI( int32_t idx)
{
  //
