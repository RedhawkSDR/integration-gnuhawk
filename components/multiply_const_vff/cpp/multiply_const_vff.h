...
#ifndef MULTIPLY_CONST_VFF_IMPL_H
#define MULTIPLY_CONST_VFF_IMPL_H

#include "multiply_const_vff_base.h"

class multiply_const_vff_i : public multiply_const_vff_base
{
   public:
      multiply_const_vff_i(const char *uuid, const char *label);
      ~multiply_const_vff_i();
