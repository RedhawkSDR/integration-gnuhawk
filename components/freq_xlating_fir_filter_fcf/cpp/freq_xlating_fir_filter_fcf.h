...
#ifndef FREQ_XLATING_FIR_FILTER_FCF_IMPL_H
#define FREQ_XLATING_FIR_FILTER_FCF_IMPL_H

#include "freq_xlating_fir_filter_fcf_base.h"

class freq_xlating_fir_filter_fcf_i : public freq_xlating_fir_filter_fcf_base
{
    public:
        freq_xlating_fir_filter_fcf_i(const char *uuid, const char *label);
        ~freq_xlating_fir_filter_fcf_i();
