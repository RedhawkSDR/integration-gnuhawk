...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,dc_blocker_cc_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, dc_blocker_cc_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<dc_blocker_cc_i *> (_parent);
