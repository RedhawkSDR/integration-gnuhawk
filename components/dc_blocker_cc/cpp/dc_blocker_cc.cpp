...
dc_blocker_cc_i::dc_blocker_cc_i(const char *uuid, const char *label) :
dc_blocker_cc_base(uuid, label)
{
}

dc_blocker_cc_i::~dc_blocker_cc_i()
{
}
...
//      
BULKIO::StreamSRI dc_blocker_cc_i::createOutputSRI( int32_t idx)
{
  //
