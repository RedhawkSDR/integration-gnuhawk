...
./reconf
%define _bindir %{_prefix}/dom/components/dc_blocker_cc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/dc_blocker_cc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/dc_blocker_cc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/dc_blocker_cc.spd.xml
