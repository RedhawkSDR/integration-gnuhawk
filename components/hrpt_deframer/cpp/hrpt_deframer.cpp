...
hrpt_deframer_i::hrpt_deframer_i(const char *uuid, const char *label) :
hrpt_deframer_base(uuid, label)
{
}

hrpt_deframer_i::~hrpt_deframer_i()
{
}
...
void hrpt_deframer_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = noaa_make_hrpt_deframer();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI hrpt_deframer_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
