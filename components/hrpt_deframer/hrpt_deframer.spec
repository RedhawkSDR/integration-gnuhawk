...
%define _namespace gnuhawk/noaa
...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/hrpt_deframer/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_deframer.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_deframer.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_deframer.spd.xml
