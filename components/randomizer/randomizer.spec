...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/randomizer/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/randomizer.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/randomizer.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/randomizer.spd.xml
