...
#ifndef BURST_TAGGER_BB_IMPL_H
#define BURST_TAGGER_BB_IMPL_H

#include "burst_tagger_bb_base.h"

class burst_tagger_bb_i : public burst_tagger_bb_base
{
    public:
        burst_tagger_bb_i(const char *uuid, const char *label);
        ~burst_tagger_bb_i();
