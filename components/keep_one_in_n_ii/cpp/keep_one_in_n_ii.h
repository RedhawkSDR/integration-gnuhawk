...
#ifndef KEEP_ONE_IN_N_II_IMPL_H
#define KEEP_ONE_IN_N_II_IMPL_H

#include "keep_one_in_n_ii_base.h"

class keep_one_in_n_ii_i : public keep_one_in_n_ii_base
{
    public:
        keep_one_in_n_ii_i(const char *uuid, const char *label);
        ~keep_one_in_n_ii_i();
