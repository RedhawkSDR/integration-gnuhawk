...
not_ii_i::not_ii_i(const char *uuid, const char *label) :
not_ii_base(uuid, label)
{
}
...
void not_ii_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_not_ii();
...
//      
BULKIO::StreamSRI not_ii_i::createOutputSRI( int32_t idx)
{
    //
