...
divide_cc_1i_i::divide_cc_1i_i(const char *uuid, const char *label) :
divide_cc_1i_base(uuid, label)
{
}

divide_cc_1i_i::~divide_cc_1i_i()
{
}
...
void divide_cc_1i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI divide_cc_1i_i::createOutputSRI( int32_t idx)
{
    //
