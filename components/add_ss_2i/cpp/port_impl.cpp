...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataShort_Out_i,add_ss_2i_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataShort_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataShort_Out_i::BULKIO_dataShort_Out_i(std::string port_name, add_ss_2i_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<add_ss_2i_i *> (_parent);
