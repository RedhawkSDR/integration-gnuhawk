...
stream_to_vector_cc_i::stream_to_vector_cc_i(const char *uuid, const char *label) :
stream_to_vector_cc_base(uuid, label)
{
}

stream_to_vector_cc_i::~stream_to_vector_cc_i()
{
}
...
void stream_to_vector_cc_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_vector_cc_i::createOutputSRI( int32_t idx)
{
    //
