...
#ifndef STREAM_TO_VECTOR_CC_IMPL_H
#define STREAM_TO_VECTOR_CC_IMPL_H

#include "stream_to_vector_cc_base.h"

class stream_to_vector_cc_i : public stream_to_vector_cc_base
{
    public:
        stream_to_vector_cc_i(const char *uuid, const char *label);
        ~stream_to_vector_cc_i();
