...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/stream_to_vector_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_cc.spd.xml
