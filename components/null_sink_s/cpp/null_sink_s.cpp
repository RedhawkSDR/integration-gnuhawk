...
null_sink_s_i::null_sink_s_i(const char *uuid, const char *label) :
null_sink_s_base(uuid, label)
{
}

null_sink_s_i::~null_sink_s_i()
{
}
...
void null_sink_s_i::createBlock()
{
    //
