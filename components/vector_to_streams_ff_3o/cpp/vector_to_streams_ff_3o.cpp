...
#include "vector_to_streams_ff_3o.h"
...
vector_to_streams_ff_3o_i::vector_to_streams_ff_3o_i(const char *uuid, const char *label) :
vector_to_streams_ff_3o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &vector_to_streams_ff_3o_i::streamIdChanged );
}

vector_to_streams_ff_3o_i::~vector_to_streams_ff_3o_i()
{
}

void vector_to_streams_ff_3o_i::streamIdChanged(const std::string& id)
{ 
...
void vector_to_streams_ff_3o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI vector_to_streams_ff_3o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
