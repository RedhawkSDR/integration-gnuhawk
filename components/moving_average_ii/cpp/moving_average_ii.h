...
#ifndef MOVING_AVERAGE_II_IMPL_H
#define MOVING_AVERAGE_II_IMPL_H

#include "moving_average_ii_base.h"

class moving_average_ii_i : public moving_average_ii_base
{
    public:
        moving_average_ii_i(const char *uuid, const char *label);
        ~moving_average_ii_i();
