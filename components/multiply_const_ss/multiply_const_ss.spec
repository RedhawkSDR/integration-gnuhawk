...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/multiply_const_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_ss.spd.xml
