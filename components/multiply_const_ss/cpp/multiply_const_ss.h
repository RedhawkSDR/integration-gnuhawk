...
#ifndef MULTIPLY_CONST_SS_IMPL_H
#define MULTIPLY_CONST_SS_IMPL_H

#include "multiply_const_ss_base.h"

class multiply_const_ss_i : public multiply_const_ss_base
{
   public:
      multiply_const_ss_i(const char *uuid, const char *label);
      ~multiply_const_ss_i();
