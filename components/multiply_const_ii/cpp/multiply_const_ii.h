...
#ifndef MULTIPLY_CONST_II_IMPL_H
#define MULTIPLY_CONST_II_IMPL_H

#include "multiply_const_ii_base.h"

class multiply_const_ii_i : public multiply_const_ii_base
{
   public:
      multiply_const_ii_i(const char *uuid, const char *label);
      ~multiply_const_ii_i();
