...
multiply_const_ii_i::multiply_const_ii_i(const char *uuid, const char *label) :
multiply_const_ii_base(uuid, label)
{
}

multiply_const_ii_i::~multiply_const_ii_i()
{
}
...
//
void multiply_const_ii_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	this->gr_sptr = gr_make_multiply_const_ii ( this->k );
	this->registerGetterSetter("k", &gr_multiply_const_ii::k, &gr_multiply_const_ii::set_k);
...
//      
BULKIO::StreamSRI multiply_const_ii_i::createOutputSRI( int32_t idx)
{
  //
