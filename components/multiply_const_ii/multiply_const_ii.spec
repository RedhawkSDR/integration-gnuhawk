...
./reconf
%define _bindir %{_prefix}/dom/components/multiply_const_ii/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_ii.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_ii.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_ii.spd.xml
