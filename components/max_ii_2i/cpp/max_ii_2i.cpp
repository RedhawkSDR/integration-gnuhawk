...
max_ii_2i_i::max_ii_2i_i(const char *uuid, const char *label) :
max_ii_2i_base(uuid, label)
{
}

max_ii_2i_i::~max_ii_2i_i()
{
}
...
//      
BULKIO::StreamSRI max_ii_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
