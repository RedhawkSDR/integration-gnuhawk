...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/streams_to_stream_ss_4i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_4i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_4i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_ss_4i.spd.xml
