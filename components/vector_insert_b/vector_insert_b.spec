...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_insert_b/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_insert_b.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_insert_b.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_insert_b.spd.xml
