...
#ifndef VECTOR_INSERT_B_IMPL_H
#define VECTOR_INSERT_B_IMPL_H

#include "vector_insert_b_base.h"

class vector_insert_b_i : public vector_insert_b_base
{
    public:
        vector_insert_b_i(const char *uuid, const char *label);
        ~vector_insert_b_i();
        ...
        void rewind_data(const std::string &id);
};
