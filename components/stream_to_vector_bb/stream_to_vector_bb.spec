...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/stream_to_vector_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_bb.spd.xml
