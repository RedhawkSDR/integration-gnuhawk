...
stream_to_vector_bb_i::stream_to_vector_bb_i(const char *uuid, const char *label) :
stream_to_vector_bb_base(uuid, label)
{
}

stream_to_vector_bb_i::~stream_to_vector_bb_i()
{
}
...
void stream_to_vector_bb_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_vector_bb_i::createOutputSRI( int32_t idx)
{
    //
