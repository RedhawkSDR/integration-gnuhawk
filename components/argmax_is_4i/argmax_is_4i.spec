...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/argmax_is_4i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_4i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_4i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_is_4i.spd.xml
