...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_vi/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vi.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vi.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vi.spd.xml
