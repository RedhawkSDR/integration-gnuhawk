...
#ifndef UCHAR_TO_FLOAT_IMPL_H
#define UCHAR_TO_FLOAT_IMPL_H

#include "uchar_to_float_base.h"

class uchar_to_float_i : public uchar_to_float_base
{
    public:
        uchar_to_float_i(const char *uuid, const char *label);
        ~uchar_to_float_i();
