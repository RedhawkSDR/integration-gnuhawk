...
uchar_to_float_i::uchar_to_float_i(const char *uuid, const char *label) :
uchar_to_float_base(uuid, label)
{
}

uchar_to_float_i::~uchar_to_float_i()
{
}
...
void uchar_to_float_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_uchar_to_float();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI uchar_to_float_i::createOutputSRI( int32_t idx)
{
    //
