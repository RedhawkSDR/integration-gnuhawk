...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/uchar_to_float/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/uchar_to_float.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/uchar_to_float.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/uchar_to_float.spd.xml
