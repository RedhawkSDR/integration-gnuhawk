...
endian_swap_ii_i::endian_swap_ii_i(const char *uuid, const char *label) :
endian_swap_ii_base(uuid, label)
{
}

endian_swap_ii_i::~endian_swap_ii_i()
{
}
...
void endian_swap_ii_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_endian_swap (this->item_size_bytes);
...
//      
BULKIO::StreamSRI endian_swap_ii_i::createOutputSRI( int32_t idx)
{
    //
