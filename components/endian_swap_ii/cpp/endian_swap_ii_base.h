...
#ifndef ENDIAN_SWAP_II_IMPL_BASE_H
#define ENDIAN_SWAP_II_IMPL_BASE_H
...
#include "endian_swap_ii_GnuHawkBlock.h"

#define NOOP 0
#define FINISH -1
#define NORMAL 1

class endian_swap_ii_base;
...
class endian_swap_ii_base : public GnuHawkBlock
{
    public:
        endian_swap_ii_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<endian_swap_ii_base> *serviceThread; 
        boost::mutex serviceThreadLock;

        // Member variables exposed as properties
        CORBA::Long item_size_bytes;

        // Ports
        bulkio::InLongPort *int_in;
        bulkio::OutLongPort *int_out;
    ...
    protected:
        ...
        void  int_in_newStreamCallback( BULKIO::StreamSRI &sri );
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( endian_swap_ii_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( endian_swap_ii_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( endian_swap_ii_base, " serviceFunction: retval:" << retval);
