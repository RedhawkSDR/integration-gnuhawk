...
#ifndef ENDIAN_SWAP_II_IMPL_H
#define ENDIAN_SWAP_II_IMPL_H

#include "endian_swap_ii_base.h"

class endian_swap_ii_i : public endian_swap_ii_base
{
    public:
        endian_swap_ii_i(const char *uuid, const char *label);
        ~endian_swap_ii_i();
