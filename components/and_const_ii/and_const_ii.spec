...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/and_const_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/and_const_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/and_const_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/and_const_ii.spd.xml
