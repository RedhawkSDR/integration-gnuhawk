...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_s/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_s.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_s.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_s.spd.xml
