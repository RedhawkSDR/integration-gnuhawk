...
#ifndef VECTOR_TO_STREAM_BB_IMPL_H
#define VECTOR_TO_STREAM_BB_IMPL_H

#include "vector_to_stream_bb_base.h"

class vector_to_stream_bb_i : public vector_to_stream_bb_base
{
    public:
        vector_to_stream_bb_i(const char *uuid, const char *label);
        ~vector_to_stream_bb_i();
