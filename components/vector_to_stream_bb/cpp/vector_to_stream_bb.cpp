...
vector_to_stream_bb_i::vector_to_stream_bb_i(const char *uuid, const char *label) :
vector_to_stream_bb_base(uuid, label)
{
}

vector_to_stream_bb_i::~vector_to_stream_bb_i()
{
}
...
void vector_to_stream_bb_i::createBlock()
{
    //
    ...
    try{
    	this->gr_sptr = gr_make_vector_to_stream (this->item_size, this->nitems_per_block);
    }
    catch(...){
    	return;
    }
...
//      
BULKIO::StreamSRI vector_to_stream_bb_i::createOutputSRI( int32_t idx)
{
    //
