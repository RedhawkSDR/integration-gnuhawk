...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_stream_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_bb.spd.xml
