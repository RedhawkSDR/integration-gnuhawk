...
integrate_ff_i::integrate_ff_i(const char *uuid, const char *label) :
integrate_ff_base(uuid, label)
{
}

integrate_ff_i::~integrate_ff_i()
{
}
...
//
void integrate_ff_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_integrate_ff(decim);
...
//      
BULKIO::StreamSRI integrate_ff_i::createOutputSRI( int32_t idx)
{
  //
