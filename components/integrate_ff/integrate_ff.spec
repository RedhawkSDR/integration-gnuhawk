...
./reconf
%define _bindir %{_prefix}/dom/components/integrate_ff/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ff.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ff.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ff.spd.xml
