...
max_ff_3i_i::max_ff_3i_i(const char *uuid, const char *label) :
max_ff_3i_base(uuid, label)
{
}

max_ff_3i_i::~max_ff_3i_i()
{
}
...
//      
BULKIO::StreamSRI max_ff_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
