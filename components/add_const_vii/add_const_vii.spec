...
./reconf
%define _bindir %{_prefix}/dom/components/add_const_vii/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/add_const_vii.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/add_const_vii.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/add_const_vii.spd.xml
