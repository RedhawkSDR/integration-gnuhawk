...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/add_const_vii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_vii.spd.xml
