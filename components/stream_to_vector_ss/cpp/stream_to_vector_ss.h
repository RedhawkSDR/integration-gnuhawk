...
#ifndef STREAM_TO_VECTOR_SS_IMPL_H
#define STREAM_TO_VECTOR_SS_IMPL_H

#include "stream_to_vector_ss_base.h"

class stream_to_vector_ss_i : public stream_to_vector_ss_base
{
    public:
        stream_to_vector_ss_i(const char *uuid, const char *label);
        ~stream_to_vector_ss_i();
