...
stream_to_vector_ss_i::stream_to_vector_ss_i(const char *uuid, const char *label) :
stream_to_vector_ss_base(uuid, label)
{
}

stream_to_vector_ss_i::~stream_to_vector_ss_i()
{
}
...
void stream_to_vector_ss_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI stream_to_vector_ss_i::createOutputSRI( int32_t idx)
{
    //
