...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/stream_to_vector_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ss.spd.xml
