...
#ifndef DEINTERLEAVE_II_1O_IMPL_H
#define DEINTERLEAVE_II_1O_IMPL_H

#include "deinterleave_ii_1o_base.h"

class deinterleave_ii_1o_i : public deinterleave_ii_1o_base
{
    public:
        deinterleave_ii_1o_i(const char *uuid, const char *label);
        ~deinterleave_ii_1o_i();
