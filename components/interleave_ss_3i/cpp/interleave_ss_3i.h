...
#ifndef INTERLEAVE_SS_3I_IMPL_H
#define INTERLEAVE_SS_3I_IMPL_H

#include "interleave_ss_3i_base.h"

class interleave_ss_3i_i : public interleave_ss_3i_base
{
    public:
        interleave_ss_3i_i(const char *uuid, const char *label);
        ~interleave_ss_3i_i();
