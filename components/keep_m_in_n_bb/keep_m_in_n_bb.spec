...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/keep_m_in_n_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_bb.spd.xml
