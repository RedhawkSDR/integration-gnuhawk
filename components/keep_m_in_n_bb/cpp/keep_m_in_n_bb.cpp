...
keep_m_in_n_bb_i::keep_m_in_n_bb_i(const char *uuid, const char *label) :
keep_m_in_n_bb_base(uuid, label)
{
}

keep_m_in_n_bb_i::~keep_m_in_n_bb_i()
{
}
...
void keep_m_in_n_bb_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI keep_m_in_n_bb_i::createOutputSRI( int32_t idx)
{
    //
