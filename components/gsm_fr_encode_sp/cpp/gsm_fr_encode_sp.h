...
#ifndef GSM_FR_ENCODE_SP_IMPL_H
#define GSM_FR_ENCODE_SP_IMPL_H

#include "gsm_fr_encode_sp_base.h"

class gsm_fr_encode_sp_i : public gsm_fr_encode_sp_base
{
    public:
        gsm_fr_encode_sp_i(const char *uuid, const char *label);
        ~gsm_fr_encode_sp_i();
