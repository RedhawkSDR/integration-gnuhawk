...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/bytes_to_syms/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/bytes_to_syms.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/bytes_to_syms.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/bytes_to_syms.spd.xml
