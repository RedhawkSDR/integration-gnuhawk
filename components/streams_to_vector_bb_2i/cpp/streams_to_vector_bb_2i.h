...
#ifndef STREAMS_TO_VECTOR_BB_2I_IMPL_H
#define STREAMS_TO_VECTOR_BB_2I_IMPL_H

#include "streams_to_vector_bb_2i_base.h"

class streams_to_vector_bb_2i_i : public streams_to_vector_bb_2i_base
{
    public:
        streams_to_vector_bb_2i_i(const char *uuid, const char *label);
        ~streams_to_vector_bb_2i_i();
