...
#include "frequency_modulator_fc.h"
...
frequency_modulator_fc_i::frequency_modulator_fc_i(const char *uuid, const char *label) :
frequency_modulator_fc_base(uuid, label)
{
}

frequency_modulator_fc_i::~frequency_modulator_fc_i()
{
}
...
void frequency_modulator_fc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_frequency_modulator_fc( this->sensitivity );
    this->registerGetterSetter("sensitivity", &gr_frequency_modulator_fc::sensitivity,
                                       &gr_frequency_modulator_fc::set_sensitivity);
...
//      
BULKIO::StreamSRI frequency_modulator_fc_i::createOutputSRI( int32_t idx)
{
    //
