...
#ifndef FREQUENCY_MODULATOR_FC_IMPL_H
#define FREQUENCY_MODULATOR_FC_IMPL_H

#include "frequency_modulator_fc_base.h"

class frequency_modulator_fc_i : public frequency_modulator_fc_base
{
    public:
        frequency_modulator_fc_i(const char *uuid, const char *label);
        ~frequency_modulator_fc_i();
