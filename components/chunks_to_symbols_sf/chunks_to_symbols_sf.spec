...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/chunks_to_symbols_sf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/chunks_to_symbols_sf.spd.xml
