...
#ifndef CHUNKS_TO_SYMBOLS_SF_IMPL_H
#define CHUNKS_TO_SYMBOLS_SF_IMPL_H

#include "chunks_to_symbols_sf_base.h"

class chunks_to_symbols_sf_i : public chunks_to_symbols_sf_base
{
    public:
        chunks_to_symbols_sf_i(const char *uuid, const char *label);
        ~chunks_to_symbols_sf_i();
