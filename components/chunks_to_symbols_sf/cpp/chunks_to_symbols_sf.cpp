...
#include "chunks_to_symbols_sf.h"
...
chunks_to_symbols_sf_i::chunks_to_symbols_sf_i(const char *uuid, const char *label) :
chunks_to_symbols_sf_base(uuid, label)
{
}

chunks_to_symbols_sf_i::~chunks_to_symbols_sf_i()
{
}
...
void chunks_to_symbols_sf_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_chunks_to_symbols_sf( this->symbol_table, this->D );

    this->registerGetter("symbol_table", &gr_chunks_to_symbols_sf::symbol_table);
    this->registerGetter("D", &gr_chunks_to_symbols_sf::D);
...
//      
BULKIO::StreamSRI chunks_to_symbols_sf_i::createOutputSRI( int32_t idx)
{
    //
