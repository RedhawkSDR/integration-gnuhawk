...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/mute_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ff.spd.xml
