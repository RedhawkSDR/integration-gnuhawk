...
mute_ff_i::mute_ff_i(const char *uuid, const char *label) :
mute_ff_base(uuid, label)
{
}
...
void mute_ff_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_mute_ff( this->mute );
...
//      
BULKIO::StreamSRI mute_ff_i::createOutputSRI( int32_t idx)
{
    //
