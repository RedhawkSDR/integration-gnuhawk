...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/ofdm_cyclic_prefixer/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_cyclic_prefixer.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_cyclic_prefixer.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ofdm_cyclic_prefixer.spd.xml
