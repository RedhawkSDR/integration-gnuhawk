...
#ifndef OFDM_CYCLIC_PREFIXER_IMPL_H
#define OFDM_CYCLIC_PREFIXER_IMPL_H

#include "ofdm_cyclic_prefixer_base.h"

class ofdm_cyclic_prefixer_i : public ofdm_cyclic_prefixer_base
{
    public:
        ofdm_cyclic_prefixer_i(const char *uuid, const char *label);
        ~ofdm_cyclic_prefixer_i();
