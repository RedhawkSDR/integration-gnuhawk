...
ofdm_cyclic_prefixer_i::ofdm_cyclic_prefixer_i(const char *uuid, const char *label) :
ofdm_cyclic_prefixer_base(uuid, label)
{
}

ofdm_cyclic_prefixer_i::~ofdm_cyclic_prefixer_i()
{
}
...
void ofdm_cyclic_prefixer_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = digital_make_ofdm_cyclic_prefixer( this->input_size, this->output_size );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI ofdm_cyclic_prefixer_i::createOutputSRI( int32_t idx)
{
    //
