...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fft_filter_fff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_fff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_fff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_fff.spd.xml
