...
./reconf
%define _bindir %{_prefix}/dom/components/fft_filter_fff/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_filter_fff.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_filter_fff.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_filter_fff.spd.xml
