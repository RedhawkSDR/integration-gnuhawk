...
#ifndef FFT_FILTER_FFF_IMPL_H
#define FFT_FILTER_FFF_IMPL_H

#include "fft_filter_fff_base.h"

class fft_filter_fff_i : public fft_filter_fff_base
{
   public:
      fft_filter_fff_i(const char *uuid, const char *label);
      ~fft_filter_fff_i();
