...
fft_filter_fff_i::fft_filter_fff_i(const char *uuid, const char *label) :
fft_filter_fff_base(uuid, label)
{
}

fft_filter_fff_i::~fft_filter_fff_i()
{
}

void fft_filter_fff_i::setTaps(const std::string &id){
    this->gr_sptr->set_taps(taps);
}

std::vector<float> fft_filter_fff_i::getTaps(){
...
//
void fft_filter_fff_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI fft_filter_fff_i::createOutputSRI( int32_t idx)
{
  //
