...
#ifndef FREQ_XLATING_FIR_FILTER_FCC_IMPL_H
#define FREQ_XLATING_FIR_FILTER_FCC_IMPL_H

#include "freq_xlating_fir_filter_fcc_base.h"

class freq_xlating_fir_filter_fcc_i : public freq_xlating_fir_filter_fcc_base
{
    public:
        freq_xlating_fir_filter_fcc_i(const char *uuid, const char *label);
        ~freq_xlating_fir_filter_fcc_i();
        ...
        std::vector<std::complex<float> > get_taps();
};
