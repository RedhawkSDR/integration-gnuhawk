...
#ifndef IIR_FILTER_FFD_IMPL_H
#define IIR_FILTER_FFD_IMPL_H

#include "iir_filter_ffd_base.h"

class iir_filter_ffd_i : public iir_filter_ffd_base
{
   public:
      iir_filter_ffd_i(const char *uuid, const char *label);
      ~iir_filter_ffd_i();
