...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/iir_filter_ffd/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iir_filter_ffd.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iir_filter_ffd.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/iir_filter_ffd.spd.xml
