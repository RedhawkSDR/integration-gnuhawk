...
#ifndef FIR_FILTER_FSF_IMPL_H
#define FIR_FILTER_FSF_IMPL_H

#include "fir_filter_fsf_base.h"

class fir_filter_fsf_i : public fir_filter_fsf_base
{
   public:
      fir_filter_fsf_i(const char *uuid, const char *label);
      ~fir_filter_fsf_i();
