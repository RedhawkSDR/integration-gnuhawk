...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fir_filter_fsf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fsf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fsf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_fsf.spd.xml
