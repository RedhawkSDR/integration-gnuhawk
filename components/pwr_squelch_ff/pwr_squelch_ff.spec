...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/pwr_squelch_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pwr_squelch_ff.spd.xml
