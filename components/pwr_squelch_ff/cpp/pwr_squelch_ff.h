...
#ifndef PWR_SQUELCH_FF_IMPL_H
#define PWR_SQUELCH_FF_IMPL_H

#include "pwr_squelch_ff_base.h"

class pwr_squelch_ff_i : public pwr_squelch_ff_base
{
    public:
        pwr_squelch_ff_i(const char *uuid, const char *label);
        ~pwr_squelch_ff_i();
