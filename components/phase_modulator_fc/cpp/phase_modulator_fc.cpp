...
phase_modulator_fc_i::phase_modulator_fc_i(const char *uuid, const char *label) :
phase_modulator_fc_base(uuid, label)
{
}

phase_modulator_fc_i::~phase_modulator_fc_i()
{
}
...
//
void phase_modulator_fc_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
	gr_sptr = gr_make_phase_modulator_fc(this->sensitivity);
...
//      
BULKIO::StreamSRI phase_modulator_fc_i::createOutputSRI( int32_t idx)
{
  //
