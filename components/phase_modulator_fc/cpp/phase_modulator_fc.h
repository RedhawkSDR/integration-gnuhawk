...
#ifndef PHASE_MODULATOR_FC_IMPL_H
#define PHASE_MODULATOR_FC_IMPL_H

#include "phase_modulator_fc_base.h"

class phase_modulator_fc_i : public phase_modulator_fc_base
{
   public:
      phase_modulator_fc_i(const char *uuid, const char *label);
      ~phase_modulator_fc_i();
