...
./reconf
%define _bindir %{_prefix}/dom/components/phase_modulator_fc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/phase_modulator_fc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/phase_modulator_fc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/phase_modulator_fc.spd.xml
