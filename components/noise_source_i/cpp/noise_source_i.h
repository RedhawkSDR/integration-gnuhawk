...
#ifndef NOISE_SOURCE_I_IMPL_H
#define NOISE_SOURCE_I_IMPL_H

#include "noise_source_i_base.h"

class noise_source_i_i : public noise_source_i_base
{
   public:
      noise_source_i_i(const char *uuid, const char *label);
      ~noise_source_i_i();
