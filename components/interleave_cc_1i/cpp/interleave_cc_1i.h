...
#ifndef INTERLEAVE_CC_1I_IMPL_H
#define INTERLEAVE_CC_1I_IMPL_H

#include "interleave_cc_1i_base.h"

class interleave_cc_1i_i : public interleave_cc_1i_base
{
    public:
        interleave_cc_1i_i(const char *uuid, const char *label);
        ~interleave_cc_1i_i();
