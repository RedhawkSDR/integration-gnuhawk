...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/mute_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/mute_ss.spd.xml
