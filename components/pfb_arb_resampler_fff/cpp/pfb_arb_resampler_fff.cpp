...
pfb_arb_resampler_fff_i::pfb_arb_resampler_fff_i(const char *uuid, const char *label) :
pfb_arb_resampler_fff_base(uuid, label)
{
}

pfb_arb_resampler_fff_i::~pfb_arb_resampler_fff_i()
{
}
...
//
void pfb_arb_resampler_fff_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr::filter::pfb_arb_resampler_fff::make(rate, taps, filter_size);
  this->registerSetter("rate", &gr::filter::pfb_arb_resampler_fff::set_rate);
...
//      
BULKIO::StreamSRI pfb_arb_resampler_fff_i::createOutputSRI( int32_t idx)
{
  //
