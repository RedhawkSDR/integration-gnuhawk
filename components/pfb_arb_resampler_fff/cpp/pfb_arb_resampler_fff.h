...
#ifndef PFB_ARB_RESAMPLER_FFF_IMPL_H
#define PFB_ARB_RESAMPLER_FFF_IMPL_H

#include "pfb_arb_resampler_fff_base.h"

class pfb_arb_resampler_fff_i : public pfb_arb_resampler_fff_base
{
   public:
      pfb_arb_resampler_fff_i(const char *uuid, const char *label);
      ~pfb_arb_resampler_fff_i();
