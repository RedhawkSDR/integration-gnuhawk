...
sub_ff_3i_i::sub_ff_3i_i(const char *uuid, const char *label) :
sub_ff_3i_base(uuid, label)
{
}

sub_ff_3i_i::~sub_ff_3i_i()
{
}
...
void sub_ff_3i_i::createBlock()
{
    ...
    try {
        gr_sptr = gr_make_sub_ff( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sub_ff_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
