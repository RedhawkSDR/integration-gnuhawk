...
char_to_short_i::char_to_short_i(const char *uuid, const char *label) :
char_to_short_base(uuid, label)
{
}

char_to_short_i::~char_to_short_i()
{
}
...
void char_to_short_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_char_to_short( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI char_to_short_i::createOutputSRI( int32_t idx)
{
    //
