...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/char_to_short/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/char_to_short.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/char_to_short.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/char_to_short.spd.xml
