...
#ifndef SIMPLE_SQUELCH_CC_IMPL_H
#define SIMPLE_SQUELCH_CC_IMPL_H

#include "simple_squelch_cc_base.h"

class simple_squelch_cc_i : public simple_squelch_cc_base
{
    public:
        simple_squelch_cc_i(const char *uuid, const char *label);
        ~simple_squelch_cc_i();
