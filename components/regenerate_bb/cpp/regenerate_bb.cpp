...
regenerate_bb_i::regenerate_bb_i(const char *uuid, const char *label) :
regenerate_bb_base(uuid, label)
{
}

regenerate_bb_i::~regenerate_bb_i()
{
}
...
//      
BULKIO::StreamSRI regenerate_bb_i::createOutputSRI( int32_t idx)
{
    //
