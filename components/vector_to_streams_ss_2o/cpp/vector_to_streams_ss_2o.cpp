...
#include "vector_to_streams_ss_2o.h"
...
vector_to_streams_ss_2o_i::~vector_to_streams_ss_2o_i()
{
}

void vector_to_streams_ss_2o_i::streamIdChanged(const std::string& id)
{ 
...
void vector_to_streams_ss_2o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI vector_to_streams_ss_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
