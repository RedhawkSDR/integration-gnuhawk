...
skiphead_ii_i::skiphead_ii_i(const char *uuid, const char *label) :
skiphead_ii_base(uuid, label)
{
}

skiphead_ii_i::~skiphead_ii_i()
{
}
...
void skiphead_ii_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI skiphead_ii_i::createOutputSRI( int32_t idx)
{
    //
