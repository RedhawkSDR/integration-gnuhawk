...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_vs/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vs.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vs.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vs.spd.xml
