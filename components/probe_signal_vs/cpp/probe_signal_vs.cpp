...
probe_signal_vs_i::probe_signal_vs_i(const char *uuid, const char *label) :
probe_signal_vs_base(uuid, label)
{
}

probe_signal_vs_i::~probe_signal_vs_i()
{
}
...
void probe_signal_vs_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_probe_signal_vs( this->size );

    this->registerGetter("level",
                         &gr_probe_signal_vs::level);
