...
#include "vector_to_streams_ii_2o.h"
...
vector_to_streams_ii_2o_i::vector_to_streams_ii_2o_i(const char *uuid, const char *label) :
vector_to_streams_ii_2o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &vector_to_streams_ii_2o_i::streamIdChanged );
}

vector_to_streams_ii_2o_i::~vector_to_streams_ii_2o_i()
{
}

void vector_to_streams_ii_2o_i::streamIdChanged(const std::string& id)
{ 
...
void vector_to_streams_ii_2o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI vector_to_streams_ii_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
