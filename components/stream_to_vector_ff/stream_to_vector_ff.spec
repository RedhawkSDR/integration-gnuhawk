...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/stream_to_vector_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/stream_to_vector_ff.spd.xml
