...
#ifndef STREAM_TO_VECTOR_FF_IMPL_H
#define STREAM_TO_VECTOR_FF_IMPL_H

#include "stream_to_vector_ff_base.h"

class stream_to_vector_ff_i : public stream_to_vector_ff_base
{
    public:
        stream_to_vector_ff_i(const char *uuid, const char *label);
        ~stream_to_vector_ff_i();
