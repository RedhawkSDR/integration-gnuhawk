...
stream_to_vector_ff_i::stream_to_vector_ff_i(const char *uuid, const char *label) :
stream_to_vector_ff_base(uuid, label)
{
}

stream_to_vector_ff_i::~stream_to_vector_ff_i()
{
}
...
//      
BULKIO::StreamSRI stream_to_vector_ff_i::createOutputSRI( int32_t idx)
{
    //
