...
transcendental_ff_i::transcendental_ff_i(const char *uuid, const char *label) :
transcendental_ff_base(uuid, label)
{
}

transcendental_ff_i::~transcendental_ff_i()
{
}
...
void transcendental_ff_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI transcendental_ff_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
