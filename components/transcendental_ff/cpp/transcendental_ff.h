...
#ifndef TRANSCENDENTAL_FF_IMPL_H
#define TRANSCENDENTAL_FF_IMPL_H

#include "transcendental_ff_base.h"

class transcendental_ff_i : public transcendental_ff_base
{
    public:
        transcendental_ff_i(const char *uuid, const char *label);
        ~transcendental_ff_i();
