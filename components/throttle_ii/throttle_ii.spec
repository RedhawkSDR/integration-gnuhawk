...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/throttle_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ii.spd.xml
