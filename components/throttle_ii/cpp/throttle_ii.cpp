...
throttle_ii_i::throttle_ii_i(const char *uuid, const char *label) :
throttle_ii_base(uuid, label)
{
}

throttle_ii_i::~throttle_ii_i()
{
}

void throttle_ii_i::changeFrequency(const std::string &id)
{
...
void throttle_ii_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("samples_per_sec", this, &throttle_ii_i::changeFrequency);
...
//      
BULKIO::StreamSRI throttle_ii_i::createOutputSRI( int32_t idx)
{
    //
