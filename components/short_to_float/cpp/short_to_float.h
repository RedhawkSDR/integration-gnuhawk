...
#ifndef SHORT_TO_FLOAT_IMPL_H
#define SHORT_TO_FLOAT_IMPL_H

#include "short_to_float_base.h"

class short_to_float_i : public short_to_float_base
{
   public:
      short_to_float_i(const char *uuid, const char *label);
      ~short_to_float_i();
    ...
    void changedScale(const std::string &id);
    float getScale();
