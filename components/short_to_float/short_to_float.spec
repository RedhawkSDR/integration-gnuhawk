...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/short_to_float/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/short_to_float.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/short_to_float.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/short_to_float.spd.xml
