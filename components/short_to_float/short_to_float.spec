...
./reconf
%define _bindir %{_prefix}/dom/components/short_to_float/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/short_to_float.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/short_to_float.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/short_to_float.spd.xml
