...
#ifndef DECODE_CCSDS_27_FB_IMPL_H
#define DECODE_CCSDS_27_FB_IMPL_H

#include "decode_ccsds_27_fb_base.h"

class decode_ccsds_27_fb_i : public decode_ccsds_27_fb_base
{
    public:
        decode_ccsds_27_fb_i(const char *uuid, const char *label);
        ~decode_ccsds_27_fb_i();
