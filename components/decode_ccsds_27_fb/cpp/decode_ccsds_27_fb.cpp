...
decode_ccsds_27_fb_i::decode_ccsds_27_fb_i(const char *uuid, const char *label) :
decode_ccsds_27_fb_base(uuid, label)
{
}

decode_ccsds_27_fb_i::~decode_ccsds_27_fb_i()
{
}
...
void decode_ccsds_27_fb_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_decode_ccsds_27_fb();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI decode_ccsds_27_fb_i::createOutputSRI( int32_t idx)
{
    //
