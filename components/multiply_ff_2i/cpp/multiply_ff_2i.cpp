...
multiply_ff_2i_i::multiply_ff_2i_i(const char *uuid, const char *label) :
multiply_ff_2i_base(uuid, label)
{
}

multiply_ff_2i_i::~multiply_ff_2i_i()
{
}
...
//
void multiply_ff_2i_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_multiply_ff(vlen);
...
//      
BULKIO::StreamSRI multiply_ff_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
  //
