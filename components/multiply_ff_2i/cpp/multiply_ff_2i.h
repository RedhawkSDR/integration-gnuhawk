...
#ifndef MULTIPLY_FF_2I_IMPL_H
#define MULTIPLY_FF_2I_IMPL_H

#include "multiply_ff_2i_base.h"

class multiply_ff_2i_i : public multiply_ff_2i_base
{
   public:
      multiply_ff_2i_i(const char *uuid, const char *label);
      ~multiply_ff_2i_i();
