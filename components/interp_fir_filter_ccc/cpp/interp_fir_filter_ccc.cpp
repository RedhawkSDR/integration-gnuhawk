...
interp_fir_filter_ccc_i::interp_fir_filter_ccc_i(const char *uuid, const char *label) :
interp_fir_filter_ccc_base(uuid, label)
{
}

interp_fir_filter_ccc_i::~interp_fir_filter_ccc_i()
{
}
...
void interp_fir_filter_ccc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr::filter::interp_fir_filter_ccc::make( this->interpolation, this->taps );

    this->registerGetter("taps", &gr::filter::interp_fir_filter_ccc::taps);
    this->registerSetter("taps", &gr::filter::interp_fir_filter_ccc::set_taps);
...
//      
BULKIO::StreamSRI interp_fir_filter_ccc_i::createOutputSRI( int32_t idx)
{
    //
