...
#ifndef INTERP_FIR_FILTER_CCC_IMPL_H
#define INTERP_FIR_FILTER_CCC_IMPL_H

#include "interp_fir_filter_ccc_base.h"

class interp_fir_filter_ccc_i : public interp_fir_filter_ccc_base
{
    public:
        interp_fir_filter_ccc_i(const char *uuid, const char *label);
        ~interp_fir_filter_ccc_i();
