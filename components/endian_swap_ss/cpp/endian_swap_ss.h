...
#ifndef ENDIAN_SWAP_SS_IMPL_H
#define ENDIAN_SWAP_SS_IMPL_H

#include "endian_swap_ss_base.h"

class endian_swap_ss_i : public endian_swap_ss_base
{
    public:
        endian_swap_ss_i(const char *uuid, const char *label);
        ~endian_swap_ss_i();
