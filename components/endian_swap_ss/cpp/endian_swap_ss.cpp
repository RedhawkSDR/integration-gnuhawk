...
endian_swap_ss_i::endian_swap_ss_i(const char *uuid, const char *label) :
endian_swap_ss_base(uuid, label)
{
}

endian_swap_ss_i::~endian_swap_ss_i()
{
}
...
void endian_swap_ss_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI endian_swap_ss_i::createOutputSRI( int32_t idx)
{
    //
