...
viterbi_decoder_i::viterbi_decoder_i(const char *uuid, const char *label) :
viterbi_decoder_base(uuid, label)
{
}

viterbi_decoder_i::~viterbi_decoder_i()
{
}
...
void viterbi_decoder_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = atsc_make_viterbi_decoder();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI viterbi_decoder_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
