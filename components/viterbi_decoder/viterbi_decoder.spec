...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/viterbi_decoder/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/viterbi_decoder.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/viterbi_decoder.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/viterbi_decoder.spd.xml
