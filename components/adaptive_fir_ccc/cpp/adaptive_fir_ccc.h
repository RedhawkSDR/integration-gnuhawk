...
#ifndef ADAPTIVE_FIR_CCC_IMPL_H
#define ADAPTIVE_FIR_CCC_IMPL_H

#include "adaptive_fir_ccc_base.h"

class adaptive_fir_ccc_i : public adaptive_fir_ccc_base
{
    public:
        adaptive_fir_ccc_i(const char *uuid, const char *label);
        ~adaptive_fir_ccc_i();
