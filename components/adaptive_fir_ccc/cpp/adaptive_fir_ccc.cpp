...
adaptive_fir_ccc_i::adaptive_fir_ccc_i(const char *uuid, const char *label) :
adaptive_fir_ccc_base(uuid, label)
{
}

adaptive_fir_ccc_i::~adaptive_fir_ccc_i()
{
}
...
void adaptive_fir_ccc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr::filter::adaptive_fir_ccc::make( this->name.c_str(), this->decimation, this->taps );

    this->registerGetter("taps",
                         &gr::filter::adaptive_fir_ccc::taps);

    this->registerSetter("taps",
                         &gr::filter::adaptive_fir_ccc::set_taps);
...
//      
BULKIO::StreamSRI adaptive_fir_ccc_i::createOutputSRI( int32_t idx)
{
    //
