...
#ifndef FS_CHECKER_FF_2I2O_IMPL_H
#define FS_CHECKER_FF_2I2O_IMPL_H

#include "fs_checker_ff_2i2o_base.h"

class fs_checker_ff_2i2o_i : public fs_checker_ff_2i2o_base
{
    public:
        fs_checker_ff_2i2o_i(const char *uuid, const char *label);
        ~fs_checker_ff_2i2o_i();
        ...
        void reset_data(const std::string &id);
