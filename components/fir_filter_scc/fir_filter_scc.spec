...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fir_filter_scc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_scc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_scc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_scc.spd.xml
