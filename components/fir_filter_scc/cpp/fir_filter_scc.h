...
#ifndef FIR_FILTER_SCC_IMPL_H
#define FIR_FILTER_SCC_IMPL_H

#include "fir_filter_scc_base.h"

class fir_filter_scc_i : public fir_filter_scc_base
{
    public:
        fir_filter_scc_i(const char *uuid, const char *label);
        ~fir_filter_scc_i();
