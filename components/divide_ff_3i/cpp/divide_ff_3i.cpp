...
divide_ff_3i_i::divide_ff_3i_i(const char *uuid, const char *label) :
divide_ff_3i_base(uuid, label)
{
}

divide_ff_3i_i::~divide_ff_3i_i()
{
}
...
void divide_ff_3i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI divide_ff_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
