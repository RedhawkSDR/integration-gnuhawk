...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/argmax_fs_4i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_4i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_4i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_4i.spd.xml
