...
./reconf
%define _bindir %{_prefix}/dom/components/multiply_cc_2i/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_cc_2i.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_cc_2i.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_cc_2i.spd.xml
