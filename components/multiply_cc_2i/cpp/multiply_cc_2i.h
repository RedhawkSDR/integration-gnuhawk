...
#ifndef MULTIPLY_CC_2I_IMPL_H
#define MULTIPLY_CC_2I_IMPL_H

#include "multiply_cc_2i_base.h"

class multiply_cc_2i_i : public multiply_cc_2i_base
{
   public:
      multiply_cc_2i_i(const char *uuid, const char *label);
      ~multiply_cc_2i_i();
