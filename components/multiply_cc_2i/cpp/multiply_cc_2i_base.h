...
class multiply_cc_2i_base : public GnuHawkBlock
{
    ...
    protected:
        ...
        // Ports
        bulkio::InFloatPort *data_complex_in_0;
        bulkio::InFloatPort *data_complex_in_1;
        bulkio::OutFloatPort *data_complex_out;
    ...
    protected:
        ...
        void  data_complex_in_0_newStreamCallback( BULKIO::StreamSRI &sri );

        // callback when a new Stream ID is detected on the port so we can add to istream/ostream mapping list
        void  data_complex_in_1_newStreamCallback( BULKIO::StreamSRI &sri );
