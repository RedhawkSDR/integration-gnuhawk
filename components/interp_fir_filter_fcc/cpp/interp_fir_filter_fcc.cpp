...
interp_fir_filter_fcc_i::interp_fir_filter_fcc_i(const char *uuid, const char *label) :
interp_fir_filter_fcc_base(uuid, label)
{
}

interp_fir_filter_fcc_i::~interp_fir_filter_fcc_i()
{
}
...
void interp_fir_filter_fcc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr::filter::interp_fir_filter_fcc::make( this->interpolation, this->taps );

    this->registerGetter("taps", &gr::filter::interp_fir_filter_fcc::taps);
    this->registerSetter("taps", &gr::filter::interp_fir_filter_fcc::set_taps);
...
//      
BULKIO::StreamSRI interp_fir_filter_fcc_i::createOutputSRI( int32_t idx)
{
    //
