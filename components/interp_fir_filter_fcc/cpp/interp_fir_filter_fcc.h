...
#ifndef INTERP_FIR_FILTER_FCC_IMPL_H
#define INTERP_FIR_FILTER_FCC_IMPL_H

#include "interp_fir_filter_fcc_base.h"

class interp_fir_filter_fcc_i : public interp_fir_filter_fcc_base
{
    public:
        interp_fir_filter_fcc_i(const char *uuid, const char *label);
        ~interp_fir_filter_fcc_i();
