...
class interp_fir_filter_fcc_base : public GnuHawkBlock, ThreadedComponent
{
    public:
        interp_fir_filter_fcc_base(const char *uuid, const char *label);
        ~interp_fir_filter_fcc_base();
    ...
    struct gr_istream_base {
        ...
        void _check( int inMode , bool force=false) {
            ...
            try {
                ...
                LOG_TRACE( interp_fir_filter_fcc_base, "UNABLE TO SET VLEN, BAD INDEX:" << _idx );
            }
...
#endif // INTERP_FIR_FILTER_FCC_IMPL_BASE_H
