...
deinterleave_ff_3o_i::deinterleave_ff_3o_i(const char *uuid, const char *label) :
deinterleave_ff_3o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_ff_3o_i::streamIdChanged );
}

deinterleave_ff_3o_i::~deinterleave_ff_3o_i()
{
}

void deinterleave_ff_3o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_ff_3o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI deinterleave_ff_3o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
