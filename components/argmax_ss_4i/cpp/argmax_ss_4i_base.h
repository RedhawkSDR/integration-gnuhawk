...
#ifndef ARGMAX_SS_4I_IMPL_BASE_H
#define ARGMAX_SS_4I_IMPL_BASE_H
...
#include "argmax_ss_4i_GnuHawkBlock.h"

#define NOOP 0
#define FINISH -1
#define NORMAL 1

class argmax_ss_4i_base;
...
class argmax_ss_4i_base : public GnuHawkBlock
{
    public:
        argmax_ss_4i_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<argmax_ss_4i_base> *serviceThread; 
        ...
        bulkio::InShortPort *short_in_4;
        bulkio::OutShortPort *short_out_1;
        bulkio::OutShortPort *short_out_2;
    ...
    protected:
        ...
        // callback when a new Stream ID is detected on the port so we can add to istream/ostream mapping list
        void  short_in_4_newStreamCallback( BULKIO::StreamSRI &sri );
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( argmax_ss_4i_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( argmax_ss_4i_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( argmax_ss_4i_base, " serviceFunction: retval:" << retval);
