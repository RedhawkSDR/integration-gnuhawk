...
argmax_ss_4i_i::argmax_ss_4i_i(const char *uuid, const char *label) :
argmax_ss_4i_base(uuid, label)
{
}

argmax_ss_4i_i::~argmax_ss_4i_i()
{
}
...
void argmax_ss_4i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_argmax_ss (this->vlen);
...
//      
BULKIO::StreamSRI argmax_ss_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
