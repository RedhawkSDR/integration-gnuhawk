...
#ifndef FEEDFORWARD_AGC_CC_IMPL_H
#define FEEDFORWARD_AGC_CC_IMPL_H

#include "feedforward_agc_cc_base.h"

class feedforward_agc_cc_i : public feedforward_agc_cc_base
{
   public:
      feedforward_agc_cc_i(const char *uuid, const char *label);
      ~feedforward_agc_cc_i();
