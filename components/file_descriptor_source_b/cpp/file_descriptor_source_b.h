...
#ifndef FILE_DESCRIPTOR_SOURCE_B_IMPL_H
#define FILE_DESCRIPTOR_SOURCE_B_IMPL_H

#include "file_descriptor_source_b_base.h"

class file_descriptor_source_b_i : public file_descriptor_source_b_base
{
    public:
        file_descriptor_source_b_i(const char *uuid, const char *label);
        ~file_descriptor_source_b_i();
