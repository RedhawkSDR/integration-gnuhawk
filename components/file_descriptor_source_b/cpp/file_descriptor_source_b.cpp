...
#include "file_descriptor_source_b.h"
...
file_descriptor_source_b_i::file_descriptor_source_b_i(const char *uuid, const char *label) :
file_descriptor_source_b_base(uuid, label)
{
}

file_descriptor_source_b_i::~file_descriptor_source_b_i()
{
}
...
void file_descriptor_source_b_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI file_descriptor_source_b_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
