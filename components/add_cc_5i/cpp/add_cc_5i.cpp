...
add_cc_5i_i::add_cc_5i_i(const char *uuid, const char *label) :
add_cc_5i_base(uuid, label)
{
}

add_cc_5i_i::~add_cc_5i_i()
{
}
...
//      
BULKIO::StreamSRI add_cc_5i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
