...
#ifndef VECTOR_TO_STREAMS_BB_1O_IMPL_H
#define VECTOR_TO_STREAMS_BB_1O_IMPL_H

#include "vector_to_streams_bb_1o_base.h"

class vector_to_streams_bb_1o_i : public vector_to_streams_bb_1o_base
{
    public:
        vector_to_streams_bb_1o_i(const char *uuid, const char *label);
        ~vector_to_streams_bb_1o_i();
