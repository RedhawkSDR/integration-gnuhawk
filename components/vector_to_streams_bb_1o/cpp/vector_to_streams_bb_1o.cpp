...
#include "vector_to_streams_bb_1o.h"
...
vector_to_streams_bb_1o_i::vector_to_streams_bb_1o_i(const char *uuid, const char *label) :
vector_to_streams_bb_1o_base(uuid, label)
{
}

vector_to_streams_bb_1o_i::~vector_to_streams_bb_1o_i()
{
}
...
void vector_to_streams_bb_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI vector_to_streams_bb_1o_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
