...
#ifndef PEAK_DETECTOR2_FB_1O_IMPL_H
#define PEAK_DETECTOR2_FB_1O_IMPL_H

#include "peak_detector2_fb_1o_base.h"

class peak_detector2_fb_1o_i : public peak_detector2_fb_1o_base
{
    public:
        peak_detector2_fb_1o_i(const char *uuid, const char *label);
        ~peak_detector2_fb_1o_i();
        ...
        float get_threshold_factor_rise();
        int get_look_ahead();
        float get_alpha();
};
