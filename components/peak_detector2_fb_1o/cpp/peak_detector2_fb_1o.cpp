...
#include "peak_detector2_fb_1o.h"
...
peak_detector2_fb_1o_i::peak_detector2_fb_1o_i(const char *uuid, const char *label) :
peak_detector2_fb_1o_base(uuid, label)
{
}

peak_detector2_fb_1o_i::~peak_detector2_fb_1o_i()
{
}


float peak_detector2_fb_1o_i::get_threshold_factor_rise()
{
    return gr_sptr->threshold_factor_rise();
}

int peak_detector2_fb_1o_i::get_look_ahead()
{
    return gr_sptr->look_ahead();
}

float peak_detector2_fb_1o_i::get_alpha()
{
...
void peak_detector2_fb_1o_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_peak_detector2_fb( threshold_factor_rise, look_ahead, alpha );
    } catch (...) {
        return;
    }

    this->registerSetter("threshold_factor_rise", &gr_peak_detector2_fb::set_threshold_factor_rise);
    this->registerSetter("look_ahead", &gr_peak_detector2_fb::set_look_ahead);
    this->registerSetter("alpha", &gr_peak_detector2_fb::set_alpha);

    this->registerGetValue("threshold_factor_rise", this, &peak_detector2_fb_1o_i::get_threshold_factor_rise);
    this->registerGetValue("look_ahead", this, &peak_detector2_fb_1o_i::get_look_ahead);
    this->registerGetValue("alpha", this, &peak_detector2_fb_1o_i::get_alpha);
...
//      
BULKIO::StreamSRI peak_detector2_fb_1o_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
