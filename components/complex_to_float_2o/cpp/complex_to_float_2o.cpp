...
complex_to_float_2o_i::complex_to_float_2o_i(const char *uuid, const char *label) :
complex_to_float_2o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &complex_to_float_2o_i::streamIdChanged );
}

complex_to_float_2o_i::~complex_to_float_2o_i()
{
}

void complex_to_float_2o_i::streamIdChanged(const std::string& id)
{ 
...
//      
BULKIO::StreamSRI complex_to_float_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
