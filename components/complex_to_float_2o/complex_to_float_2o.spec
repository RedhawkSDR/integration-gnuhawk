...
./reconf
%define _bindir %{_prefix}/dom/components/complex_to_float_2o/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_float_2o.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_float_2o.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/complex_to_float_2o.spd.xml
