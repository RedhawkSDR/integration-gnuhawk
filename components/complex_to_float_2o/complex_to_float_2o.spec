...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/complex_to_float_2o/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_float_2o.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_float_2o.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/complex_to_float_2o.spd.xml
