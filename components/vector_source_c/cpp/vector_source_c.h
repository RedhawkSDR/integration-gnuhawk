...
#ifndef VECTOR_SOURCE_C_IMPL_H
#define VECTOR_SOURCE_C_IMPL_H

#include "vector_source_c_base.h"

class vector_source_c_i : public vector_source_c_base
{
    public:
        vector_source_c_i(const char *uuid, const char *label);
        ~vector_source_c_i();
