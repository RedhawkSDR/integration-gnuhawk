...
./reconf
%define _bindir %{_prefix}/dom/components/unpack_k_bits_bb/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/unpack_k_bits_bb.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/unpack_k_bits_bb.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/unpack_k_bits_bb.spd.xml
