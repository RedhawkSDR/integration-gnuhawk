...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataOctet_Out_i(std::string port_name, unpack_k_bits_bb_base *_parent);
...
class BULKIO_dataOctet_In_i : public POA_BULKIO::dataOctet, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataOctet_In_i(std::string port_name, unpack_k_bits_bb_base *_parent);
