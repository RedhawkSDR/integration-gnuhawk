...
#ifndef UNPACK_K_BITS_BB_IMPL_H
#define UNPACK_K_BITS_BB_IMPL_H

#include "unpack_k_bits_bb_base.h"

class unpack_k_bits_bb_i : public unpack_k_bits_bb_base
{
   public:
      unpack_k_bits_bb_i(const char *uuid, const char *label);
      ~unpack_k_bits_bb_i();
