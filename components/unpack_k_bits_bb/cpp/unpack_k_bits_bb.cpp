...
unpack_k_bits_bb_i::unpack_k_bits_bb_i(const char *uuid, const char *label) :
unpack_k_bits_bb_base(uuid, label)
{
}

unpack_k_bits_bb_i::~unpack_k_bits_bb_i()
{
}
...
//
void unpack_k_bits_bb_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_unpack_k_bits_bb(k);
...
//      
BULKIO::StreamSRI unpack_k_bits_bb_i::createOutputSRI( int32_t idx)
{
  //
