...
class single_pole_iir_filter_ff_i;
...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataFloat_Out_i(std::string port_name, single_pole_iir_filter_ff_base *_parent);
    ...
    protected:
        single_pole_iir_filter_ff_i *parent;
...
class BULKIO_dataFloat_In_i : public POA_BULKIO::dataFloat, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataFloat_In_i(std::string port_name, single_pole_iir_filter_ff_base *_parent);
