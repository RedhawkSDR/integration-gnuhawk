...
#ifndef SINGLE_POLE_IIR_FILTER_FF_IMPL_H
#define SINGLE_POLE_IIR_FILTER_FF_IMPL_H

#include "single_pole_iir_filter_ff_base.h"

class single_pole_iir_filter_ff_i : public single_pole_iir_filter_ff_base
{
   public:
      single_pole_iir_filter_ff_i(const char *uuid, const char *label);
      ~single_pole_iir_filter_ff_i();
