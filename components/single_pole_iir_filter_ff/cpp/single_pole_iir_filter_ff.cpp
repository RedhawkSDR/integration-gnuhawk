...
single_pole_iir_filter_ff_i::single_pole_iir_filter_ff_i(const char *uuid, const char *label) :
single_pole_iir_filter_ff_base(uuid, label)
{
}

single_pole_iir_filter_ff_i::~single_pole_iir_filter_ff_i()
{
}
...
//
void single_pole_iir_filter_ff_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
    this->gr_sptr = gr::filter::single_pole_iir_filter_ff::make( this->alpha, this->vlen );
    this->registerSetter("alpha", &gr::filter::single_pole_iir_filter_ff::set_taps);
...
//      
BULKIO::StreamSRI single_pole_iir_filter_ff_i::createOutputSRI( int32_t idx)
{
  //
