...
#ifndef MOVING_AVERAGE_CC_IMPL_H
#define MOVING_AVERAGE_CC_IMPL_H

#include "moving_average_cc_base.h"

class moving_average_cc_i : public moving_average_cc_base
{
    public:
        moving_average_cc_i(const char *uuid, const char *label);
        ~moving_average_cc_i();
