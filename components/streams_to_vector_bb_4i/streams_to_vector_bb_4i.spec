...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/streams_to_vector_bb_4i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_vector_bb_4i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_vector_bb_4i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_vector_bb_4i.spd.xml
