...
#ifndef PEAK_DETECTOR_FB_IMPL_H
#define PEAK_DETECTOR_FB_IMPL_H

#include "peak_detector_fb_base.h"

class peak_detector_fb_i : public peak_detector_fb_base
{
    public:
        peak_detector_fb_i(const char *uuid, const char *label);
        ~peak_detector_fb_i();
