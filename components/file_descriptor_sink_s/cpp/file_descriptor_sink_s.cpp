...
#include "file_descriptor_sink_s.h"
...
file_descriptor_sink_s_i::file_descriptor_sink_s_i(const char *uuid, const char *label) :
file_descriptor_sink_s_base(uuid, label)
{
}

file_descriptor_sink_s_i::~file_descriptor_sink_s_i()
{
}
...
void file_descriptor_sink_s_i::createBlock()
{
    //
