...
endian_swap_bb_i::endian_swap_bb_i(const char *uuid, const char *label) :
endian_swap_bb_base(uuid, label)
{
}

endian_swap_bb_i::~endian_swap_bb_i()
{
}
...
void endian_swap_bb_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI endian_swap_bb_i::createOutputSRI( int32_t idx)
{
    //
