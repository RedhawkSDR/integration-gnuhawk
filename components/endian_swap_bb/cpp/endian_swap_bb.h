...
#ifndef ENDIAN_SWAP_BB_IMPL_H
#define ENDIAN_SWAP_BB_IMPL_H

#include "endian_swap_bb_base.h"

class endian_swap_bb_i : public endian_swap_bb_base
{
    public:
        endian_swap_bb_i(const char *uuid, const char *label);
        ~endian_swap_bb_i();
