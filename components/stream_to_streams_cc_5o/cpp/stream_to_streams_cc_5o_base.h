...
#ifndef STREAM_TO_STREAMS_CC_5O_IMPL_BASE_H
#define STREAM_TO_STREAMS_CC_5O_IMPL_BASE_H
...
#include "stream_to_streams_cc_5o_GnuHawkBlock.h"
#include <sstream>
...
class stream_to_streams_cc_5o_base;
...
class stream_to_streams_cc_5o_base : public GnuHawkBlock
{
    public:
        stream_to_streams_cc_5o_base(const char *uuid, const char *label);
        ...
        ~stream_to_streams_cc_5o_base();

        void loadProperties();

    protected:
        ProcessThread<stream_to_streams_cc_5o_base> *serviceThread; 
        boost::mutex serviceThreadLock;

        // Member variables exposed as properties
        CORBA::ULong item_size;
        CORBA::ULong nstreams;
    ...
    struct gr_istream_base {
        ...
        void _check( int inMode , bool force=false) {
            ...
            try {
                ...
                LOG_TRACE( stream_to_streams_cc_5o_base, "UNABLE TO SET VLEN, BAD INDEX:" << _idx );
            }
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( stream_to_streams_cc_5o_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( stream_to_streams_cc_5o_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( stream_to_streams_cc_5o_base, " serviceFunction: retval:" << retval);
