...
keep_m_in_n_ii_i::keep_m_in_n_ii_i(const char *uuid, const char *label) :
keep_m_in_n_ii_base(uuid, label)
{
}

keep_m_in_n_ii_i::~keep_m_in_n_ii_i()
{
}
...
void keep_m_in_n_ii_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI keep_m_in_n_ii_i::createOutputSRI( int32_t idx)
{
    //
