...
#ifndef KEEP_M_IN_N_II_IMPL_H
#define KEEP_M_IN_N_II_IMPL_H

#include "keep_m_in_n_ii_base.h"

class keep_m_in_n_ii_i : public keep_m_in_n_ii_base
{
    public:
        keep_m_in_n_ii_i(const char *uuid, const char *label);
        ~keep_m_in_n_ii_i();
