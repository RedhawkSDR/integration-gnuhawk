...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/keep_m_in_n_ii/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_ii.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_ii.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_ii.spd.xml
