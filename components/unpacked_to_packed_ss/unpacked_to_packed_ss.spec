...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/unpacked_to_packed_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_ss.spd.xml
