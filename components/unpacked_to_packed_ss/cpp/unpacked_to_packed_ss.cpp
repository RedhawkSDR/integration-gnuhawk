...
#include "unpacked_to_packed_ss.h"
...
unpacked_to_packed_ss_i::unpacked_to_packed_ss_i(const char *uuid, const char *label) :
unpacked_to_packed_ss_base(uuid, label)
{
}

unpacked_to_packed_ss_i::~unpacked_to_packed_ss_i()
{
}
...
void unpacked_to_packed_ss_i::createBlock()
{
    //
    ...
    gr_sptr = gr_make_unpacked_to_packed_ss(this->bits_per_chunk, end);
...
//      
BULKIO::StreamSRI unpacked_to_packed_ss_i::createOutputSRI( int32_t idx)
{
    //
