...
#ifndef UNPACKED_TO_PACKED_SS_IMPL_H
#define UNPACKED_TO_PACKED_SS_IMPL_H

#include "unpacked_to_packed_ss_base.h"

class unpacked_to_packed_ss_i : public unpacked_to_packed_ss_base
{
    public:
        unpacked_to_packed_ss_i(const char *uuid, const char *label);
        ~unpacked_to_packed_ss_i();
