...
single_pole_iir_filter_cc_i::single_pole_iir_filter_cc_i(const char *uuid, const char *label) :
single_pole_iir_filter_cc_base(uuid, label)
{
}

single_pole_iir_filter_cc_i::~single_pole_iir_filter_cc_i()
{
}
...
//
void single_pole_iir_filter_cc_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI single_pole_iir_filter_cc_i::createOutputSRI( int32_t idx)
{
  //
