...
#ifndef SINGLE_POLE_IIR_FILTER_CC_IMPL_H
#define SINGLE_POLE_IIR_FILTER_CC_IMPL_H

#include "single_pole_iir_filter_cc_base.h"

class single_pole_iir_filter_cc_i : public single_pole_iir_filter_cc_base
{
   public:
      single_pole_iir_filter_cc_i(const char *uuid, const char *label);
      ~single_pole_iir_filter_cc_i();
