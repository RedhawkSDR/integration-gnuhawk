...
max_ss_4i_i::max_ss_4i_i(const char *uuid, const char *label) :
max_ss_4i_base(uuid, label)
{
}

max_ss_4i_i::~max_ss_4i_i()
{
}
...
void max_ss_4i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_max_ss (this->vlen);
...
//      
BULKIO::StreamSRI max_ss_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
