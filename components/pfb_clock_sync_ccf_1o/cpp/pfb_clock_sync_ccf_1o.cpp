...
#include "pfb_clock_sync_ccf_1o.h"
...
pfb_clock_sync_ccf_1o_i::pfb_clock_sync_ccf_1o_i(const char *uuid, const char *label) :
pfb_clock_sync_ccf_1o_base(uuid, label)
{
}

pfb_clock_sync_ccf_1o_i::~pfb_clock_sync_ccf_1o_i()
{
}
...
void pfb_clock_sync_ccf_1o_i::createBlock()
{
    //
    ...
    this->registerSetter("max_rate_deviation", &digital_pfb_clock_sync_ccf::set_max_rate_deviation);
    // 
...
//      
BULKIO::StreamSRI pfb_clock_sync_ccf_1o_i::createOutputSRI( int32_t idx)
{
    //
