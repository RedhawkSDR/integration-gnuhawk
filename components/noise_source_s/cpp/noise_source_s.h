...
#ifndef NOISE_SOURCE_S_IMPL_H
#define NOISE_SOURCE_S_IMPL_H

#include "noise_source_s_base.h"

class noise_source_s_i : public noise_source_s_base
{
   public:
      noise_source_s_i(const char *uuid, const char *label);
      ~noise_source_s_i();
