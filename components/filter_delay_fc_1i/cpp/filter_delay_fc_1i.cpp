...
filter_delay_fc_1i_i::filter_delay_fc_1i_i(const char *uuid, const char *label) :
filter_delay_fc_1i_base(uuid, label)
{
}

filter_delay_fc_1i_i::~filter_delay_fc_1i_i()
{
}
...
//
void filter_delay_fc_1i_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI filter_delay_fc_1i_i::createOutputSRI( int32_t idx)
{
  //
