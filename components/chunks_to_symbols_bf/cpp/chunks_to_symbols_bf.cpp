...
#include "chunks_to_symbols_bf.h"
...
chunks_to_symbols_bf_i::chunks_to_symbols_bf_i(const char *uuid, const char *label) :
chunks_to_symbols_bf_base(uuid, label)
{
}

chunks_to_symbols_bf_i::~chunks_to_symbols_bf_i()
{
}
...
void chunks_to_symbols_bf_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_chunks_to_symbols_bf( this->symbol_table, this->D );

    this->registerGetter("symbol_table", &gr_chunks_to_symbols_bf::symbol_table);
    this->registerGetter("D", &gr_chunks_to_symbols_bf::D);
    // 
...
//      
BULKIO::StreamSRI chunks_to_symbols_bf_i::createOutputSRI( int32_t idx)
{
    //
