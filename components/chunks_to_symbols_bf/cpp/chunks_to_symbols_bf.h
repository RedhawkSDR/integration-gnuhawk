...
#ifndef CHUNKS_TO_SYMBOLS_BF_IMPL_H
#define CHUNKS_TO_SYMBOLS_BF_IMPL_H

#include "chunks_to_symbols_bf_base.h"

class chunks_to_symbols_bf_i : public chunks_to_symbols_bf_base
{
    public:
        chunks_to_symbols_bf_i(const char *uuid, const char *label);
        ~chunks_to_symbols_bf_i();
