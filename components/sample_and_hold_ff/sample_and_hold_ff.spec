...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/sample_and_hold_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sample_and_hold_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sample_and_hold_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/sample_and_hold_ff.spd.xml
