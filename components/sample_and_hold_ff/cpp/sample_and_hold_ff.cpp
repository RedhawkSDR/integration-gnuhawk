...
sample_and_hold_ff_i::sample_and_hold_ff_i(const char *uuid, const char *label) :
sample_and_hold_ff_base(uuid, label)
{
}

sample_and_hold_ff_i::~sample_and_hold_ff_i()
{
}
...
void sample_and_hold_ff_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_sample_and_hold_ff();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sample_and_hold_ff_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
