...
#ifndef SAMPLE_AND_HOLD_FF_IMPL_H
#define SAMPLE_AND_HOLD_FF_IMPL_H

#include "sample_and_hold_ff_base.h"

class sample_and_hold_ff_i : public sample_and_hold_ff_base
{
    public:
        sample_and_hold_ff_i(const char *uuid, const char *label);
        ~sample_and_hold_ff_i();
