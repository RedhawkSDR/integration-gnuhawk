...
./reconf
%define _bindir %{_prefix}/dom/components/fft_vfc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vfc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vfc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fft_vfc.spd.xml
