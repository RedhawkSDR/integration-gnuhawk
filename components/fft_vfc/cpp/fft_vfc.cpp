...
fft_vfc_i::fft_vfc_i(const char *uuid, const char *label) :
fft_vfc_base(uuid, label)
{
}
...
void fft_vfc_i::changedWindow(const std::string &id)
{
        gr_sptr->set_window(window);
}
...
//      
BULKIO::StreamSRI fft_vfc_i::createOutputSRI( int32_t idx)
{
  //
