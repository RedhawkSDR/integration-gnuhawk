...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/add_const_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/add_const_bb.spd.xml
