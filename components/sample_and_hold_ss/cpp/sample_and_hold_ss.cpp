...
sample_and_hold_ss_i::sample_and_hold_ss_i(const char *uuid, const char *label) :
sample_and_hold_ss_base(uuid, label)
{
}

sample_and_hold_ss_i::~sample_and_hold_ss_i()
{
}
...
void sample_and_hold_ss_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_sample_and_hold_ss();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sample_and_hold_ss_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
