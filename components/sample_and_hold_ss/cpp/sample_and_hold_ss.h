...
#ifndef SAMPLE_AND_HOLD_SS_IMPL_H
#define SAMPLE_AND_HOLD_SS_IMPL_H

#include "sample_and_hold_ss_base.h"

class sample_and_hold_ss_i : public sample_and_hold_ss_base
{
    public:
        sample_and_hold_ss_i(const char *uuid, const char *label);
        ~sample_and_hold_ss_i();
