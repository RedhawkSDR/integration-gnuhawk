...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fft_filter_ccc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_ccc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_ccc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fft_filter_ccc.spd.xml
