...
#ifndef FFT_FILTER_CCC_IMPL_H
#define FFT_FILTER_CCC_IMPL_H

#include "fft_filter_ccc_base.h"

class fft_filter_ccc_i : public fft_filter_ccc_base
{
    public:
        fft_filter_ccc_i(const char *uuid, const char *label);
        ~fft_filter_ccc_i();
