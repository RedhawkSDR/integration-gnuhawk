...
max_ff_2i_i::max_ff_2i_i(const char *uuid, const char *label) :
max_ff_2i_base(uuid, label)
{
}

max_ff_2i_i::~max_ff_2i_i()
{
}
...
void max_ff_2i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_max_ff (this->vlen);
...
//      
BULKIO::StreamSRI max_ff_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
