...
#ifndef FIR_FILTER_FFF_IMPL_H
#define FIR_FILTER_FFF_IMPL_H

#include "fir_filter_fff_base.h"

class fir_filter_fff_i : public fir_filter_fff_base
{
   public:
      fir_filter_fff_i(const char *uuid, const char *label);
      ~fir_filter_fff_i();
