...
sample_and_hold_ii_i::sample_and_hold_ii_i(const char *uuid, const char *label) :
sample_and_hold_ii_base(uuid, label)
{
}

sample_and_hold_ii_i::~sample_and_hold_ii_i()
{
}
...
void sample_and_hold_ii_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_sample_and_hold_ii();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sample_and_hold_ii_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
