...
#ifndef SAMPLE_AND_HOLD_II_IMPL_H
#define SAMPLE_AND_HOLD_II_IMPL_H

#include "sample_and_hold_ii_base.h"

class sample_and_hold_ii_i : public sample_and_hold_ii_base
{
    public:
        sample_and_hold_ii_i(const char *uuid, const char *label);
        ~sample_and_hold_ii_i();
