...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_i.spd.xml
