...
#ifndef GLFSR_SOURCE_B_IMPL_H
#define GLFSR_SOURCE_B_IMPL_H

#include "glfsr_source_b_base.h"

class glfsr_source_b_i : public glfsr_source_b_base
{
    public:
        glfsr_source_b_i(const char *uuid, const char *label);
        ~glfsr_source_b_i();
