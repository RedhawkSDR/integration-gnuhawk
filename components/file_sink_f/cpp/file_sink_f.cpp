...
file_sink_f_i::file_sink_f_i(const char *uuid, const char *label) :
file_sink_f_base(uuid, label)
{
}

file_sink_f_i::~file_sink_f_i()
{
}
...
void file_sink_f_i::createBlock()
{
    //
