...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/simple_framer/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/simple_framer.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/simple_framer.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/simple_framer.spd.xml
