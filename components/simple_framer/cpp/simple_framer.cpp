...
simple_framer_i::simple_framer_i(const char *uuid, const char *label) :
simple_framer_base(uuid, label)
{
}

simple_framer_i::~simple_framer_i()
{
}
...
void simple_framer_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = digital_make_simple_framer( this->payload_bytesize );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI simple_framer_i::createOutputSRI( int32_t idx)
{
    //
