...
max_ii_3i_i::max_ii_3i_i(const char *uuid, const char *label) :
max_ii_3i_base(uuid, label)
{
}

max_ii_3i_i::~max_ii_3i_i()
{
}
...
void max_ii_3i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_max_ii (this->vlen);
...
//      
BULKIO::StreamSRI max_ii_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
