...
./reconf
%define _bindir %{_prefix}/dom/components/agc_cc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_cc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_cc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/agc_cc.spd.xml
