...
#ifndef GSM_FR_DECODE_PS_IMPL_H
#define GSM_FR_DECODE_PS_IMPL_H

#include "gsm_fr_decode_ps_base.h"

class gsm_fr_decode_ps_i : public gsm_fr_decode_ps_base
{
    public:
        gsm_fr_decode_ps_i(const char *uuid, const char *label);
        ~gsm_fr_decode_ps_i();
