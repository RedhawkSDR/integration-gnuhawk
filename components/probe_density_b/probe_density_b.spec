...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_density_b/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_density_b.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_density_b.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_density_b.spd.xml
