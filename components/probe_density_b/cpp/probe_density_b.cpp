...
probe_density_b_i::probe_density_b_i(const char *uuid, const char *label) :
probe_density_b_base(uuid, label)
{
}

probe_density_b_i::~probe_density_b_i()
{
}
...
void probe_density_b_i::createBlock()
{
    //
    ...
    gr_sptr = digital_make_probe_density_b( this->alpha );

    this->registerSetter("alpha",
                        &digital_probe_density_b::set_alpha);
    this->registerGetter("density",
                        &digital_probe_density_b::density);
