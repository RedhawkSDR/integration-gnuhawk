...
tagged_file_sink_c_i::tagged_file_sink_c_i(const char *uuid, const char *label) :
tagged_file_sink_c_base(uuid, label)
{
}

tagged_file_sink_c_i::~tagged_file_sink_c_i()
{
}
...
void tagged_file_sink_c_i::createBlock()
{
    //
