...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/tagged_file_sink_c/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/tagged_file_sink_c.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/tagged_file_sink_c.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/tagged_file_sink_c.spd.xml
