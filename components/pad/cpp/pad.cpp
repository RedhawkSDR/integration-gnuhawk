...
pad_i::pad_i(const char *uuid, const char *label) :
pad_base(uuid, label)
{
}
...
//      
BULKIO::StreamSRI pad_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
