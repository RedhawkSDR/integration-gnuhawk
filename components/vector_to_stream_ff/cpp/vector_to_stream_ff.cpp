...
vector_to_stream_ff_i::vector_to_stream_ff_i(const char *uuid, const char *label) :
vector_to_stream_ff_base(uuid, label)
{
}

vector_to_stream_ff_i::~vector_to_stream_ff_i()
{
}
...
void vector_to_stream_ff_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI vector_to_stream_ff_i::createOutputSRI( int32_t idx)
{
    //
