...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_to_stream_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_to_stream_ff.spd.xml
