...
#ifndef STREAMS_TO_VECTOR_II_4I_IMPL_H
#define STREAMS_TO_VECTOR_II_4I_IMPL_H

#include "streams_to_vector_ii_4i_base.h"

class streams_to_vector_ii_4i_i : public streams_to_vector_ii_4i_base
{
    public:
        streams_to_vector_ii_4i_i(const char *uuid, const char *label);
        ~streams_to_vector_ii_4i_i();
