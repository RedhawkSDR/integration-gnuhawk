...
./reconf
%define _bindir %{_prefix}/dom/components/and_const_bb/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/and_const_bb.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/and_const_bb.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/and_const_bb.spd.xml
