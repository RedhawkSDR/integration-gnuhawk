...
#ifndef LFSR_32K_SOURCE_S_IMPL_H
#define LFSR_32K_SOURCE_S_IMPL_H

#include "lfsr_32k_source_s_base.h"

class lfsr_32k_source_s_i : public lfsr_32k_source_s_base
{
    public:
        lfsr_32k_source_s_i(const char *uuid, const char *label);
        ~lfsr_32k_source_s_i();
