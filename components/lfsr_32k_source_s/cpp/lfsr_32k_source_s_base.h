...
#ifndef LFSR_32K_SOURCE_S_IMPL_BASE_H
#define LFSR_32K_SOURCE_S_IMPL_BASE_H
...
class lfsr_32k_source_s_base : public GnuHawkBlock
{
    public:
        lfsr_32k_source_s_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<lfsr_32k_source_s_base> *serviceThread; 
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( lfsr_32k_source_s_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( lfsr_32k_source_s_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( lfsr_32k_source_s_base, " serviceFunction: retval:" << retval);
