...
lfsr_32k_source_s_i::lfsr_32k_source_s_i(const char *uuid, const char *label) :
lfsr_32k_source_s_base(uuid, label)
{
}

lfsr_32k_source_s_i::~lfsr_32k_source_s_i()
{
}
...
void lfsr_32k_source_s_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_lfsr_32k_source_s();
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI lfsr_32k_source_s_i::createOutputSRI( int32_t idx)
{
    //
