...
#ifndef VECTOR_SOURCE_F_IMPL_H
#define VECTOR_SOURCE_F_IMPL_H

#include "vector_source_f_base.h"

class vector_source_f_i : public vector_source_f_base
{
   public:
      vector_source_f_i(const char *uuid, const char *label);
      ~vector_source_f_i();
