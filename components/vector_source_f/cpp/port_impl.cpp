...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Source: vector_source_f.spd.xml
 	Generated on: Thu Feb 28 14:52:17 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,vector_source_f_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, vector_source_f_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<vector_source_f_i *> (_parent);
