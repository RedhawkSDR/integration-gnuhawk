...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/file_descriptor_source_f/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_descriptor_source_f.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_descriptor_source_f.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_descriptor_source_f.spd.xml
