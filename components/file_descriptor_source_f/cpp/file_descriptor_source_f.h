...
#ifndef FILE_DESCRIPTOR_SOURCE_F_IMPL_H
#define FILE_DESCRIPTOR_SOURCE_F_IMPL_H

#include "file_descriptor_source_f_base.h"

class file_descriptor_source_f_i : public file_descriptor_source_f_base
{
    public:
        file_descriptor_source_f_i(const char *uuid, const char *label);
        ~file_descriptor_source_f_i();
