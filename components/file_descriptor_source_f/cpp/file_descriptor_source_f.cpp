...
#include "file_descriptor_source_f.h"
...
file_descriptor_source_f_i::file_descriptor_source_f_i(const char *uuid, const char *label) :
file_descriptor_source_f_base(uuid, label)
{
}

file_descriptor_source_f_i::~file_descriptor_source_f_i()
{
}
...
void file_descriptor_source_f_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI file_descriptor_source_f_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
