...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/float_to_int/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_int.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_int.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_int.spd.xml
