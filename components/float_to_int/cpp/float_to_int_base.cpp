...
// Destructor
float_to_int_base::~float_to_int_base()
{
    // Free input streams
...
int float_to_int_base::_transformerServiceFunction( std::vector< gr_istream_base * > &istreams ,
...
int float_to_int_base::_forecastAndProcess( bool &eos, std::vector< gr_istream_base * > &istreams ,
                                 std::vector< gr_ostream_base * > &ostreams  )
{
    typedef std::vector< gr_istream_base * >   _IStreamList;
    typedef std::vector< gr_ostream_base * >  _OStreamList;
...
// use incoming packet's time stamp to forward
      ...
      LOG_DEBUG( float_to_int_base, "                  mode:" <<  pktTs.tcmode );
      LOG_DEBUG( float_to_int_base, "                status:" <<  pktTs.tcstatus );
      LOG_DEBUG( float_to_int_base, "                offset:" <<  pktTs.toff );
      LOG_DEBUG( float_to_int_base, "                 whole:" <<  std::setprecision(10) << pktTs.twsec );
      LOG_DEBUG( float_to_int_base, "PKT - TS          frac:" <<  std::setprecision(12) << pktTs.tfsec );
#endif
