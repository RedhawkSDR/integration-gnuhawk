...
sub_ss_4i_i::sub_ss_4i_i(const char *uuid, const char *label) :
sub_ss_4i_base(uuid, label)
{
}

sub_ss_4i_i::~sub_ss_4i_i()
{
}
...
//      
BULKIO::StreamSRI sub_ss_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
