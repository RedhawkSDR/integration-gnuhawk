...
deinterleave_ii_3o_i::~deinterleave_ii_3o_i()
{
}

void deinterleave_ii_3o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_ii_3o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI deinterleave_ii_3o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
