...
#ifndef BURST_TAGGER_FF_IMPL_H
#define BURST_TAGGER_FF_IMPL_H

#include "burst_tagger_ff_base.h"

class burst_tagger_ff_i : public burst_tagger_ff_base
{
    public:
        burst_tagger_ff_i(const char *uuid, const char *label);
        ~burst_tagger_ff_i();
