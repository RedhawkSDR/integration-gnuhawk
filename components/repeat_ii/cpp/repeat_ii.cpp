...
repeat_ii_i::repeat_ii_i(const char *uuid, const char *label) :
repeat_ii_base(uuid, label)
{
}

repeat_ii_i::~repeat_ii_i()
{
}
...
void repeat_ii_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_repeat (this->itemsize, this->interp);
...
//      
BULKIO::StreamSRI repeat_ii_i::createOutputSRI( int32_t idx)
{
    //
