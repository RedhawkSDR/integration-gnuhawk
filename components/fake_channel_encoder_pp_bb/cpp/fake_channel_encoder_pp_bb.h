...
#ifndef FAKE_CHANNEL_ENCODER_PP_BB_IMPL_H
#define FAKE_CHANNEL_ENCODER_PP_BB_IMPL_H

#include "fake_channel_encoder_pp_bb_base.h"

class fake_channel_encoder_pp_bb_i : public fake_channel_encoder_pp_bb_base
{
    public:
        fake_channel_encoder_pp_bb_i(const char *uuid, const char *label);
        ~fake_channel_encoder_pp_bb_i();
