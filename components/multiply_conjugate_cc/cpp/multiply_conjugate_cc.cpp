...
multiply_conjugate_cc_i::multiply_conjugate_cc_i(const char *uuid, const char *label) :
multiply_conjugate_cc_base(uuid, label)
{
}

multiply_conjugate_cc_i::~multiply_conjugate_cc_i()
{
}
...
void multiply_conjugate_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_multiply_conjugate_cc( this->vlen );
...
//      
BULKIO::StreamSRI multiply_conjugate_cc_i::createOutputSRI( int32_t idx)
{
    //
