...
#ifndef MULTIPLY_CONJUGATE_CC_IMPL_H
#define MULTIPLY_CONJUGATE_CC_IMPL_H

#include "multiply_conjugate_cc_base.h"

class multiply_conjugate_cc_i : public multiply_conjugate_cc_base
{
    public:
        multiply_conjugate_cc_i(const char *uuid, const char *label);
        ~multiply_conjugate_cc_i();
