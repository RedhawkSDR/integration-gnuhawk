...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/multiply_conjugate_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_conjugate_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_conjugate_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_conjugate_cc.spd.xml
