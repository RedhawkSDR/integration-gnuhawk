...
#ifndef BURST_TAGGER_CC_IMPL_H
#define BURST_TAGGER_CC_IMPL_H

#include "burst_tagger_cc_base.h"

class burst_tagger_cc_i : public burst_tagger_cc_base
{
    public:
        burst_tagger_cc_i(const char *uuid, const char *label);
        ~burst_tagger_cc_i();
