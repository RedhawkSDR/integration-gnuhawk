...
#ifndef KEEP_M_IN_N_CC_IMPL_H
#define KEEP_M_IN_N_CC_IMPL_H

#include "keep_m_in_n_cc_base.h"

class keep_m_in_n_cc_i : public keep_m_in_n_cc_base
{
    public:
        keep_m_in_n_cc_i(const char *uuid, const char *label);
        ~keep_m_in_n_cc_i();
