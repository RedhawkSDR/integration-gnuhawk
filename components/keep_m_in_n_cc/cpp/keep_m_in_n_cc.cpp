...
keep_m_in_n_cc_i::keep_m_in_n_cc_i(const char *uuid, const char *label) :
keep_m_in_n_cc_base(uuid, label)
{
}

keep_m_in_n_cc_i::~keep_m_in_n_cc_i()
{
}
...
void keep_m_in_n_cc_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI keep_m_in_n_cc_i::createOutputSRI( int32_t idx)
{
    //
