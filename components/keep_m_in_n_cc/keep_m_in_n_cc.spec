...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/keep_m_in_n_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_m_in_n_cc.spd.xml
