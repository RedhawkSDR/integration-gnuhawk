...
null_sink_b_i::null_sink_b_i(const char *uuid, const char *label) :
null_sink_b_base(uuid, label)
{
}

null_sink_b_i::~null_sink_b_i()
{
}
...
void null_sink_b_i::createBlock()
{
    //
