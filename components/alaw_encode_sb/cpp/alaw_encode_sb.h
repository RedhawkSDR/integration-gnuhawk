...
#ifndef ALAW_ENCODE_SB_IMPL_H
#define ALAW_ENCODE_SB_IMPL_H

#include "alaw_encode_sb_base.h"

class alaw_encode_sb_i : public alaw_encode_sb_base
{
    public:
        alaw_encode_sb_i(const char *uuid, const char *label);
        ~alaw_encode_sb_i();
