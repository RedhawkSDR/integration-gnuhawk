...
float_to_complex_2i_i::float_to_complex_2i_i(const char *uuid, const char *label) :
float_to_complex_2i_base(uuid, label)
{
}

float_to_complex_2i_i::~float_to_complex_2i_i()
{
}
...
void float_to_complex_2i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI float_to_complex_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
