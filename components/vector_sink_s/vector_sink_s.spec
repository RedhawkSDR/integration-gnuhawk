...
./reconf
%define _bindir %{_prefix}/dom/components/vector_sink_s/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_s.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_s.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/vector_sink_s.spd.xml
