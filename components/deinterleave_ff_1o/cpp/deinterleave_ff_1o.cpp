...
deinterleave_ff_1o_i::deinterleave_ff_1o_i(const char *uuid, const char *label) :
deinterleave_ff_1o_base(uuid, label)
{
}

deinterleave_ff_1o_i::~deinterleave_ff_1o_i()
{
}
...
void deinterleave_ff_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI deinterleave_ff_1o_i::createOutputSRI( int32_t idx)
{
    //
