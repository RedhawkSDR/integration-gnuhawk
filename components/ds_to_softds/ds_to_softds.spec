...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/ds_to_softds/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ds_to_softds.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ds_to_softds.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/ds_to_softds.spd.xml
