...
divide_cc_4i_i::divide_cc_4i_i(const char *uuid, const char *label) :
divide_cc_4i_base(uuid, label)
{
}

divide_cc_4i_i::~divide_cc_4i_i()
{
}
...
void divide_cc_4i_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI divide_cc_4i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
