...
not_ss_i::not_ss_i(const char *uuid, const char *label) :
not_ss_base(uuid, label)
{
}
...
void not_ss_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_not_ss();
...
//      
BULKIO::StreamSRI not_ss_i::createOutputSRI( int32_t idx)
{
    //
