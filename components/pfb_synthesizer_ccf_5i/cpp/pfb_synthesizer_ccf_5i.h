...
#ifndef PFB_SYNTHESIZER_CCF_5I_IMPL_H
#define PFB_SYNTHESIZER_CCF_5I_IMPL_H

#include "pfb_synthesizer_ccf_5i_base.h"

class pfb_synthesizer_ccf_5i_i : public pfb_synthesizer_ccf_5i_base
{
    public:
        pfb_synthesizer_ccf_5i_i(const char *uuid, const char *label);
        ~pfb_synthesizer_ccf_5i_i();
