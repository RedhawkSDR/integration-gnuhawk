...
pfb_synthesizer_ccf_5i_i::pfb_synthesizer_ccf_5i_i(const char *uuid, const char *label) :
pfb_synthesizer_ccf_5i_base(uuid, label)
{
}

pfb_synthesizer_ccf_5i_i::~pfb_synthesizer_ccf_5i_i()
{
}
...
//      
BULKIO::StreamSRI pfb_synthesizer_ccf_5i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
