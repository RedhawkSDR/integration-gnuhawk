...
deinterleave_ff_4o_i::deinterleave_ff_4o_i(const char *uuid, const char *label) :
deinterleave_ff_4o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_ff_4o_i::streamIdChanged );
}

deinterleave_ff_4o_i::~deinterleave_ff_4o_i()
{
}

void deinterleave_ff_4o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_ff_4o_i::createBlock()
{
    //
    //
