...
copy_ss_i::copy_ss_i(const char *uuid, const char *label) :
copy_ss_base(uuid, label)
{
}
...
//      
BULKIO::StreamSRI copy_ss_i::createOutputSRI( int32_t idx)
{
    //
