...
#ifndef INTERLEAVED_SHORT_TO_COMPLEX_IMPL_H
#define INTERLEAVED_SHORT_TO_COMPLEX_IMPL_H

#include "interleaved_short_to_complex_base.h"

class interleaved_short_to_complex_i : public interleaved_short_to_complex_base
{
    public:
        interleaved_short_to_complex_i(const char *uuid, const char *label);
        ~interleaved_short_to_complex_i();
