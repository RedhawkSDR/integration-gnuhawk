...
#include "fractional_interpolator_ff.h"
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,fractional_interpolator_ff_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, fractional_interpolator_ff_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<fractional_interpolator_ff_i *> (_parent);
