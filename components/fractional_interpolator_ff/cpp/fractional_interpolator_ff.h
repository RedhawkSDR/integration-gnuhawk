...
#ifndef FRACTIONAL_INTERPOLATOR_FF_IMPL_H
#define FRACTIONAL_INTERPOLATOR_FF_IMPL_H

#include "fractional_interpolator_ff_base.h"

class fractional_interpolator_ff_i : public fractional_interpolator_ff_base
{
   public:
      fractional_interpolator_ff_i(const char *uuid, const char *label);
      ~fractional_interpolator_ff_i();
