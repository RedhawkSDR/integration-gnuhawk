...
fractional_interpolator_ff_i::fractional_interpolator_ff_i(const char *uuid, const char *label) :
fractional_interpolator_ff_base(uuid, label)
{
}

fractional_interpolator_ff_i::~fractional_interpolator_ff_i()
{
}
...
//
void fractional_interpolator_ff_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI fractional_interpolator_ff_i::createOutputSRI( int32_t idx)
{
  //
