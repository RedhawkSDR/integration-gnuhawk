...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/vector_sink_b/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_b.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_b.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/vector_sink_b.spd.xml
