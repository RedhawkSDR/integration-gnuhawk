...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/file_sink_s/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_s.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_s.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_sink_s.spd.xml
