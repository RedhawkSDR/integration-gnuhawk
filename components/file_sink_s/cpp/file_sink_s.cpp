...
file_sink_s_i::file_sink_s_i(const char *uuid, const char *label) :
file_sink_s_base(uuid, label)
{
}

file_sink_s_i::~file_sink_s_i()
{
}
...
void file_sink_s_i::createBlock()
{
    //
