...
sub_ss_2i_i::sub_ss_2i_i(const char *uuid, const char *label) :
sub_ss_2i_base(uuid, label)
{
}

sub_ss_2i_i::~sub_ss_2i_i()
{
}
...
void sub_ss_2i_i::createBlock()
{
    ...
    try {
        gr_sptr = gr_make_sub_ss( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sub_ss_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
