...
./reconf
%define _bindir %{_prefix}/dom/components/fir_filter_ccf/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fir_filter_ccf.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fir_filter_ccf.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/fir_filter_ccf.spd.xml
