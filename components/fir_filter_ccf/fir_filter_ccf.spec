...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/fir_filter_ccf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_ccf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_ccf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/fir_filter_ccf.spd.xml
