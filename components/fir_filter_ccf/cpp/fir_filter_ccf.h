...
#ifndef FIR_FILTER_CCF_IMPL_H
#define FIR_FILTER_CCF_IMPL_H

#include "fir_filter_ccf_base.h"

class fir_filter_ccf_i : public fir_filter_ccf_base
{
   public:
      fir_filter_ccf_i(const char *uuid, const char *label);
      ~fir_filter_ccf_i();
