...
#ifndef MULTIPLY_CONST_FF_IMPL_H
#define MULTIPLY_CONST_FF_IMPL_H

#include "multiply_const_ff_base.h"

class multiply_const_ff_i : public multiply_const_ff_base
{
   public:
      multiply_const_ff_i(const char *uuid, const char *label);
      ~multiply_const_ff_i();
