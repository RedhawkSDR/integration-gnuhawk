...
#include "file_descriptor_sink_c.h"
...
file_descriptor_sink_c_i::file_descriptor_sink_c_i(const char *uuid, const char *label) :
file_descriptor_sink_c_base(uuid, label)
{
}

file_descriptor_sink_c_i::~file_descriptor_sink_c_i()
{
}
...
void file_descriptor_sink_c_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	try {
        gr_sptr = gr_make_file_descriptor_sink (this->itemsize, this->fd);
	}
	catch(...) {
		return;
	}
