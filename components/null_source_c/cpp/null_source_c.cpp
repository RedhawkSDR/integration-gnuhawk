...
null_source_c_i::null_source_c_i(const char *uuid, const char *label) :
null_source_c_base(uuid, label)
{
}

null_source_c_i::~null_source_c_i()
{
}

void null_source_c_i::changedSamplingFreq(const std::string &id)
{
...
void null_source_c_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("sampling_freq", this, &null_source_c_i::changedSamplingFreq);
...
//      
BULKIO::StreamSRI null_source_c_i::createOutputSRI( int32_t idx)
{
    //
