...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/keep_one_in_n_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/keep_one_in_n_ss.spd.xml
