...
keep_one_in_n_ss_i::keep_one_in_n_ss_i(const char *uuid, const char *label) :
keep_one_in_n_ss_base(uuid, label)
{
}

keep_one_in_n_ss_i::~keep_one_in_n_ss_i()
{
}
...
void keep_one_in_n_ss_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI keep_one_in_n_ss_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
