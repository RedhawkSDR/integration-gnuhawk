...
#ifndef KEEP_ONE_IN_N_SS_IMPL_H
#define KEEP_ONE_IN_N_SS_IMPL_H

#include "keep_one_in_n_ss_base.h"

class keep_one_in_n_ss_i : public keep_one_in_n_ss_base
{
    public:
        keep_one_in_n_ss_i(const char *uuid, const char *label);
        ~keep_one_in_n_ss_i();
