...
and_ss_2i_i::and_ss_2i_i(const char *uuid, const char *label) :
and_ss_2i_base(uuid, label)
{
}

and_ss_2i_i::~and_ss_2i_i()
{
}
...
//
void and_ss_2i_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_and_ss();
...
//      
BULKIO::StreamSRI and_ss_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
  //
