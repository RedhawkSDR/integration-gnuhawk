...
multiply_const_vss_i::multiply_const_vss_i(const char *uuid, const char *label) :
multiply_const_vss_base(uuid, label)
{
}

multiply_const_vss_i::~multiply_const_vss_i()
{
}
...
//      
BULKIO::StreamSRI multiply_const_vss_i::createOutputSRI( int32_t idx)
{
  //
