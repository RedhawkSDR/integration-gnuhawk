...
#ifndef MULTIPLY_CONST_VSS_IMPL_H
#define MULTIPLY_CONST_VSS_IMPL_H

#include "multiply_const_vss_base.h"

class multiply_const_vss_i : public multiply_const_vss_base
{
   public:
      multiply_const_vss_i(const char *uuid, const char *label);
      ~multiply_const_vss_i();
