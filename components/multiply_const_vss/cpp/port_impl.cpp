...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Mon Feb 25 13:55:23 EST 2013
 	Redhawk IDE
 	Version:N.1.8.3
...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataShort_Out_i,multiply_const_vss_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataShort_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataShort_Out_i::BULKIO_dataShort_Out_i(std::string port_name, multiply_const_vss_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<multiply_const_vss_i *> (_parent);
