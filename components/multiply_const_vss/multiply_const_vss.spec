...
./reconf
%define _bindir %{_prefix}/dom/components/multiply_const_vss/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vss.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vss.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/multiply_const_vss.spd.xml
