...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/multiply_const_vss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_vss.spd.xml
