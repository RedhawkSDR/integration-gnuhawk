...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/float_to_complex_1i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_complex_1i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_complex_1i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_complex_1i.spd.xml
