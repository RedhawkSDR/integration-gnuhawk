...
#ifndef FLOAT_TO_COMPLEX_1I_IMPL_H
#define FLOAT_TO_COMPLEX_1I_IMPL_H

#include "float_to_complex_1i_base.h"

class float_to_complex_1i_i : public float_to_complex_1i_base
{
    public:
        float_to_complex_1i_i(const char *uuid, const char *label);
        ~float_to_complex_1i_i();
