...
float_to_complex_1i_i::float_to_complex_1i_i(const char *uuid, const char *label) :
float_to_complex_1i_base(uuid, label)
{
}

float_to_complex_1i_i::~float_to_complex_1i_i()
{
}
...
void float_to_complex_1i_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_float_to_complex( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI float_to_complex_1i_i::createOutputSRI( int32_t idx)
{
    //
