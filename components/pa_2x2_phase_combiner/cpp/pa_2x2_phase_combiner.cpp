...
pa_2x2_phase_combiner_i::pa_2x2_phase_combiner_i(const char *uuid, const char *label) :
pa_2x2_phase_combiner_base(uuid, label)
{
}

pa_2x2_phase_combiner_i::~pa_2x2_phase_combiner_i()
{
}
...
void pa_2x2_phase_combiner_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = gr_make_pa_2x2_phase_combiner();
    } catch (...) {
        return;
    }

    this->registerGetterSetter("theta", &gr_pa_2x2_phase_combiner::theta, &gr_pa_2x2_phase_combiner::set_theta);
...
//      
BULKIO::StreamSRI pa_2x2_phase_combiner_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
