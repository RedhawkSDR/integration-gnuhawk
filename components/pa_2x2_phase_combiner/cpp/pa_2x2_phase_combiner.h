...
#ifndef PA_2X2_PHASE_COMBINER_IMPL_H
#define PA_2X2_PHASE_COMBINER_IMPL_H

#include "pa_2x2_phase_combiner_base.h"

class pa_2x2_phase_combiner_i : public pa_2x2_phase_combiner_base
{
    public:
        pa_2x2_phase_combiner_i(const char *uuid, const char *label);
        ~pa_2x2_phase_combiner_i();
