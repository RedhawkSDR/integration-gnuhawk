...
#ifndef CLOCK_RECOVERY_MM_CC_2O_IMPL_H
#define CLOCK_RECOVERY_MM_CC_2O_IMPL_H

#include "clock_recovery_mm_cc_2o_base.h"

class clock_recovery_mm_cc_2o_i : public clock_recovery_mm_cc_2o_base
{
    public:
        clock_recovery_mm_cc_2o_i(const char *uuid, const char *label);
        ~clock_recovery_mm_cc_2o_i();
