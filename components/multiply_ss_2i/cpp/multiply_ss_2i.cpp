...
multiply_ss_2i_i::multiply_ss_2i_i(const char *uuid, const char *label) :
multiply_ss_2i_base(uuid, label)
{
}

multiply_ss_2i_i::~multiply_ss_2i_i()
{
}
...
//
void multiply_ss_2i_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_multiply_ss(vlen);
...
//      
BULKIO::StreamSRI multiply_ss_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
  //
