...
#ifndef MULTIPLY_SS_2I_IMPL_H
#define MULTIPLY_SS_2I_IMPL_H

#include "multiply_ss_2i_base.h"

class multiply_ss_2i_i : public multiply_ss_2i_base
{
   public:
      multiply_ss_2i_i(const char *uuid, const char *label);
      ~multiply_ss_2i_i();
