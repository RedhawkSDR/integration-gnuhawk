...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataShort_Out_i,multiply_ss_2i_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataShort_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataShort_Out_i::BULKIO_dataShort_Out_i(std::string port_name, multiply_ss_2i_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<multiply_ss_2i_i *> (_parent);
