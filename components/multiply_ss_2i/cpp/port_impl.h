...
//RESOLVE    ENABLE_LOGGING;
    public:
        ...
        BULKIO_dataShort_Out_i(std::string port_name, multiply_ss_2i_base *_parent);
...
class BULKIO_dataShort_In_i : public POA_BULKIO::dataShort, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataShort_In_i(std::string port_name, multiply_ss_2i_base *_parent);
