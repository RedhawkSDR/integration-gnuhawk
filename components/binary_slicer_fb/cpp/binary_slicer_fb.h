...
#ifndef BINARY_SLICER_FB_IMPL_H
#define BINARY_SLICER_FB_IMPL_H

#include "binary_slicer_fb_base.h"

class binary_slicer_fb_i : public binary_slicer_fb_base
{
    public:
        binary_slicer_fb_i(const char *uuid, const char *label);
        ~binary_slicer_fb_i();
