...
binary_slicer_fb_i::binary_slicer_fb_i(const char *uuid, const char *label) :
binary_slicer_fb_base(uuid, label)
{
}

binary_slicer_fb_i::~binary_slicer_fb_i()
{
}
...
void binary_slicer_fb_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = digital_make_binary_slicer_fb();
...
//      
BULKIO::StreamSRI binary_slicer_fb_i::createOutputSRI( int32_t idx)
{
    //
