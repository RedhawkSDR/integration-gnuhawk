...
throttle_ss_i::throttle_ss_i(const char *uuid, const char *label) :
throttle_ss_base(uuid, label)
{
}

throttle_ss_i::~throttle_ss_i()
{
}

void throttle_ss_i::changeFrequency(const std::string &id)
{
...
void throttle_ss_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("samples_per_sec", this, &throttle_ss_i::changeFrequency);
...
//      
BULKIO::StreamSRI throttle_ss_i::createOutputSRI( int32_t idx)
{
    //
