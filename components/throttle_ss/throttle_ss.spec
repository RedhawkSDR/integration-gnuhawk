...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/throttle_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/throttle_ss.spd.xml
