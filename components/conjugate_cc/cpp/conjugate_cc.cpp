...
conjugate_cc_i::conjugate_cc_i(const char *uuid, const char *label) :
conjugate_cc_base(uuid, label)
{
}

conjugate_cc_i::~conjugate_cc_i()
{
}
...
void conjugate_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_conjugate_cc();
...
//      
BULKIO::StreamSRI conjugate_cc_i::createOutputSRI( int32_t idx)
{
    //
