...
#include "file_descriptor_source_c.h"
...
file_descriptor_source_c_i::file_descriptor_source_c_i(const char *uuid, const char *label) :
file_descriptor_source_c_base(uuid, label)
{
}

file_descriptor_source_c_i::~file_descriptor_source_c_i()
{
}
...
void file_descriptor_source_c_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI file_descriptor_source_c_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
