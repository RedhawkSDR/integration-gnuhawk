...
#ifndef FILE_DESCRIPTOR_SOURCE_C_IMPL_H
#define FILE_DESCRIPTOR_SOURCE_C_IMPL_H

#include "file_descriptor_source_c_base.h"

class file_descriptor_source_c_i : public file_descriptor_source_c_base
{
    public:
        file_descriptor_source_c_i(const char *uuid, const char *label);
        ~file_descriptor_source_c_i();
