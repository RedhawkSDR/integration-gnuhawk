...
#include "packed_to_unpacked_ss.h"
...
packed_to_unpacked_ss_i::packed_to_unpacked_ss_i(const char *uuid, const char *label) :
packed_to_unpacked_ss_base(uuid, label)
{
}

packed_to_unpacked_ss_i::~packed_to_unpacked_ss_i()
{
}
...
//      
BULKIO::StreamSRI packed_to_unpacked_ss_i::createOutputSRI( int32_t idx)
{
    //
