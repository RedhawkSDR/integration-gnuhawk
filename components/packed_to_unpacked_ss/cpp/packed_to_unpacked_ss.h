...
#ifndef PACKED_TO_UNPACKED_SS_IMPL_H
#define PACKED_TO_UNPACKED_SS_IMPL_H

#include "packed_to_unpacked_ss_base.h"

class packed_to_unpacked_ss_i : public packed_to_unpacked_ss_base
{
    public:
        packed_to_unpacked_ss_i(const char *uuid, const char *label);
        ~packed_to_unpacked_ss_i();
