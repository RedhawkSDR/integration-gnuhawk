...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/packed_to_unpacked_ss/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ss.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ss.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/packed_to_unpacked_ss.spd.xml
