...
interleave_bb_3i_i::interleave_bb_3i_i(const char *uuid, const char *label) :
interleave_bb_3i_base(uuid, label)
{
}

interleave_bb_3i_i::~interleave_bb_3i_i()
{
}
...
void interleave_bb_3i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_interleave (this->itemsize);
...
//      
BULKIO::StreamSRI interleave_bb_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
