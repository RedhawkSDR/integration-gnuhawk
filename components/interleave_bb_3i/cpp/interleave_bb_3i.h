...
#ifndef INTERLEAVE_BB_3I_IMPL_H
#define INTERLEAVE_BB_3I_IMPL_H

#include "interleave_bb_3i_base.h"

class interleave_bb_3i_i : public interleave_bb_3i_base
{
    public:
        interleave_bb_3i_i(const char *uuid, const char *label);
        ~interleave_bb_3i_i();
