...
deinterleave_ii_2o_i::deinterleave_ii_2o_i(const char *uuid, const char *label) :
deinterleave_ii_2o_base(uuid, label)
{
    setPropertyChangeListener ("stream_id_map" , this, &deinterleave_ii_2o_i::streamIdChanged );
}

deinterleave_ii_2o_i::~deinterleave_ii_2o_i()
{
}

void deinterleave_ii_2o_i::streamIdChanged(const std::string& id)
{ 
...
void deinterleave_ii_2o_i::createBlock()
{
    //
    //
...
//      
BULKIO::StreamSRI deinterleave_ii_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
