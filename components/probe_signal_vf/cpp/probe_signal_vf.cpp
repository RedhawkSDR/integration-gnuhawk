...
probe_signal_vf_i::probe_signal_vf_i(const char *uuid, const char *label) :
probe_signal_vf_base(uuid, label)
{
}

probe_signal_vf_i::~probe_signal_vf_i()
{
}
...
void probe_signal_vf_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_probe_signal_vf( this->size );

    this->registerGetter("level",
                         &gr_probe_signal_vf::level);
