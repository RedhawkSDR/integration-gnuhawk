...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/probe_signal_vf/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vf.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vf.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/probe_signal_vf.spd.xml
