...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/file_source_c/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_source_c.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_source_c.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/file_source_c.spd.xml
