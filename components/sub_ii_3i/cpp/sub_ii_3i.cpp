...
sub_ii_3i_i::sub_ii_3i_i(const char *uuid, const char *label) :
sub_ii_3i_base(uuid, label)
{
}

sub_ii_3i_i::~sub_ii_3i_i()
{
}
...
//      
BULKIO::StreamSRI sub_ii_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
