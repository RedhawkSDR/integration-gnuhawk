...
class multiply_ii_2i_base : public GnuHawkBlock
{
    ...
    protected:
        ...
        // Ports
        bulkio::InLongPort *data_in_0;
        bulkio::InLongPort *data_in_1;
        bulkio::OutLongPort *data_out;
    ...
    protected:
        ...
        void  data_in_0_newStreamCallback( BULKIO::StreamSRI &sri );

        // callback when a new Stream ID is detected on the port so we can add to istream/ostream mapping list
        void  data_in_1_newStreamCallback( BULKIO::StreamSRI &sri );
