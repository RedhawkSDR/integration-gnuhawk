...
#ifndef MULTIPLY_II_2I_IMPL_H
#define MULTIPLY_II_2I_IMPL_H

#include "multiply_ii_2i_base.h"

class multiply_ii_2i_i : public multiply_ii_2i_base
{
   public:
      multiply_ii_2i_i(const char *uuid, const char *label);
      ~multiply_ii_2i_i();
