...
unpacked_to_packed_bb_i::unpacked_to_packed_bb_i(const char *uuid, const char *label) :
unpacked_to_packed_bb_base(uuid, label)
{
}

unpacked_to_packed_bb_i::~unpacked_to_packed_bb_i()
{
}
...
void unpacked_to_packed_bb_i::createBlock()
{
    //
    ...
    gr_sptr = gr_make_unpacked_to_packed_bb(this->bits_per_chunk, end);
...
//      
BULKIO::StreamSRI unpacked_to_packed_bb_i::createOutputSRI( int32_t idx)
{
    //
