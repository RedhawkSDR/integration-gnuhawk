...
#ifndef UNPACKED_TO_PACKED_BB_IMPL_H
#define UNPACKED_TO_PACKED_BB_IMPL_H

#include "unpacked_to_packed_bb_base.h"

class unpacked_to_packed_bb_i : public unpacked_to_packed_bb_base
{
    public:
        unpacked_to_packed_bb_i(const char *uuid, const char *label);
        ~unpacked_to_packed_bb_i();
