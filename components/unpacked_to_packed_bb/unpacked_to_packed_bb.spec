...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/unpacked_to_packed_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/unpacked_to_packed_bb.spd.xml
