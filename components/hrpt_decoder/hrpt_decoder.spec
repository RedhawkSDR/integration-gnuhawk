...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/hrpt_decoder/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_decoder.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_decoder.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/hrpt_decoder.spd.xml
