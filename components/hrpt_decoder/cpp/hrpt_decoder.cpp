...
hrpt_decoder_i::hrpt_decoder_i(const char *uuid, const char *label) :
hrpt_decoder_base(uuid, label)
{
}

hrpt_decoder_i::~hrpt_decoder_i()
{
}
...
void hrpt_decoder_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = noaa_make_hrpt_decoder( this->verbose, this->output_files );
    } catch (...) {
        return;
    }
