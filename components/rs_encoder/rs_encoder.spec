...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/rs_encoder/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_encoder.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_encoder.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/rs_encoder.spd.xml
