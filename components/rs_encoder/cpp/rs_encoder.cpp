...
rs_encoder_i::rs_encoder_i(const char *uuid, const char *label) :
rs_encoder_base(uuid, label)
{
}

rs_encoder_i::~rs_encoder_i()
{
}
...
//      
BULKIO::StreamSRI rs_encoder_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
