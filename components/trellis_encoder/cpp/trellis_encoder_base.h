...
#ifndef TRELLIS_ENCODER_IMPL_BASE_H
#define TRELLIS_ENCODER_IMPL_BASE_H
...
#include "trellis_encoder_GnuHawkBlock.h"

#define NOOP 0
#define FINISH -1
#define NORMAL 1

class trellis_encoder_base;
...
class trellis_encoder_base : public GnuHawkBlock
{
    public:
        trellis_encoder_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<trellis_encoder_base> *serviceThread; 
        boost::mutex serviceThreadLock;

        // Ports
        bulkio::InOctetPort *atsc_mpeg_packet_rs_encoded_in;
        bulkio::OutOctetPort *atsc_data_segment_out;
    ...
    protected:
        ...
        void  atsc_mpeg_packet_rs_encoded_in_newStreamCallback( BULKIO::StreamSRI &sri );
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( trellis_encoder_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( trellis_encoder_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( trellis_encoder_base, " serviceFunction: retval:" << retval);
