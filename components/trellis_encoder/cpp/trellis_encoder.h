...
#ifndef TRELLIS_ENCODER_IMPL_H
#define TRELLIS_ENCODER_IMPL_H

#include "trellis_encoder_base.h"

class trellis_encoder_i : public trellis_encoder_base
{
    public:
        trellis_encoder_i(const char *uuid, const char *label);
        ~trellis_encoder_i();
