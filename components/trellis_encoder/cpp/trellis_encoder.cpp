...
trellis_encoder_i::trellis_encoder_i(const char *uuid, const char *label) :
trellis_encoder_base(uuid, label)
{
}

trellis_encoder_i::~trellis_encoder_i()
{
}
...
void trellis_encoder_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = atsc_make_trellis_encoder();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI trellis_encoder_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
