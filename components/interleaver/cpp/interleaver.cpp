...
interleaver_i::interleaver_i(const char *uuid, const char *label) :
interleaver_base(uuid, label)
{
}

interleaver_i::~interleaver_i()
{
}
...
void interleaver_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI interleaver_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
