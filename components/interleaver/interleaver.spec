...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/interleaver/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/interleaver.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/interleaver.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/interleaver.spd.xml
