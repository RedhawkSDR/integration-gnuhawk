...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/multiply_const_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/multiply_const_cc.spd.xml
