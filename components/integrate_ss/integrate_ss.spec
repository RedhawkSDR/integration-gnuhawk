...
./reconf
%define _bindir %{_prefix}/dom/components/integrate_ss/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ss.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ss.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_ss.spd.xml
