...
integrate_ss_i::integrate_ss_i(const char *uuid, const char *label) :
integrate_ss_base(uuid, label)
{
}

integrate_ss_i::~integrate_ss_i()
{
}
...
//
void integrate_ss_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_integrate_ss(decim);
...
//      
BULKIO::StreamSRI integrate_ss_i::createOutputSRI( int32_t idx)
{
  //
