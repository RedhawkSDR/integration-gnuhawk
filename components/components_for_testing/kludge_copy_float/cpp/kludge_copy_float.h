...
#ifndef KLUDGE_COPY_FLOAT_IMPL_H
#define KLUDGE_COPY_FLOAT_IMPL_H

#include "kludge_copy_float_base.h"

class kludge_copy_float_i : public kludge_copy_float_base
{
   public:
      kludge_copy_float_i(const char *uuid, const char *label);
      ~kludge_copy_float_i();
