...
kludge_copy_float_i::kludge_copy_float_i(const char *uuid, const char *label) :
kludge_copy_float_base(uuid, label)
{
}

kludge_copy_float_i::~kludge_copy_float_i()
{
}
...
//
void kludge_copy_float_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_kludge_copy(sizeof(float));
...
//      
BULKIO::StreamSRI kludge_copy_float_i::createOutputSRI( int32_t idx)
{
  //
...
//
uint32_t  kludge_copy_float_i::getNOutputStreams() {
