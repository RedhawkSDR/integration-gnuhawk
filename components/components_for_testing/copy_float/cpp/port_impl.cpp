...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataFloat_Out_i,copy_float_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataFloat_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataFloat_Out_i::BULKIO_dataFloat_Out_i(std::string port_name, copy_float_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<copy_float_i *> (_parent);
