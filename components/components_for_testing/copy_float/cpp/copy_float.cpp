...
copy_float_i::copy_float_i(const char *uuid, const char *label) :
copy_float_base(uuid, label)
{
}

copy_float_i::~copy_float_i()
{
}
...
//
void copy_float_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_copy(sizeof(float));
...
//      
BULKIO::StreamSRI copy_float_i::createOutputSRI( int32_t idx)
{
  //
...
//
uint32_t  copy_float_i::getNOutputStreams() {
