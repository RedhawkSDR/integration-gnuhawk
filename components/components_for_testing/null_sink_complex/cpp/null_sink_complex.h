...
#ifndef NULL_SINK_COMPLEX_IMPL_H
#define NULL_SINK_COMPLEX_IMPL_H

#include "null_sink_complex_base.h"

class null_sink_complex_i : public null_sink_complex_base
{
   public:
      null_sink_complex_i(const char *uuid, const char *label);
      ~null_sink_complex_i();
