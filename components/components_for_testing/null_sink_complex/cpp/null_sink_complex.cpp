...
null_sink_complex_i::null_sink_complex_i(const char *uuid, const char *label) :
null_sink_complex_base(uuid, label)
{
}

null_sink_complex_i::~null_sink_complex_i()
{
}
...
//
void null_sink_complex_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_null_sink(sizeof(gr_complex));
