...
class null_sink_complex_base;
class null_sink_complex_i;
...
class BULKIO_dataFloat_In_i : public POA_BULKIO::dataFloat, public Port_Provides_base_impl
{
    public:
     ...
     //BULKIO_dataFloat_In_i(std::string port_name, null_sink_complex_base *_parent);
