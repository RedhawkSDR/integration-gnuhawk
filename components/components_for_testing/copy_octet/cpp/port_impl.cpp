...
//RESOLVE PREPARE_ALT_LOGGING(BULKIO_dataOctet_Out_i,copy_octet_i)
// ----------------------------------------------------------------------------------------
// BULKIO_dataOctet_Out_i definition
// ----------------------------------------------------------------------------------------
BULKIO_dataOctet_Out_i::BULKIO_dataOctet_Out_i(std::string port_name, copy_octet_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<copy_octet_i *> (_parent);
