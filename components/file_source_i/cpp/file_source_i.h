...
#ifndef FILE_SOURCE_I_IMPL_H
#define FILE_SOURCE_I_IMPL_H

#include "file_source_i_base.h"

class file_source_i_i : public file_source_i_base
{
    public:
        file_source_i_i(const char *uuid, const char *label);
        ~file_source_i_i();
        ...
        void changedSeek(const std::string &id);
        bool getSeek();
};
