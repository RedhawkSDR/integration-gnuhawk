...
integrate_cc_i::integrate_cc_i(const char *uuid, const char *label) :
integrate_cc_base(uuid, label)
{
}

integrate_cc_i::~integrate_cc_i()
{
}
...
//
void integrate_cc_i::createBlock()
{
  //
  // gr_sptr = xxx_make_xxx( args );
  //
  gr_sptr = gr_make_integrate_cc(decim);
...
//      
BULKIO::StreamSRI integrate_cc_i::createOutputSRI( int32_t idx)
{
  //
