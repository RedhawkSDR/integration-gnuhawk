...
./reconf
%define _bindir %{_prefix}/dom/components/integrate_cc/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_cc.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_cc.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/integrate_cc.spd.xml
