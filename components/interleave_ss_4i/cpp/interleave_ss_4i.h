...
#ifndef INTERLEAVE_SS_4I_IMPL_H
#define INTERLEAVE_SS_4I_IMPL_H

#include "interleave_ss_4i_base.h"

class interleave_ss_4i_i : public interleave_ss_4i_base
{
    public:
        interleave_ss_4i_i(const char *uuid, const char *label);
        ~interleave_ss_4i_i();
