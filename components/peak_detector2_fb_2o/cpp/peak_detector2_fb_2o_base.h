...
#ifndef PEAK_DETECTOR2_FB_2O_IMPL_BASE_H
#define PEAK_DETECTOR2_FB_2O_IMPL_BASE_H
...
#include "peak_detector2_fb_2o_GnuHawkBlock.h"
#include <sstream>
...
class peak_detector2_fb_2o_base;
...
class peak_detector2_fb_2o_base : public GnuHawkBlock
{
    public:
        peak_detector2_fb_2o_base(const char *uuid, const char *label);
        ...
        ~peak_detector2_fb_2o_base();

        void loadProperties();

    protected:
        ProcessThread<peak_detector2_fb_2o_base> *serviceThread; 
        ...
        bulkio::OutFloatPort *debug_sig_out;
    ...
    struct gr_istream_base {
        ...
        void _check( int inMode , bool force=false) {
            ...
            try {
                ...
                LOG_TRACE( peak_detector2_fb_2o_base, "UNABLE TO SET VLEN, BAD INDEX:" << _idx );
            }
        ...
        int serviceFunction()
        {
            ...
            if ( retval == NORMAL && _throttle ) {
                ...
                if ( delta.is_not_a_date_time() == false && delta.is_negative() == false ) {
                    LOG_TRACE( peak_detector2_fb_2o_base, " SLEEP ...." << delta );
                    boost::this_thread::sleep( delta );
                } else {
                    LOG_TRACE( peak_detector2_fb_2o_base, " NO SLEEPING...." );
                }
            }
            p_start_time = p_end_time;
       
            LOG_TRACE( peak_detector2_fb_2o_base, " serviceFunction: retval:" << retval);
