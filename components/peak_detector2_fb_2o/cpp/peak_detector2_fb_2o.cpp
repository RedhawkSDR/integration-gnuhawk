...
int peak_detector2_fb_2o_i::get_look_ahead()
{
    return gr_sptr->look_ahead();
}

float peak_detector2_fb_2o_i::get_alpha()
{
...
void peak_detector2_fb_2o_i::createBlock()
{
    ...
    this->registerGetValue("threshold_factor_rise", this, &peak_detector2_fb_2o_i::get_threshold_factor_rise);
    this->registerGetValue("look_ahead", this, &peak_detector2_fb_2o_i::get_look_ahead);
    this->registerGetValue("alpha", this, &peak_detector2_fb_2o_i::get_alpha);
...
//      
BULKIO::StreamSRI peak_detector2_fb_2o_i::createOutputSRI( int32_t oidx, int32_t &in_idx, std::string &ext)
{
    //
