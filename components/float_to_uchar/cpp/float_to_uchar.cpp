...
float_to_uchar_i::float_to_uchar_i(const char *uuid, const char *label) :
float_to_uchar_base(uuid, label)
{
}

float_to_uchar_i::~float_to_uchar_i()
{
}
...
void float_to_uchar_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_float_to_uchar();
...
//      
BULKIO::StreamSRI float_to_uchar_i::createOutputSRI( int32_t idx)
{
    //
