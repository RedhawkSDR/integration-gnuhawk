...
#ifndef FLOAT_TO_UCHAR_IMPL_H
#define FLOAT_TO_UCHAR_IMPL_H

#include "float_to_uchar_base.h"

class float_to_uchar_i : public float_to_uchar_base
{
    public:
        float_to_uchar_i(const char *uuid, const char *label);
        ~float_to_uchar_i();
