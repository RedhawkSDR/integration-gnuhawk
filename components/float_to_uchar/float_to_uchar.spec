...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/float_to_uchar/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_uchar.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_uchar.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/float_to_uchar.spd.xml
