...
#ifndef FILTER_DELAY_FC_2I_IMPL_H
#define FILTER_DELAY_FC_2I_IMPL_H

#include "filter_delay_fc_2i_base.h"

class filter_delay_fc_2i_i : public filter_delay_fc_2i_base
{
   public:
      filter_delay_fc_2i_i(const char *uuid, const char *label);
      ~filter_delay_fc_2i_i();
