...
or_ii_2i_i::or_ii_2i_i(const char *uuid, const char *label) :
or_ii_2i_base(uuid, label)
{
}

or_ii_2i_i::~or_ii_2i_i()
{
}
...
//      
BULKIO::StreamSRI or_ii_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
