...
#ifndef VECTOR_TO_STREAMS_CC_3O_IMPL_H
#define VECTOR_TO_STREAMS_CC_3O_IMPL_H

#include "vector_to_streams_cc_3o_base.h"

class vector_to_streams_cc_3o_i : public vector_to_streams_cc_3o_base
{
    public:
        vector_to_streams_cc_3o_i(const char *uuid, const char *label);
        ~vector_to_streams_cc_3o_i();
