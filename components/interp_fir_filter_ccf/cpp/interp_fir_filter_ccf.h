...
#ifndef INTERP_FIR_FILTER_CCF_IMPL_H
#define INTERP_FIR_FILTER_CCF_IMPL_H

#include "interp_fir_filter_ccf_base.h"

class interp_fir_filter_ccf_i : public interp_fir_filter_ccf_base
{
   public:
      interp_fir_filter_ccf_i(const char *uuid, const char *label);
      ~interp_fir_filter_ccf_i();
