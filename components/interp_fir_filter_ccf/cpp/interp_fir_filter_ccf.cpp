...
interp_fir_filter_ccf_i::interp_fir_filter_ccf_i(const char *uuid, const char *label) :
interp_fir_filter_ccf_base(uuid, label)
{
}

interp_fir_filter_ccf_i::~interp_fir_filter_ccf_i()
{
}

void interp_fir_filter_ccf_i::setTaps(const std::string &id)
{
...
//
void interp_fir_filter_ccf_i::createBlock()
{
  //
...
//      
BULKIO::StreamSRI interp_fir_filter_ccf_i::createOutputSRI( int32_t idx)
{
  //
