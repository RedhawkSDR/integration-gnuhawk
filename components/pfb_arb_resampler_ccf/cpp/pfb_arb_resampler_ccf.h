...
#ifndef PFB_ARB_RESAMPLER_CCF_IMPL_H
#define PFB_ARB_RESAMPLER_CCF_IMPL_H

#include "pfb_arb_resampler_ccf_base.h"

class pfb_arb_resampler_ccf_i : public pfb_arb_resampler_ccf_base
{
   public:
      pfb_arb_resampler_ccf_i(const char *uuid, const char *label);
      ~pfb_arb_resampler_ccf_i();
