...
#ifndef ULAW_ENCODE_SB_IMPL_H
#define ULAW_ENCODE_SB_IMPL_H

#include "ulaw_encode_sb_base.h"

class ulaw_encode_sb_i : public ulaw_encode_sb_base
{
    public:
        ulaw_encode_sb_i(const char *uuid, const char *label);
        ~ulaw_encode_sb_i();
