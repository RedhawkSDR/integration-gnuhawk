...
#ifndef STREAMS_TO_VECTOR_CC_1I_IMPL_H
#define STREAMS_TO_VECTOR_CC_1I_IMPL_H

#include "streams_to_vector_cc_1i_base.h"

class streams_to_vector_cc_1i_i : public streams_to_vector_cc_1i_base
{
    public:
        streams_to_vector_cc_1i_i(const char *uuid, const char *label);
        ~streams_to_vector_cc_1i_i();
