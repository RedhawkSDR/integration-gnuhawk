...
#ifndef STREAM_TO_STREAMS_FF_1O_IMPL_H
#define STREAM_TO_STREAMS_FF_1O_IMPL_H

#include "stream_to_streams_ff_1o_base.h"

class stream_to_streams_ff_1o_i : public stream_to_streams_ff_1o_base
{
    public:
        stream_to_streams_ff_1o_i(const char *uuid, const char *label);
        ~stream_to_streams_ff_1o_i();
