...
void fractional_interpolator_cc_base::construct()
{
...
*******************************************************************************************/
void fractional_interpolator_cc_base::initialize() throw (CF::LifeCycle::InitializeError, CORBA::SystemException)
{
}

void fractional_interpolator_cc_base::start() throw (CORBA::SystemException, CF::Resource::StartError)
{
...
void fractional_interpolator_cc_base::stop() throw (CORBA::SystemException, CF::Resource::StopError)
{
    ...
    if (serviceThread != 0) {
      {
        boost::mutex::scoped_lock lock(serviceThreadLock);
        LOG_TRACE( fractional_interpolator_cc_base, "Stopping Service Function" );
        serviceThread->stop();
      }
    ...
    LOG_TRACE( fractional_interpolator_cc_base, "COMPLETED STOP REQUEST" );
}

CORBA::Object_ptr fractional_interpolator_cc_base::getPort(const char* _id) throw (CORBA::SystemException, CF::PortSupplier::UnknownPort)
{
...
void fractional_interpolator_cc_base::releaseObject() throw (CORBA::SystemException, CF::LifeCycle::ReleaseError)
{
