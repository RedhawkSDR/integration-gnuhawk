...
#ifndef FRACTIONAL_INTERPOLATOR_CC_IMPL_H
#define FRACTIONAL_INTERPOLATOR_CC_IMPL_H

#include "fractional_interpolator_cc_base.h"

class fractional_interpolator_cc_i : public fractional_interpolator_cc_base
{
   public:
      fractional_interpolator_cc_i(const char *uuid, const char *label);
      ~fractional_interpolator_cc_i();
