...
g723_40_encode_sb_i::g723_40_encode_sb_i(const char *uuid, const char *label) :
g723_40_encode_sb_base(uuid, label)
{
}

g723_40_encode_sb_i::~g723_40_encode_sb_i()
{
}
...
void g723_40_encode_sb_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = vocoder_make_g723_40_encode_sb();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI g723_40_encode_sb_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
