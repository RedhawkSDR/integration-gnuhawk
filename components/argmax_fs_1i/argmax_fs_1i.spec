...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/argmax_fs_1i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_1i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_1i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/argmax_fs_1i.spd.xml
