...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/correlate_access_code_bb/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/correlate_access_code_bb.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/correlate_access_code_bb.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/correlate_access_code_bb.spd.xml
