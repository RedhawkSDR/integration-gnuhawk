...
null_source_s_i::null_source_s_i(const char *uuid, const char *label) :
null_source_s_base(uuid, label)
{
}

null_source_s_i::~null_source_s_i()
{
}

void null_source_s_i::changedSamplingFreq(const std::string &id)
{
...
void null_source_s_i::createBlock()
{
    //
    ...
    this->setPropertyChangeListener("sampling_freq", this, &null_source_s_i::changedSamplingFreq);
...
//      
BULKIO::StreamSRI null_source_s_i::createOutputSRI( int32_t idx)
{
    //
