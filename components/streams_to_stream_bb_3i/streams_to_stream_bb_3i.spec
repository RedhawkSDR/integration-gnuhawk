...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/streams_to_stream_bb_3i/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_bb_3i.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_bb_3i.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/streams_to_stream_bb_3i.spd.xml
