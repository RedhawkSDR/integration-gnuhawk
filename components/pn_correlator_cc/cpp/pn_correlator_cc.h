...
#ifndef PN_CORRELATOR_CC_IMPL_H
#define PN_CORRELATOR_CC_IMPL_H

#include "pn_correlator_cc_base.h"

class pn_correlator_cc_i : public pn_correlator_cc_base
{
    public:
        pn_correlator_cc_i(const char *uuid, const char *label);
        ~pn_correlator_cc_i();
