...
pn_correlator_cc_i::pn_correlator_cc_i(const char *uuid, const char *label) :
pn_correlator_cc_base(uuid, label)
{
}

pn_correlator_cc_i::~pn_correlator_cc_i()
{
}
...
void pn_correlator_cc_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = digital_make_pn_correlator_cc( this->degree, this->mask, this->seed );
...
//      
BULKIO::StreamSRI pn_correlator_cc_i::createOutputSRI( int32_t idx)
{
    //
