...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/pn_correlator_cc/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pn_correlator_cc.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pn_correlator_cc.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/pn_correlator_cc.spd.xml
