...
%define _namespace gnuhawk/wavelet
...
./reconf
%define _bindir %{_prefix}/dom/components/%{_namespace}/%{_version}/wavelet_ff/cpp
...
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/wavelet_ff.scd.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/wavelet_ff.prf.xml
%{_prefix}/dom/components/%{_namespace}/%{name}/%{version}/wavelet_ff.spd.xml
