...
#ifndef NOISE_SOURCE_C_IMPL_H
#define NOISE_SOURCE_C_IMPL_H

#include "noise_source_c_base.h"

class noise_source_c_i : public noise_source_c_base
{
   public:
      noise_source_c_i(const char *uuid, const char *label);
      ~noise_source_c_i();
