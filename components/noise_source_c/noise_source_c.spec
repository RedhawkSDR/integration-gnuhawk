...
./reconf
%define _bindir %{_prefix}/dom/components/noise_source_c/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/noise_source_c.scd.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/noise_source_c.prf.xml
%{_prefix}/dom/components/gnuhawk/gr/%{name}/1.0.0/noise_source_c.spd.xml
