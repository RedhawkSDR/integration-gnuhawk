...
#include "clock_recovery_mm_cc_1o.h"
...
clock_recovery_mm_cc_1o_i::clock_recovery_mm_cc_1o_i(const char *uuid, const char *label) :
clock_recovery_mm_cc_1o_base(uuid, label)
{
}

clock_recovery_mm_cc_1o_i::~clock_recovery_mm_cc_1o_i()
{
}
...
void clock_recovery_mm_cc_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI clock_recovery_mm_cc_1o_i::createOutputSRI( int32_t idx)
{
    //
