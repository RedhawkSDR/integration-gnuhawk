...
argmax_fs_3i_i::argmax_fs_3i_i(const char *uuid, const char *label) :
argmax_fs_3i_base(uuid, label)
{
}

argmax_fs_3i_i::~argmax_fs_3i_i()
{
}
...
void argmax_fs_3i_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //
	gr_sptr = gr_make_argmax_fs (this->vlen);
...
//      
BULKIO::StreamSRI argmax_fs_3i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
