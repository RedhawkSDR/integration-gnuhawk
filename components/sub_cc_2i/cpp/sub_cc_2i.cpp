...
sub_cc_2i_i::sub_cc_2i_i(const char *uuid, const char *label) :
sub_cc_2i_base(uuid, label)
{
}

sub_cc_2i_i::~sub_cc_2i_i()
{
}
...
void sub_cc_2i_i::createBlock()
{
    ...
    try {
        gr_sptr = gr_make_sub_cc( this->vlen );
    } catch (...) {
        return;
    }
...
//      
BULKIO::StreamSRI sub_cc_2i_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
