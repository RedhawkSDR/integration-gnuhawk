...
#ifndef MOVING_AVERAGE_SS_IMPL_H
#define MOVING_AVERAGE_SS_IMPL_H

#include "moving_average_ss_base.h"

class moving_average_ss_i : public moving_average_ss_base
{
    public:
        moving_average_ss_i(const char *uuid, const char *label);
        ~moving_average_ss_i();
