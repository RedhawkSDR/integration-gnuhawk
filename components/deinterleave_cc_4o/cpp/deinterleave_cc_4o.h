...
#ifndef DEINTERLEAVE_CC_4O_IMPL_H
#define DEINTERLEAVE_CC_4O_IMPL_H

#include "deinterleave_cc_4o_base.h"

class deinterleave_cc_4o_i : public deinterleave_cc_4o_base
{
    public:
        deinterleave_cc_4o_i(const char *uuid, const char *label);
        ~deinterleave_cc_4o_i();
