...
not_bb_i::not_bb_i(const char *uuid, const char *label) :
not_bb_base(uuid, label)
{
}
...
void not_bb_i::createBlock()
{
    //
    // gr_sptr = xxx_make_xxx( args );
    //

    gr_sptr = gr_make_not_bb();
...
//      
BULKIO::StreamSRI not_bb_i::createOutputSRI( int32_t idx)
{
    //
