...
fll_band_edge_cc_1o_i::fll_band_edge_cc_1o_i(const char *uuid, const char *label) :
fll_band_edge_cc_1o_base(uuid, label)
{
}

fll_band_edge_cc_1o_i::~fll_band_edge_cc_1o_i()
{
}
...
void fll_band_edge_cc_1o_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = digital_make_fll_band_edge_cc(this->samples_per_symbol, this->rolloff, this->filter_size, this->bandwidth);
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI fll_band_edge_cc_1o_i::createOutputSRI( int32_t idx)
{
    //
