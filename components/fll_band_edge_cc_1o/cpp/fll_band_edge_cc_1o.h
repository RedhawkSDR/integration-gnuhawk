...
#ifndef FLL_BAND_EDGE_CC_1O_IMPL_H
#define FLL_BAND_EDGE_CC_1O_IMPL_H

#include "fll_band_edge_cc_1o_base.h"

class fll_band_edge_cc_1o_i : public fll_band_edge_cc_1o_base
{
    public:
        fll_band_edge_cc_1o_i(const char *uuid, const char *label);
        ~fll_band_edge_cc_1o_i();
