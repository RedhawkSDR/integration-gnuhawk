...
#ifndef DEINTERLEAVE_BB_2O_IMPL_H
#define DEINTERLEAVE_BB_2O_IMPL_H

#include "deinterleave_bb_2o_base.h"

class deinterleave_bb_2o_i : public deinterleave_bb_2o_base
{
    public:
        deinterleave_bb_2o_i(const char *uuid, const char *label);
        ~deinterleave_bb_2o_i();
