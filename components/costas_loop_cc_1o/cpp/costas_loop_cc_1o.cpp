...
costas_loop_cc_1o_i::costas_loop_cc_1o_i(const char *uuid, const char *label) :
costas_loop_cc_1o_base(uuid, label)
{
}

costas_loop_cc_1o_i::~costas_loop_cc_1o_i()
{
}
...
void costas_loop_cc_1o_i::createBlock()
{
    //
...
//      
BULKIO::StreamSRI costas_loop_cc_1o_i::createOutputSRI( int32_t idx)
{
    //
