...
#ifndef COSTAS_LOOP_CC_1O_IMPL_H
#define COSTAS_LOOP_CC_1O_IMPL_H

#include "costas_loop_cc_1o_base.h"

class costas_loop_cc_1o_i : public costas_loop_cc_1o_base
{
    public:
        costas_loop_cc_1o_i(const char *uuid, const char *label);
        ~costas_loop_cc_1o_i();
