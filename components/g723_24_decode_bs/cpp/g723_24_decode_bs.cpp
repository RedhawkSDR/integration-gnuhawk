...
g723_24_decode_bs_i::g723_24_decode_bs_i(const char *uuid, const char *label) :
g723_24_decode_bs_base(uuid, label)
{
}

g723_24_decode_bs_i::~g723_24_decode_bs_i()
{
}
...
void g723_24_decode_bs_i::createBlock()
{
    //
    ...
    try {
        gr_sptr = vocoder_make_g723_24_decode_bs();
    } catch (...){
        return;
    }
...
//      
BULKIO::StreamSRI g723_24_decode_bs_i::createOutputSRI( int32_t oidx, int32_t &in_idx)
{
    //
